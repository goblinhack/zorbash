...
TP_SET_PROTO(delay_ai_ms)
TP_SET_PROTO(is_bouncy)
...
TP_SET_PROTO(is_initial_health_at)
TP_SET_PROTO(is_starving_at_health_pct)
TP_SET_PROTO(is_hungry_at_health_pct)
TP_SET_PROTO(is_hungry_every_rounds)
TP_SET_PROTO(is_scent_aware_at_distance)
...
TP_SET_PROTO(is_collision_use_box)
TP_SET_PROTO(is_collision_detect_use_circle)
