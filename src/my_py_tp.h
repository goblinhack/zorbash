...
TP_SET_PROTO(is_gfx_animated)
TP_SET_PROTO(is_gfx_animated_can_vflip)
TP_SET_PROTO(is_gfx_animated_no_dir)
TP_SET_PROTO(is_gfx_bounce_on_move)
TP_SET_PROTO(is_gfx_animated_can_hflip)
TP_SET_PROTO(is_gfx_dead_anim)
TP_SET_PROTO(is_gfx_an_animation_only)
TP_SET_PROTO(is_floor_deco)
TP_SET_PROTO(is_wall_deco)
TP_SET_PROTO(is_gfx_weapon_carry_anim)
TP_SET_PROTO(is_gfx_attack_anim)
TP_SET_PROTO(is_gfx_large_shadow)
TP_SET_PROTO(is_gfx_oversized_but_sitting_on_the_ground)
TP_SET_PROTO(is_gfx_show_outlined)
TP_SET_PROTO(is_gfx_small_shadow_caster)
TP_SET_PROTO(hunger_clock_freq_ms)
TP_SET_PROTO(is_gfx_on_fire_anim)
...
TP_SET_PROTO(is_gfx_bounce_always)
