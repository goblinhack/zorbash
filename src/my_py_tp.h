...
TP_SET_PROTO(is_not_stackable)
TP_SET_PROTO(is_mundane_item)
TP_SET_PROTO(is_bag)
TP_SET_PROTO(has_capacity)
TP_SET_PROTO(is_potion)
TP_SET_PROTO(is_sidebar_item)
