...
TP_SET_PROTO(ai_can_learn_skills)
TP_SET_PROTO(ai_can_enchant_weapons)
TP_SET_PROTO(ai_can_attack_generators)
TP_SET_PROTO(is_ai_wanderer)
...
TP_SET_PROTO(ai_enemy_memory)
TP_SET_PROTO(is_debug_path)
TP_SET_PROTO(is_ai_can_collect_keys)
