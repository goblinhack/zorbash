...
TP_SET_PROTO(is_double_damage_from_fire)
TP_SET_PROTO(is_double_damage_from_water)
...
TP_SET_PROTO(is_fire_hater)
TP_SET_PROTO(is_flammable)
TP_SET_PROTO(is_floating)
TP_SET_PROTO(is_floor)
TP_SET_PROTO(is_floor_deco)
TP_SET_PROTO(is_food)
TP_SET_PROTO(is_generator)
TP_SET_PROTO(is_gfx_health_bar_shown)
TP_SET_PROTO(is_gfx_health_bar_shown_only_when_injured)
TP_SET_PROTO(is_gfx_moves_ahead_shown)
...
TP_SET_PROTO(is_item_class_a)
TP_SET_PROTO(is_item_class_b)
...
TP_SET_PROTO(ascii_show_outlined)
TP_SET_PROTO(is_shown_uniquely_on_monstbar)
TP_SET_PROTO(is_stamina_check)
TP_SET_PROTO(is_gfx_shown_in_bg)
...
TP_SET_PROTO(stats_stamina)
TP_SET_PROTO(stats_attack_dice)
