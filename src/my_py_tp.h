...
TP_SET_PROTO(gfx_moves_ahead_shown)
...
TP_SET_PROTO(is_poison_lover)
TP_SET_PROTO(is_double_damage_from_poison)
TP_SET_PROTO(is_poison_hater)
...
TP_SET_PROTO(stats_throw_distance)
TP_SET_PROTO(stats_stamina)
TP_SET_PROTO(stats_attack_melee_dice)
TP_SET_PROTO(stats_attack_poison_dice)
TP_SET_PROTO(stats_defence)
TP_SET_PROTO(stats_health_hunger_pct)
TP_SET_PROTO(stats_health_initial_dice)
