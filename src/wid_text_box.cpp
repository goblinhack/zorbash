...
{_
...

    {
        ...
        wid_set_shape_box(wid_text_box_container);
    ...
    wid_vert_scroll =
        wid_new_vert_scroll_bar(wid_text_box_container, "", wid_text_area);
    wid_horiz_scroll =
        wid_new_horiz_scroll_bar(wid_text_box_container, "", wid_text_area);
