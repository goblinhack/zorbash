...
void Level::chances_of_creating_set(void)
{
  ...
  switch (difficulty_depth) {
    ...
    case 1:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 1000;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 0;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 0;
      }
    ...
    case 2:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 1000;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 100;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 0;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 0;
      }
    ...
    case 3:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 1000;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 100;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 0;
      }
      d1000_chance_of_creating_mob_challenge_class_a = 500;
      d1000_chance_of_creating_mob_challenge_class_b = 500;
    ...
    case 4:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 200;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 100;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 10;
      }
      d1000_chance_of_creating_mob_challenge_class_a = 500;
      d1000_chance_of_creating_mob_challenge_class_b = 500;
      d1000_chance_of_creating_treasure_class_a      = 1000;
    ...
    case 5:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 100;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 100;
      }
    ...
    case 6:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 500;
      }
      d1000_chance_of_creating_mob_challenge_class_a = 100;
      d1000_chance_of_creating_mob_challenge_class_b = 500;
      d1000_chance_of_creating_treasure_class_a      = 10;
    ...
    case 8:
      for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
        ...
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ] = 10;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ] = 500;
        d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ] = 1000;
      }
      d1000_chance_of_creating_mob_challenge_class_a = 10;
      d1000_chance_of_creating_mob_challenge_class_b = 10;
      d1000_chance_of_creating_treasure_class_a      = 10;
  ...
  for (auto t = (int) MONST_TYPE_NORMAL; t < MONST_TYPE_MAX; t++) {
    for (auto c = (int) MONST_CLASS_A; c < MONST_CLASS_MAX; c++) {
      if (d1000_chance_of_creating_monst[ t ][ c ] < 0) {
        d1000_chance_of_creating_monst[ t ][ c ] = 0;
      }
      if (d1000_chance_of_creating_monst[ t ][ c ] > 1000) {
        d1000_chance_of_creating_monst[ t ][ c ] = 1000;
      }
    }
  }
  ...
  auto t = MONST_TYPE_NORMAL;
  dbg("- d1000 monst_class_a         %u", d1000_chance_of_creating_monst[ t ][ MONST_CLASS_A ]);
  dbg("- d1000 monst_class_b         %u", d1000_chance_of_creating_monst[ t ][ MONST_CLASS_B ]);
  dbg("- d1000 monst_class_c         %u", d1000_chance_of_creating_monst[ t ][ MONST_CLASS_C ]);
  dbg("- d1000 monst_class_d         %u", d1000_chance_of_creating_monst[ t ][ MONST_CLASS_D ]);
  dbg("- d1000 monst_class_e         %u", d1000_chance_of_creating_monst[ t ][ MONST_CLASS_E ]);
