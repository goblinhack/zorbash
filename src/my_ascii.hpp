...
void ascii_draw_line_fg4(int x0, int y0, int x1, int y1, wchar_t ch, color c);
void ascii_draw_line_fg3(int x0, int y0, int x1, int y1, wchar_t ch, color c);
void ascii_draw_line_fg2(int x0, int y0, int x1, int y1, wchar_t ch, color c);
void ascii_draw_line_fg1(int x0, int y0, int x1, int y1, wchar_t ch, color c);
void ascii_draw_line_bg(int x0, int y0, int x1, int y1, wchar_t ch, color c);
void ascii_draw_line_bg2(int x0, int y0, int x1, int y1, wchar_t ch, color c);
...
void ascii_put_box(box_args b, int style, Tilep bg, Tilep fg, Tilep fg2, Tilep fg3, const wchar_t *fmt, ...);
