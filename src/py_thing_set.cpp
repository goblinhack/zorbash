  ...
  {                                                                                                                  \
    ...
    if (! id) {                                                                                                      \
      ...
      Py_RETURN_FALSE;                                                                                               \
                                                                                                                     ...
                                                                                                                     \
    if (! oid) {                                                                                                     \
      PY_ERR("%s: No oid thing ID set", __FUNCTION__);                                                               \
      Py_RETURN_FALSE;                                                                                               \
    }                                                                                                                \
                                                                                                                     \
    Thingp t = game->thing_find(id);                                                                                 \
    ...
    if (unlikely(! t)) {                                                                                             \
      PY_ERR("%s: Cannot find thing ID %u", __FUNCTION__, oid);                                                      \
      Py_RETURN_FALSE;                                                                                               \
    }                                                                                                                \
                                                                                                                     \
    t->__api__(o);                                                                                                   \
...
THING_BODY_SET_INT(thing_confused_count_decr, confused_count_decr)
THING_BODY_SET_INT(thing_confused_count_incr, confused_count_incr)
THING_BODY_SET_INT(thing_confused_count_set, confused_count_set)
THING_BODY_SET_INT(thing_entranced_count_decr, entranced_count_decr)
THING_BODY_SET_INT(thing_entranced_count_incr, entranced_count_incr)
THING_BODY_SET_INT(thing_entranced_count_set, entranced_count_set)
