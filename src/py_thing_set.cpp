...
THING_BODY_SET_INT(thing_confusion_count_decr, confusion_count_decr)
THING_BODY_SET_INT(thing_confusion_count_incr, confusion_count_incr)
THING_BODY_SET_INT(thing_confusion_count_set, confusion_count_set)
