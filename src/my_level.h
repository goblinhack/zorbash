...
#define FOR_ALL_DEBUG_PATH_THINGS(level, t, x, y)                                                                      \
  ...
  void create_dungeon_place_floors(Dungeonp d, const std::string what, int depth, int variant, int block_width,
  ...
  bool fov_calculete(struct FovMap_ *fov, int pov_x, int pov_y, int max_radius, bool light_walls);
};
