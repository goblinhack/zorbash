...
void gl_push(float **P, float *p_end, uint8_t first_vertex, float tex_left, float tex_top, float tex_right,
             float tex_bottom, point tl, point tr, point bl, point br, uint8_t r1, uint8_t g1, uint8_t b1, uint8_t a1,
...
void blit(int tex, float texMinX, float texMinY, float texMaxX, float texMaxY, point tl, point tr, point bl, point br)
{
  ...
  gl_push(&bufp, bufp_end, first_vertex, texMinX, texMinY, texMaxX, texMaxY, tl, tr, bl, br, r, g, b, a, r, g, b, a,
          r, g, b, a, r, g, b, a);
}
