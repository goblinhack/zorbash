...
std::istream &operator>>(std::istream &in, Bits< Thingp & > my)
{
  ...
  // begin sort marker2 {
             ...
             my.t->is_floating_                                 = ((bits64 >> shift) & 1LLU) ? 1LLU : 0LLU; shift++;
             ...
             my.t->is_the_grid_                                 = ((bits64 >> shift) & 1LLU) ? 1LLU : 0LLU; shift++;
  ...
  // begin sort marker3 {
             ...
             my.t->i_set_is_spell_of_sanctuary_barrier    = ((bits64 >> shift) & 1LLU) ? 1LLU : 0LLU; shift++;
