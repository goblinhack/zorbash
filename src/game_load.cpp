...
{_
    ...
    /////////////////////////////////////////////////////////////////////////
    /* ThingId     */ in >> bits(my.t->on_fire_id_anim);
    /* ThingId     */ in >> bits(my.t->owner_id);
    /* ThingId     */ in >> bits(my.t->weapon_id);
    /* ThingId     */ in >> bits(my.t->weapon_id_carry_anim);
    /* ThingId     */ in >> bits(my.t->weapon_id_use_anim);
    ...
    /* std::list<ThingId>   */ in >> bits(my.t->carrying);
    /* std::string          */ in >> bits(my.t->msg);
    /* std::vector<ThingId> */ in >> bits(my.t->actionbar_id);
    /* std::vector<ThingId> */ in >> bits(my.t->enemies);
    ...
    /* uint32_t    */ in >> bits(my.t->tick_last_did_something);
    /* uint32_t    */ in >> bits(my.t->tick_last_escape);
    /////////////////////////////////////////////////////////////////////////
    // ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^
    // | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
    //
