...
{_
    ...
    /* timestamp_t  timestamp_born            */ in >> bits(my.t->timestamp_born);
    /* timestamp_t  timestamp_bounce_begin    */ in >> bits(my.t->timestamp_bounce_begin);
    /* timestamp_t  timestamp_bounce_end      */ in >> bits(my.t->timestamp_bounce_end);
    /* timestamp_t  timestamp_fadeup_begin    */ in >> bits(my.t->timestamp_fadeup_begin);
    /* timestamp_t  timestamp_fadeup_end      */ in >> bits(my.t->timestamp_fadeup_end);
    /* timestamp_t  timestamp_fall_begin      */ in >> bits(my.t->timestamp_fall_begin);
    /* timestamp_t  timestamp_fall_end        */ in >> bits(my.t->timestamp_fall_end);
    /* timestamp_t  timestamp_flip_start      */ in >> bits(my.t->timestamp_flip_start);
    /* timestamp_t  timestamp_hunger_tick     */ in >> bits(my.t->timestamp_hunger_tick);
    /* timestamp_t  timestamp_last_tick       */ in >> bits(my.t->timestamp_last_tick);
    /* timestamp_t  timestamp_last_ticked     */ in >> bits(my.t->timestamp_last_ticked);
    /* timestamp_t  timestamp_last_wander_try */ in >> bits(my.t->timestamp_last_wander_try);
    /* timestamp_t  timestamp_lunge_begin     */ in >> bits(my.t->timestamp_lunge_begin);
    /* timestamp_t  timestamp_lunge_end       */ in >> bits(my.t->timestamp_lunge_end);
    /* timestamp_t  timestamp_move_begin      */ in >> bits(my.t->timestamp_move_begin);
    /* timestamp_t  timestamp_move_end        */ in >> bits(my.t->timestamp_move_end);
