...
Tpp Level::level_biome_dungeon_random_monst(Dungeonp d, point p)
{
...
Tpp Level::tp_random_biome_dungeon_monst(const point p)
{
  TRACE_NO_INDENT();
  auto tries = 0U;
  for (;;) {
    ...
    auto tpp = ::tp_random_biome_dungeon_monst();
...
Tpp Level::tp_random_biome_dungeon_monst_class_a(const point p)
{
  ...
  for (;;) {
    if (tries++ > 10000) {
      ...
      return tp_random_biome_dungeon_monst(p);
    }
...
Tpp tp_random_biome_dungeon_monst(void)
{
  TRACE_NO_INDENT();
  if (unlikely(! tp_biome_dungeon_monst.size())) {
    ERR("No monsts found");
    return nullptr;
  }
  return tp_get_with_rarity_filter(tp_biome_dungeon_monst);
}

Tpp tp_random_biome_dungeon_monst_class_a(void)
{
#if 0
  ...
  if (unlikely(! tp_biome_dungeon_monst_class_a.size())) {
    return tp_random_biome_dungeon_monst();
  }
  return tp_get_with_rarity_filter(tp_biome_dungeon_monst_class_a);
}

Tpp tp_random_biome_dungeon_monst_class_b(void)
{
  TRACE_NO_INDENT();
...
Tpp tp_random_biome_dungeon_monst_class_c(void)
{
  TRACE_NO_INDENT();
...
Tpp tp_random_biome_dungeon_monst_class_d(void)
{
  TRACE_NO_INDENT();
...
Tpp tp_random_biome_dungeon_monst_class_e(void)
{
  TRACE_NO_INDENT();
