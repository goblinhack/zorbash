...
#define TILE_CURSOR_CHAR  ((wchar_t) ('z' + 6))
#define TILE_BLOCK_CHAR   ((wchar_t) ('z' + 5))
#define TILE_BLOCK_STR    "3.97" // arrow
#define TILE_POINTER_STR  "3.98" // arrow
#define TILE_UNKNOWN_STR  "3.99" // ??
