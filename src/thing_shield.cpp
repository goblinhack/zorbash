...
int Thing::carried_shield_count_get(void)
{
  TRACE_NO_INDENT();
  int count = 0;
...
int Thing::carried_shield_least_value_get(Thingp *out)
{
  TRACE_NO_INDENT();
  int least_value = -1;
...
int Thing::carried_shield_highest_value_get(Thingp *out)
{
  TRACE_NO_INDENT();
  int highest_value = -1;
...
int Thing::carried_shield_highest_value_for_target_get(Thingp *out, Thingp target)
{
  TRACE_NO_INDENT();
  int highest_value = -1;
