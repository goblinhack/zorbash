...
void Thing::init_hue(void)
{
  ...
  if (gfx_ascii_bg_color_spread_blue()) {
    blit_bg_color.b =
        128 + non_pcg_random_range(0, gfx_ascii_bg_color_spread_blue() * 2) - (gfx_ascii_bg_color_spread_blue() / 2);
  }
  ...
  if (gfx_ascii_fg_color_spread_blue()) {
    blit_fg_color.b =
        128 + non_pcg_random_range(0, gfx_ascii_fg_color_spread_blue() * 2) - (gfx_ascii_fg_color_spread_blue() / 2);
  }
