...
bool py_call_bool_fn(const char *module, const char *name, int v1, int v2, int v3, int v4, int v5, int v6, int v7, int v8);
...
bool py_call_bool_fn(const char *module, const char *name, unsigned int v1, unsigned int v2, unsigned int v3, unsigned int v4);
bool py_call_bool_fn(const char *module, const char *name, unsigned int v1, unsigned int v2, unsigned int v3, unsigned int v4, unsigned int v5);
bool py_call_bool_fn(const char *module, const char *name, unsigned int v1, unsigned int v2, unsigned int v3, unsigned int v4, unsigned int v5, unsigned int v6);
bool py_call_bool_fn(const char *module, const char *name, unsigned int v1, unsigned int v2, unsigned int v3, unsigned int v4, unsigned int v5, unsigned int v6, unsigned int v7);
bool py_call_bool_fn(const char *module, const char *name, unsigned int v1, unsigned int v2, unsigned int v3, unsigned int v4, unsigned int v5, unsigned int v6, unsigned int v7, unsigned int v8);
