...
{
  if (request_reset_state_change) return;
...
{
  if (request_to_remake_rightbar) return;
...
{
  if (request_to_remake_inventory) return;
...
{
  if (request_to_remake_actionbar) return;
...
{
  if (request_to_remake_skillbox) return;
...
{
  if (request_to_remake_spellbox) return;
...
{
  if (request_to_remake_debuffbox) return;
...
{
  if (request_to_remake_buffbox) return;
...
{
  if (request_to_update_same_level) return;
...
{
  if (request_to_save_snapshot) return;
...
{
  if (currently_saving_snapshot) return;
...
{
  if (request_to_update_inventory_with_thing_over) return;
...
{
  if (request_to_update_inventory_with_thing_selected) return;
