...
#define FOR_ALL_DEBUG_PATH_THINGS(level, t, x, y)                                                                    \
  ...
  void incr_noisemap(const int x, const int y);
  void incr_noisemap_in(const int x, const int y);
  void incr_noisemap_in(const int x, const int y, int dv);
  void incr_noisemap_in_no_check(const int x, const int y);
  void incr_noisemap_in_no_check(const int x, const int y, int dv);
  void incr_noisemap_no_check(const int x, const int y);
  void incr_noisemap_no_check(const int x, const int y, int dv);
  ...
  void set_noisemap_in(const int x, const int y, uint8_t v);
  void set_noisemap_in_no_check(const int x, const int y, uint8_t v);
  ...
  void unset_noisemap(const int x, const int y);
  void unset_noisemap_in(const int x, const int y);
  void unset_noisemap_in_no_check(const int x, const int y);
  void unset_noisemap_no_check(const int x, const int y);
