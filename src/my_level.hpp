...
public:
  ...
  std::array< std::array< uint8_t, MAP_HEIGHT_MAX >, MAP_WIDTH_MAX > _is_spectral_blade {};
...
#define FOR_ALL_THINGS_SAFE_WALKER(level, t, x, y)                                                                   \
  if (! (level)->is_oob(x, y)) {                                                                                     \
    auto _copy_of_vector_ = level->all_things_ptr_at[ x ][ y ];                                                      \
    {                                                                                                                \
      for (auto t : _copy_of_vector_) {                                                                              \
...
#define FOR_ALL_DEBUG_PATH_THINGS(level, t, x, y)                                                                    \
  ...
  uint8_t is_gas_confusion(const int x, const int y) const;
  ...
  uint8_t is_gas_paralysis(const int x, const int y) const;
  uint8_t is_gas_paralysis(const point p) const;
  uint8_t is_gas_paralysis_no_check(const int x, const int y) const;
  uint8_t is_gas_paralysis_no_check(const point p) const;
  ...
  uint8_t is_spectral_blade(const int x, const int y);
  uint8_t is_spectral_blade(const point p);
  ...
  void is_gas_confusion_no_check_set(const int x, const int y, uint8_t val);
  void is_gas_confusion_no_check_unset(const int x, const int y);
  void is_gas_confusion_set(const int x, const int y, uint8_t val);
  void is_gas_confusion_unset(const int x, const int y);
  ...
  void is_gas_paralysis_no_check_set(const int x, const int y, uint8_t val);
  void is_gas_paralysis_no_check_unset(const int x, const int y);
  void is_gas_paralysis_set(const int x, const int y, uint8_t val);
  void is_gas_paralysis_unset(const int x, const int y);
  ...
  void is_spectral_blade_set(const int x, const int y);
  void is_spectral_blade_unset(const int x, const int y);
  ...
  std::deque< Thingp > flood_fill_gas_grid_things(point, int distance);
