...
#define UI_RIGHTBAR_PIXELART_HEIGHT  53
...
#define UI_DUNGEONS_DIFFICULTY_LEVEL_3_CHASMS_COLOR STEELBLUE3
#define UI_DUNGEONS_DIFFICULTY_LEVEL_4_ICE_COLOR    CYAN3
