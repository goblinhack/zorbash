...
private:
  ...
  int         _ai_is_able_to_remember_enemies_for_n_ticks {};
  int         _ai_obstacle {};
...
public:
  ...
  void               set_ai_is_able_to_remember_enemies_for_n_ticks(int);
  ...
  void               set_random_jump_chance_d1000(int);
