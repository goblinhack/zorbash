...
private:
  ...
  int         _is_rusty {};
  int         _unused_flag5 {};
  int         _ai_can_learn_skills {};
  int         _ai_can_enchant_weapons {};
  int         _ai_can_attack_generators {};
  int         _is_ai_wanderer {};
  int         _is_organic {};
  int         _is_glass {};
  int         _is_stone {};
...
public:
  ...
  void               set_is_ai_can_collect_keys(int);
  void               set_is_key(int);
  ...
  void               set_unused_flag42(int);
  void               set_unused_flag43(int);
  void               set_unused_flag44(int);
  void               set_unused_flag45(int);
  ...
  void               set_ai_can_learn_skills(int);
  void               set_ai_can_enchant_weapons(int);
  void               set_ai_can_attack_generators(int);
