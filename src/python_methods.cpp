...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_noise_additional_on_jumping_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_noise_additional_on_jumping),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(noise_additional_on_jumping),
