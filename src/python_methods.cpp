...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_noise_decibels_on_i_am_hit_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_noise_decibels_on_i_am_hit),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(noise_decibels_on_i_am_hit),
