...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_gfx_pixelart_health_bar_shown_when_awake_only_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_move_diagonally_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_sleep_at),
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_teleport_attack_at),
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_teleport_attack_chance_d1000_at),
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_teleport_escape_at),
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_teleport_without_tiring_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_use_wands_or_staffs_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_breather_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_pink_blood_at),
    MY_ADD_PYTHON_FUNCTION(level_is_pink_blood_eater_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_gfx_ascii_color_spread_green_at),
    MY_ADD_PYTHON_FUNCTION(level_gfx_ascii_color_spread_red_at),
    MY_ADD_PYTHON_FUNCTION(level_attack_no_msg_at),
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_attack_owner_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_gfx_ascii_color_spread_alpha_at),
    MY_ADD_PYTHON_FUNCTION(level_gfx_ascii_color_spread_blue_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_damage_nat_attack),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_gfx_pixelart_health_bar_shown_when_awake_only),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_breather),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_pink_blood),
    MY_ADD_PYTHON_FUNCTION(thing_is_pink_blood_eater),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_gfx_ascii_color_spread_green),
    MY_ADD_PYTHON_FUNCTION(thing_gfx_ascii_color_spread_red),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_gfx_ascii_color_spread_alpha),
    MY_ADD_PYTHON_FUNCTION(thing_gfx_ascii_color_spread_blue),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(damage_nat_attack_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(damage_nat_attack_type),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(gfx_pixelart_health_bar_shown_when_awake_only),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_breather),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_pink_blood),
    MY_ADD_PYTHON_TP_FUNCTION(is_pink_blood_eater),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(long_text_description2),
    MY_ADD_PYTHON_TP_FUNCTION(long_text_description3),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_damage_stat_str_do),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_damage_stat_str_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_damage_stat_str_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_remove_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_polymorphed_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_damage_stat_str_do),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_you_nat_attack_do),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(gfx_ascii_color_spread_green),
    MY_ADD_PYTHON_TP_FUNCTION(gfx_ascii_color_spread_red),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(gfx_ascii_color_spread_alpha),
    MY_ADD_PYTHON_TP_FUNCTION(gfx_ascii_color_spread_blue),
