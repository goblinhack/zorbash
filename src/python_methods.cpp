...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(thing_current_damage_decr),
    MY_ADD_PYTHON_FUNCTION(thing_enchant_decr),
    MY_ADD_PYTHON_FUNCTION(thing_enchant_max_decr),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_current_damage_incr),
    MY_ADD_PYTHON_FUNCTION(thing_enchant_incr),
    MY_ADD_PYTHON_FUNCTION(thing_enchant_max_incr),
