...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_collision_hit_two_ahead_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_collision_hit_two_ahead),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(collision_hit_two_ahead),
