...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_noise_blocker_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_noise_level_able_to_hear_at),
    MY_ADD_PYTHON_FUNCTION(level_is_noise_blocker_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_noise_level_able_to_hear),
    MY_ADD_PYTHON_FUNCTION(thing_is_noise_blocker),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_noise_level_able_to_hear),
    MY_ADD_PYTHON_TP_FUNCTION(is_noise_blocker),
