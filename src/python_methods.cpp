...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_collision_hit_all_adjacent_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_victim_select),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_collision_hit_all_adjacent),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_victim_select),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(collision_hit_all_adjacent),
