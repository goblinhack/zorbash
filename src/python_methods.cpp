...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_distance_teleport_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_distance_jump_get),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_distance_teleport),
    MY_ADD_PYTHON_FUNCTION(thing_distance_teleport_get),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(distance_teleport),
