...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_constitution),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_set_constitution),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(constitution),
    MY_ADD_PYTHON_TP_FUNCTION(dexterity),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(strength),
