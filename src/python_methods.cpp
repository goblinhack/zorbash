...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(thing_msg_is_seen),
    MY_ADD_PYTHON_FUNCTION(thing_msg_is_wounded),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(msg_is_seen),
    MY_ADD_PYTHON_TP_FUNCTION(msg_is_wounded),
