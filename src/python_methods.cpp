...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_temperature_change_sensitive_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_damage_acid_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_cold_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_cold_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_crush_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_crush_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_current_decr),
    MY_ADD_PYTHON_FUNCTION(thing_damage_current_get),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_damage_digest_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_energy_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_energy_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_fire_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_fire_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future1_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future1_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future2_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future2_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future3_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_future3_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_lightning_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_lightning_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_melee_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_natural_attack_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_necrosis_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_necrosis_get),
    MY_ADD_PYTHON_FUNCTION(thing_damage_poison_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_damage_poison_get),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_temperature_change_sensitive),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(temperature_change_sensitive),
