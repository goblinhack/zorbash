...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_toughness_indestructible_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_toughness_indestructible),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_toughness_indestructible),
