...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_gfx_ascii_animated_at),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_attacking_dmg_nat_attack_do),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_attacking_dmg_stat_str_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_acid_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_cold_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_crush_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_digest_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_draining_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_energy_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_fire_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_future1_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_future2_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_future3_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_lightning_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_melee_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_nat_attack_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_necrosis_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_poison_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_stat_att_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_stat_con_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_owner_receiving_dmg_stat_str_do),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_receiving_dmg_nat_attack_do),
