...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(thing_gfx_pixelart_reflection),
    MY_ADD_PYTHON_FUNCTION(thing_gfx_pixelart_shadow),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_submerged),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_submerged),
