...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_damage_current),
    MY_ADD_PYTHON_FUNCTION(thing_get_damage_acid),
    MY_ADD_PYTHON_FUNCTION(thing_get_damage_cold),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_immediate_mob_id),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_set_damage_current),
