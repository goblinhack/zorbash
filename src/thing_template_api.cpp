...
const std::string &Tp::on_owner_set_do(void) const { return _on_owner_set_do; }
...
int Tp::environ_prefers_acid(void) const { return _environ_prefers_acid; }
int Tp::environ_prefers_fire(void) const { return _environ_prefers_fire; }
int Tp::environ_prefers_necrosis(void) const { return _environ_prefers_necrosis; }
int Tp::environ_prefers_poison(void) const { return _environ_prefers_poison; }
int Tp::environ_prefers_spiderwebs(void) const { return _environ_prefers_spiderwebs; }
int Tp::environ_prefers_water(void) const { return _environ_prefers_water; }
...
void Tp::set_environ_avoids_fire(int v) { _environ_avoids_fire = v; }
void Tp::set_environ_avoids_necrosis(int v) { _environ_avoids_necrosis = v; }
void Tp::set_environ_avoids_poison(int v) { _environ_avoids_poison = v; }
void Tp::set_environ_avoids_water(int v) { _environ_avoids_water = v; }
void Tp::set_environ_prefers_acid(int v) { _environ_prefers_acid = v; }
void Tp::set_environ_prefers_fire(int v) { _environ_prefers_fire = v; }
void Tp::set_environ_prefers_necrosis(int v) { _environ_prefers_necrosis = v; }
void Tp::set_environ_prefers_poison(int v) { _environ_prefers_poison = v; }
void Tp::set_environ_prefers_spiderwebs(int v) { _environ_prefers_spiderwebs = v; }
void Tp::set_environ_prefers_water(int v) { _environ_prefers_water = v; }
...
void Tp::set_on_owner_set_do(const std::string &v) { _on_owner_set_do = v; }
void Tp::set_on_owner_unset_do(const std::string &v) { _on_owner_unset_do = v; }
