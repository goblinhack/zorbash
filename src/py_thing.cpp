...
THING_BODY_GET_BOOL(thing_ai_can_learn_skills, ai_can_learn_skills)
THING_BODY_GET_BOOL(thing_ai_can_enchant_weapons, ai_can_enchant_weapons)
THING_BODY_GET_BOOL(thing_ai_can_attack_generators, ai_can_attack_generators)
...
THING_BODY_GET_BOOL(thing_is_ai_can_collect_keys, is_ai_can_collect_keys)
