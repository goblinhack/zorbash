...
THING_BODY_GET_BOOL(thing_ai_is_able_to_attack_generators, ai_is_able_to_attack_generators)
THING_BODY_GET_BOOL(thing_ai_is_able_to_break_down_doors, ai_is_able_to_break_down_doors)
THING_BODY_GET_BOOL(thing_ai_is_able_to_break_out_of_webs, ai_is_able_to_break_out_of_webs)
THING_BODY_GET_BOOL(thing_ai_is_able_to_collect_keys, ai_is_able_to_collect_keys)
THING_BODY_GET_BOOL(thing_ai_is_able_to_detect_secret_doors_when_close, ai_is_able_to_detect_secret_doors_when_close)
THING_BODY_GET_BOOL(thing_ai_is_able_to_enchant_weapons, ai_is_able_to_enchant_weapons)
...
THING_BODY_GET_BOOL(thing_ai_is_able_to_learn_skills, ai_is_able_to_learn_skills)
THING_BODY_GET_BOOL(thing_ai_is_able_to_open_doors, ai_is_able_to_open_doors)
THING_BODY_GET_BOOL(thing_ai_is_able_to_see_through_doors, ai_is_able_to_see_through_doors)
THING_BODY_GET_BOOL(thing_ai_is_able_to_walk_through_walls, ai_is_able_to_walk_through_walls)
THING_BODY_GET_BOOL(thing_ai_is_exit_finder, ai_is_exit_finder)
THING_BODY_GET_BOOL(thing_ai_is_item_collector, ai_is_item_collector)
THING_BODY_GET_BOOL(thing_ai_is_level_explorer, ai_is_level_explorer)
...
THING_BODY_GET_BOOL(thing_environ_loves_acid, environ_loves_acid)
THING_BODY_GET_BOOL(thing_environ_loves_fire, environ_loves_fire)
THING_BODY_GET_BOOL(thing_environ_loves_poison, environ_loves_poison)
THING_BODY_GET_BOOL(thing_environ_loves_spiderwebs, environ_loves_spiderwebs)
THING_BODY_GET_BOOL(thing_environ_loves_water, environ_loves_water)
...
THING_BODY_GET_BOOL(thing_attack_poison_chance_d1000, attack_poison_chance_d1000)
...
THING_BODY_GET_BOOL(thing_is_weapon_equiper, is_weapon_equiper)
...
THING_BODY_GET_BOOL(thing_ai_aggression_level, ai_aggression_level)
...
THING_BODY_GET_INT(thing_get_poison, get_poison)
...
THING_BODY_SET_INT(thing_decr_poison, decr_poison)
...
THING_BODY_SET_INT(thing_incr_poison, incr_poison)
...
THING_BODY_SET_INT(thing_set_poison, set_poison)
