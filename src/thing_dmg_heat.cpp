...
int Thing::chance_d1000_dmg_heat(int index)
{
  TRACE_NO_INDENT();
  return (tp()->chance_d1000_dmg_heat(index));
}
...
int Tp::chance_d1000_dmg_heat(int index) const
{
  if (index >= (int) _chance_d1000_dmg_heat.size()) {
    return 0;
  }
  return _chance_d1000_dmg_heat[ index ];
}

void Tp::chance_d1000_dmg_heat_set(int index, int v)
{
  _chance_d1000_dmg_heat.resize(index + 1);
  _chance_d1000_dmg_heat[ index ] = v;
}
