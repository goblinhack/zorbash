...
public:
  ...
  int total_damage_for_on_attacking_dmg_nat_attack(Thingp victim, int damage);
  ...
  int total_damage_for_on_receiving_dmg_nat_attack(Thingp hitter, Thingp real_hitter, int damage);
  ...
  int gfx_ascii_color_spread_hue(void);
