...
public:
  ...
  const std::string &on_attacking_dmg_nat_attack_do(void);
  ...
  const std::string &on_owner_attacking_dmg_acid_do(void);
  const std::string &on_owner_attacking_dmg_cold_do(void);
  const std::string &on_owner_attacking_dmg_crush_do(void);
  const std::string &on_owner_attacking_dmg_digest_do(void);
  const std::string &on_owner_attacking_dmg_draining_do(void);
  const std::string &on_owner_attacking_dmg_energy_do(void);
  const std::string &on_owner_attacking_dmg_fire_do(void);
  const std::string &on_owner_attacking_dmg_future1_do(void);
  const std::string &on_owner_attacking_dmg_future2_do(void);
  const std::string &on_owner_attacking_dmg_future3_do(void);
  const std::string &on_owner_attacking_dmg_lightning_do(void);
  const std::string &on_owner_attacking_dmg_melee_do(void);
  const std::string &on_owner_attacking_dmg_nat_attack_do(void);
  const std::string &on_owner_attacking_dmg_necrosis_do(void);
  const std::string &on_owner_attacking_dmg_poison_do(void);
  const std::string &on_owner_attacking_dmg_stat_att_do(void);
  const std::string &on_owner_attacking_dmg_stat_con_do(void);
  const std::string &on_owner_attacking_dmg_stat_str_do(void);
  const std::string &on_owner_receiving_dmg_acid_do(void);
  const std::string &on_owner_receiving_dmg_cold_do(void);
  const std::string &on_owner_receiving_dmg_crush_do(void);
  const std::string &on_owner_receiving_dmg_digest_do(void);
  const std::string &on_owner_receiving_dmg_draining_do(void);
  const std::string &on_owner_receiving_dmg_energy_do(void);
  const std::string &on_owner_receiving_dmg_fire_do(void);
  const std::string &on_owner_receiving_dmg_future1_do(void);
  const std::string &on_owner_receiving_dmg_future2_do(void);
  const std::string &on_owner_receiving_dmg_future3_do(void);
  const std::string &on_owner_receiving_dmg_lightning_do(void);
  const std::string &on_owner_receiving_dmg_melee_do(void);
  const std::string &on_owner_receiving_dmg_nat_attack_do(void);
  const std::string &on_owner_receiving_dmg_necrosis_do(void);
  const std::string &on_owner_receiving_dmg_poison_do(void);
  const std::string &on_owner_receiving_dmg_stat_att_do(void);
  const std::string &on_owner_receiving_dmg_stat_con_do(void);
  const std::string &on_owner_receiving_dmg_stat_str_do(void);
  ...
  const std::string &on_receiving_dmg_nat_attack_do(void);
  ...
  int get_total_damage_for_on_attacking_dmg_acid(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_cold(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_crush(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_digest(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_draining(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_energy(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_fire(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_future1(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_future2(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_future3(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_lightning(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_melee(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_nat_attack(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_necrosis(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_poison(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_stat_att(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_stat_con(Thingp victim, int damage);
  int get_total_damage_for_on_attacking_dmg_stat_str(Thingp victim, int damage);
  int get_total_damage_for_on_receiving_dmg_acid(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_cold(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_crush(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_digest(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_draining(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_energy(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_fire(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_future1(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_future2(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_future3(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_lightning(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_melee(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_nat_attack(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_necrosis(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_poison(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_stat_att(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_stat_con(Thingp hitter, Thingp real_hitter, int damage);
  int get_total_damage_for_on_receiving_dmg_stat_str(Thingp hitter, Thingp real_hitter, int damage);
  ...
  int on_attacking_dmg_nat_attack(Thingp victim, int damage);
  ...
  int on_owner_attacking_dmg_acid(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_cold(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_crush(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_digest(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_draining(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_energy(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_fire(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_future1(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_future2(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_future3(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_lightning(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_melee(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_nat_attack(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_necrosis(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_poison(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_stat_att(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_stat_con(Thingp owner, Thingp victim, int damage);
  int on_owner_attacking_dmg_stat_str(Thingp owner, Thingp victim, int damage);
  int on_owner_receiving_dmg_acid(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_cold(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_crush(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_digest(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_draining(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_energy(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_fire(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_future1(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_future2(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_future3(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_lightning(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_melee(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_nat_attack(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_necrosis(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_poison(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_stat_att(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_stat_con(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receiving_dmg_stat_str(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  ...
  int on_receiving_dmg_nat_attack(Thingp hitter, Thingp real_hitter, int damage);
