...
public:
  ...
  int decr_stat_att_mod(int);
  int decr_stat_att_mod(void);
  int decr_stat_con(int);
  int decr_stat_con_mod(int);
  int decr_stat_con_mod(void);
  int decr_stat_con(void);
  int decr_stat_def(int);
  int decr_stat_def_mod(int);
  int decr_stat_def_mod(void);
  ...
  int incr_stat_att_mod(int);
  int incr_stat_att_mod(void);
  int incr_stat_con(int);
  int incr_stat_con_mod(int);
  int incr_stat_con_mod(void);
  int incr_stat_con(void);
  int incr_stat_def(int);
  int incr_stat_def_mod(int);
  int incr_stat_def_mod(void);
  ...
  int set_stat_att_mod(int);
  int set_stat_con(int);
  int set_stat_con_mod(int);
  ...
  int unused_flag138(void);
  int unused_flag139(void);
