...
public:
  ...
  inline int is_player_bodypart(void) { return (mytp->is_player_bodypart()); }
  inline int is_player(void) { return is_the_player; }
  inline int is_monst(void) { return (mytp->is_monst()); }
  inline int is_interesting(void) { return (mytp->is_interesting()); }
  inline int is_internal(void) { return (mytp->is_internal()); }
  inline int is_animation(void) { return (mytp->is_animation()); }
  inline int is_tickable(void) { return (mytp->is_tickable()); }
