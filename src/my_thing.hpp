...
public:
  ...
  int on_receiving_damage_acid(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_cold(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_cold(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_crush(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_crush(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_digest(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_digest(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_draining(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_draining(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_energy(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_energy(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_fire(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_fire(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future1(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future1(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future2(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future2(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future3(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_future3(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_lightning(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_lightning(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_melee(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_melee(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_nat_attack(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_nat_attack(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_necrosis(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_necrosis(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_poison(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_poison(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stamina(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stamina(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_att(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_att(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_con(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_con(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_str(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_damage_stat_str(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
