...
public:
  ...
  ThingId equip_id_carry_anim_get(int equip);
  ThingId equip_id_use_anim_get(int equip);
  ...
  const Dice &damage_natural_dice_get(void);
  const Dice &damage_crush_dice_get(void);
  const Dice &damage_melee_dice_get(void);
  const Dice &damage_poison_dice_get(void);
  const Dice &damage_future1_dice_get(void);
  const Dice &damage_future2_dice_get(void);
  const Dice &damage_future3_dice_get(void);
  const Dice &damage_cold_dice_get(void);
  const Dice &damage_fire_dice_get(void);
  const Dice &damage_lightning_dice_get(void);
  const Dice &damage_energy_dice_get(void);
  const Dice &damage_acid_dice_get(void);
  const Dice &damage_digest_dice_get(void);
  const Dice &damage_necrosis_dice_get(void);

  const Dice &gold_value_dice_get(void);
  const Dice &health_initial_dice_get(void);
  const Dice &lifespan_dice_get(void);
  const Dice &nutrition_dice_get(void);
  const Dice &on_idle_tick_frequency_dice_get(void);
  const Dice &spawn_group_size_dice_get(void);
  const Dice &resurrect_dice_get(void);
  ...
  const std::string damage_acid_dice_str_get(void);
  const std::string damage_cold_dice_str_get(void);
  const std::string damage_crush_dice_str_get(void);
  const std::string damage_digest_dice_str_get(void);
  const std::string damage_energy_dice_str_get(void);
  const std::string damage_fire_dice_str_get(void);
  const std::string damage_future1_dice_str_get(void);
  const std::string damage_future2_dice_str_get(void);
  const std::string damage_future3_dice_str_get(void);
  const std::string damage_lightning_dice_str_get(void);
  const std::string damage_melee_dice_str_get(void);
  const std::string damage_natural_dice_str_get(void);
  const std::string damage_necrosis_dice_str_get(void);
  const std::string damage_poison_dice_str_get(void);
  ...
  const std::string &gold_value_dice_str_get(void);
  const std::string &health_initial_dice_str_get(void);
  const std::string &lifespan_dice_str_get(void);
  const std::string &msg_get(void);
  const std::string &nutrition_dice_str_get(void);
  const std::string &on_idle_tick_frequency_dice_str_get(void);
  const std::string &resurrect_dice_str_get(void);
  const std::string &spawn_group_size_dice_str_get(void);
  ...
  float bounce_fade_get(void);
  float bounce_height_get(void);
  float bounce_get(void);
  float distance_avoid_get(void);
  float distance_from_leader_get(point p);
  float distance_from_leader_get(void);
  float distance_from_mob_get(point p);
  float distance_from_mob_get(void);
  float distance_leader_max_get(point p);
  float distance_leader_max_get(void);
  float distance_mob_max_get(point p);
  float distance_mob_max_get(void);
  float distance_recruitment_max_get(point p);
  float distance_recruitment_max_get(void);
  float distance_throw_get(void);
  float distance_vision_get(void);
  float fadeup_fade_get(void);
  float fadeup_height_get(void);
  ...
  int attack_modifier_get(Thingp victim);
  ...
  int carried_amulet_count_get(void);
  int carried_amulet_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_amulet_highest_value_get(Thingp *out);
  int carried_amulet_least_value_get(Thingp *out);
  int carried_armor_count_get(void);
  int carried_armor_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_armor_highest_value_get(Thingp *out);
  int carried_armor_least_value_get(Thingp *out);
  int carried_boots_count_get(void);
  int carried_boots_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_boots_highest_value_get(Thingp *out);
  int carried_boots_least_value_get(Thingp *out);
  int carried_cloak_count_get(void);
  int carried_cloak_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_cloak_highest_value_get(Thingp *out);
  int carried_cloak_least_value_get(Thingp *out);
  int carried_food_count_get(void);
  int carried_food_highest_value_get(Thingp *out);
  int carried_food_least_value_get(Thingp *out);
  int carried_gauntlet_count_get(void);
  int carried_gauntlet_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_gauntlet_highest_value_get(Thingp *out);
  int carried_gauntlet_least_value_get(Thingp *out);
  int carried_helmet_count_get(void);
  int carried_helmet_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_helmet_highest_value_get(Thingp *out);
  int carried_helmet_least_value_get(Thingp *out);
  int carried_ring_count_get(void);
  int carried_ring_highest_value_get(Thingp *out);
  int carried_ring_least_value_get(Thingp *out);
  int carried_shield_count_get(void);
  int carried_shield_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_shield_highest_value_get(Thingp *out);
  int carried_shield_least_value_get(Thingp *out);
  int carried_wand_count_get(void);
  int carried_wand_highest_value_for_target_get(Thingp *out, Thingp target);
  int carried_wand_highest_value_get(Thingp *out);
  int carried_wand_least_value_get(Thingp *out);
  int carried_weapon_count_get(void);
  int carried_weapon_highest_value_get(Thingp *out);
  int carried_weapon_least_value_get(Thingp *out);
  int charge_count_decr(int);
  int charge_count_decr(void);
  int charge_count_get(void);
  ...
  int current_damage_decr(int);
  int current_damage_decr(void);
  int current_damage_get(void);
  int current_damage_incr(int);
  int current_damage_incr(void);
  int current_damage_set(int);
  int damage_acid_chance_d1000(void);
  int damage_acid_get(void);
  int damage_cold_chance_d1000(void);
  int damage_cold_get(void);
  int damage_crush_chance_d1000(void);
  int damage_crush_get(void);
  int damage_digest_chance_d1000(void);
  int damage_digest_get(void);
  int damage_energy_chance_d1000(void);
  int damage_energy_get(void);
  int damage_fire_chance_d1000(void);
  int damage_fire_get(void);
  int damage_future1_chance_d1000(void);
  int damage_future1_get(void);
  int damage_future2_chance_d1000(void);
  int damage_future2_get(void);
  int damage_future3_chance_d1000(void);
  int damage_future3_get(void);
  int damage_lightning_chance_d1000(void);
  int damage_lightning_get(void);
  int damage_max_get(void);
  int damage_melee_chance_d1000(void);
  int damage_melee_get(void);
  int damage_min_get(void);
  int damage_natural_attack_chance_d1000(void);
  int damage_natural_attack_get(void);
  int damage_necrosis_chance_d1000(void);
  int damage_necrosis_get(void);
  int damage_poison_chance_d1000(void);
  int damage_poison_get(void);
  ...
  int enchant_max_decr(int);
  int enchant_max_decr(void);
  int enchant_max_get(void);
  int enchant_max_incr(int);
  int enchant_max_incr(void);
  ...
  int prev_light_power_decr(int);
  int prev_light_power_decr(void);
  int prev_light_power_get(void);
  int prev_light_power_incr(int);
  int prev_light_power_incr(void);
  ...
  struct FovMap_ *can_see_currently_get(void);
  struct FovMap_ *can_see_ever_get(void);
  ...
  ts_t ts_anim_delay_end_get(void);
  ts_t ts_bounce_begin_get(void);
  ts_t ts_bounce_end_get(void);
  ts_t ts_fadeup_begin_get(void);
  ts_t ts_fadeup_end_get(void);
  ts_t ts_fall_begin_get(void);
  ts_t ts_fall_end_get(void);
  ts_t ts_flip_start_get(void);
  ts_t ts_lunge_begin_get(void);
  ts_t ts_lunge_end_get(void);
  ...
  uint32_t tick_last_dropped_get(void);
  uint32_t tick_last_escape_get(void);
  uint32_t tick_last_level_change_get(void);
  uint32_t tick_last_i_was_attacked_get(void);
  uint32_t tick_last_location_check_get(void);
  ...
  uint32_t tick_last_did_something_get(void);
  ...
  const std::array< std::array< ThingId, MAX_BAG_WIDTH >, MAX_BAG_HEIGHT > *stat_const_bag_get(void);
