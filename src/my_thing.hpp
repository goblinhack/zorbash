...
public:
  ...
  //
  std::list< Thingp > get_amulet_list(void);
  std::list< Thingp > get_armor_list(void);
  std::list< Thingp > get_boots_list(void);
  std::list< Thingp > get_cloak_list(void);
  std::list< Thingp > get_food_list(void);
  std::list< Thingp > get_gauntlet_list(void);
  std::list< Thingp > get_helmet_list(void);
  std::list< Thingp > get_item_list(void);
  std::list< Thingp > get_ring_list(void);
  std::list< Thingp > get_shield_list(void);
  std::list< Thingp > get_treasure_list(void);
  std::list< Thingp > get_wand_list(void);
  std::list< Thingp > get_weapon_list(void);

  std::vector< Thingp > get_amulet_vector(void);
  std::vector< Thingp > get_armor_vector(void);
  std::vector< Thingp > get_boots_vector(void);
  std::vector< Thingp > get_cloak_vector(void);
  std::vector< Thingp > get_food_vector(void);
  std::vector< Thingp > get_gauntlet_vector(void);
  std::vector< Thingp > get_helmet_vector(void);
  std::vector< Thingp > get_item_vector(void);
  std::vector< Thingp > get_ring_vector(void);
  std::vector< Thingp > get_shield_vector(void);
  ...
  Thingp get_immediate_mob(void);
  Thingp get_immediate_owner(void);
  Thingp get_immediate_spawned_owner(void);
  Thingp get_leader(void);
  Thingp get_most_dangerous_adjacent_thing(void);
  Thingp get_most_dangerous_visible_thing(void);
  Thingp get_top_mob(void);
  Thingp get_top_owner(void);
  Thingp get_top_spawned_owner(void);
  ...
  const ThingId &get_immediate_mob_id(void);
  ...
  const ThingId &set_mob_id(const ThingId &v);
  ...
  float get_distance_from_mob(point p);
  float get_distance_from_mob(void);
  float get_distance_leader_max(point p);
  float get_distance_leader_max(void);
  float get_distance_mob_max(point p);
  float get_distance_mob_max(void);
  ...
  int get_carried_amulet_highest_value(Thingp *out);
  int get_carried_amulet_least_value(Thingp *out);
  ...
  int get_carried_boots_count(void);
  int get_carried_boots_highest_value_for_target(Thingp *out, Thingp target);
  int get_carried_boots_highest_value(Thingp *out);
  int get_carried_boots_least_value(Thingp *out);
  int get_carried_cloak_count(void);
  int get_carried_cloak_highest_value_for_target(Thingp *out, Thingp target);
  int get_carried_cloak_highest_value(Thingp *out);
  int get_carried_cloak_least_value(Thingp *out);
  int get_carried_food_count(void);
  int get_carried_food_highest_value(Thingp *out);
  int get_carried_food_least_value(Thingp *out);
  int get_carried_gauntlet_count(void);
  int get_carried_gauntlet_highest_value_for_target(Thingp *out, Thingp target);
  int get_carried_gauntlet_highest_value(Thingp *out);
  int get_carried_gauntlet_least_value(Thingp *out);
  int get_carried_helmet_count(void);
  int get_carried_helmet_highest_value_for_target(Thingp *out, Thingp target);
  int get_carried_helmet_highest_value(Thingp *out);
  int get_carried_helmet_least_value(Thingp *out);
  int get_carried_ring_count(void);
  int get_carried_ring_highest_value(Thingp *out);
  int get_carried_ring_least_value(Thingp *out);
  int get_carried_shield_count(void);
  int get_carried_shield_highest_value_for_target(Thingp *out, Thingp target);
  int get_carried_shield_highest_value(Thingp *out);
  int get_carried_shield_least_value(Thingp *out);
