...
public:
  ...
  const std::string &on_receiving_damage_stamina_do(void);
  ...
  const std::string &on_attacking_damage_stamina_do(void);
  ...
  const std::string &on_owner_receiving_damage_stamina_do(void);
  ...
  const std::string &on_owner_attacking_damage_stamina_do(void);
  ...
  int get_total_damage_for_on_attacking_damage_stamina(Thingp victim, int damage);
  ...
  int get_total_damage_for_on_receiving_damage_stamina(Thingp hitter, Thingp real_hitter, int damage);
  ...
  int on_attacking_damage_stamina(Thingp victim, int damage);
  ...
  int on_owner_attacking_damage_stamina(Thingp owner, Thingp victim, int damage);
  ...
  int on_owner_receiving_damage_stamina(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  ...
  int on_receiving_damage_stamina(Thingp hitter, Thingp real_hitter, int damage);
