...
public:
  ...
  int total_on_receiving_damage_acid(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_cold(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_crush(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_digest(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_draining(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_energy(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_fire(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_future1(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_future2(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_future3(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_lightning(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_melee(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_nat_attack(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_necrosis(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_poison(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_stamina(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_stat_att(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_stat_con(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_receiving_damage_stat_str(Thingp hitter, Thingp real_hitter, int damage);
  int total_on_attacking_damage_acid(Thingp victim, int damage);
  int total_on_attacking_damage_cold(Thingp victim, int damage);
  int total_on_attacking_damage_crush(Thingp victim, int damage);
  int total_on_attacking_damage_digest(Thingp victim, int damage);
  int total_on_attacking_damage_draining(Thingp victim, int damage);
  int total_on_attacking_damage_energy(Thingp victim, int damage);
  int total_on_attacking_damage_fire(Thingp victim, int damage);
  int total_on_attacking_damage_future1(Thingp victim, int damage);
  int total_on_attacking_damage_future2(Thingp victim, int damage);
  int total_on_attacking_damage_future3(Thingp victim, int damage);
  int total_on_attacking_damage_lightning(Thingp victim, int damage);
  int total_on_attacking_damage_melee(Thingp victim, int damage);
  int total_on_attacking_damage_nat_attack(Thingp victim, int damage);
  int total_on_attacking_damage_necrosis(Thingp victim, int damage);
  int total_on_attacking_damage_poison(Thingp victim, int damage);
  int total_on_attacking_damage_stamina(Thingp victim, int damage);
  int total_on_attacking_damage_stat_att(Thingp victim, int damage);
  int total_on_attacking_damage_stat_con(Thingp victim, int damage);
  int total_on_attacking_damage_stat_str(Thingp victim, int damage);
