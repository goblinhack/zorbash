...
void py_my_module_add_stat_consts(void)
{
  ...
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_BARREL", MAP_PRIO_BARREL);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_BEHIND", MAP_PRIO_BEHIND);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_CARRY", MAP_PRIO_CARRY);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_CLOAK", MAP_PRIO_CLOAK);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_CONSUMER", MAP_PRIO_CONSUMER);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_EFFECT", MAP_PRIO_EFFECT);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_FIRE", MAP_PRIO_FIRE);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_FOILAGE", MAP_PRIO_FOILAGE);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_ITEM", MAP_PRIO_ITEM);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_CURSOR", MAP_PRIO_CURSOR);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_MONST", MAP_PRIO_MONST);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_SWING", MAP_PRIO_SWING);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_PLAYER", MAP_PRIO_PLAYER);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_RING", MAP_PRIO_RING);
  PyModule_AddIntConstant(my_mod, "MAP_PRIO_WEB", MAP_PRIO_WEB);
