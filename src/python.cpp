...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_distance_jump_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_follower_at),
    MY_ADD_PYTHON_FUNCTION(level_distance_leader_max_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_follower),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(leader_text_description),
    MY_ADD_PYTHON_TP_FUNCTION(follower_text_description),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_follower),
