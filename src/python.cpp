...
static PyMethodDef python_c_METHODS[] = {
    ...
    TP_SET_DECL(attackable_by_monst)
    TP_SET_DECL(attackable_by_player)
    TP_SET_DECL(is_bag)
    ...
    TP_SET_DECL(on_death_is_corpse)
    ...
    TP_SET_DECL(is_thrown_automatically_when_selected)
    ...
    TP_SET_DECL(stats11)
    TP_SET_DECL(stats12)
    TP_SET_DECL(modifier_constitution)
    TP_SET_DECL(modifier_attack)
    TP_SET_DECL(modifier_constitution)
    TP_SET_DECL(stats17)
...
{_
    ...
    PyModule_AddIntConstant(zx_mod, "MAP_DEPTH_EXPLOSION", MAP_DEPTH_EXPLOSION);
