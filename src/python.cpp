...
static PyMethodDef python_c_METHODS[] = {
    ...
    ZX_ADD_PYTHON_FUNCTION(level_is_ai_can_collect_keys_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(level_ai_can_learn_skills_at),
    ZX_ADD_PYTHON_FUNCTION(level_ai_can_enchant_weapons_at),
    ZX_ADD_PYTHON_FUNCTION(level_ai_can_attack_generators_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_is_ai_can_collect_keys),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_ai_can_learn_skills),
    ZX_ADD_PYTHON_FUNCTION(thing_ai_can_enchant_weapons),
    ZX_ADD_PYTHON_FUNCTION(thing_ai_can_attack_generators),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_ai_can_collect_keys),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(ai_can_learn_skills),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_can_enchant_weapons),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_can_attack_generators),
