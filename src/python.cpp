...
static PyMethodDef python_c_METHODS[] = {
    ZX_ADD_PYTHON_FUNCTION(level_ai_is_able_to_remember_enemies_for_n_ticks_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(level_is_able_to_jump_at),
    ZX_ADD_PYTHON_FUNCTION(level_random_jump_chance_d1000_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_able_to_jump_distance_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_able_to_jump_on_low_hp_chance_d1000_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_remember_enemies_for_n_ticks),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_is_able_to_jump),
    ZX_ADD_PYTHON_FUNCTION(thing_random_jump_chance_d1000),
    ZX_ADD_PYTHON_FUNCTION(thing_is_able_to_jump_distance),
    ZX_ADD_PYTHON_FUNCTION(thing_is_able_to_jump_on_low_hp_chance_d1000),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_remember_enemies_for_n_ticks),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_able_to_jump),
    ZX_ADD_PYTHON_TP_FUNCTION(random_jump_chance_d1000),
    ZX_ADD_PYTHON_TP_FUNCTION(is_able_to_jump_distance),
    ZX_ADD_PYTHON_TP_FUNCTION(is_able_to_jump_on_low_hp_chance_d1000),
