...
static PyMethodDef python_c_METHODS[] = {
    ...
    TP_SET_DECL(tl_tile)
    TP_SET_DECL(tr_tile)
    TP_SET_DECL(block_1x2_tile)
    TP_SET_DECL(block_2x1_tile)
    TP_SET_DECL(block_2x2_tile)
    TP_SET_DECL(block_3x3_tile)
    TP_SET_DECL(block_6x3_tile)
    TP_SET_DECL(block_3x6_tile)
    TP_SET_DECL(block_6x6_tile)
