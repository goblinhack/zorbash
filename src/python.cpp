...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_poisonous_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_poisonous),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(damage_value_doubled_from_acid),
    MY_ADD_PYTHON_TP_FUNCTION(damage_value_doubled_from_fire),
    MY_ADD_PYTHON_TP_FUNCTION(damage_value_doubled_from_poison),
    MY_ADD_PYTHON_TP_FUNCTION(damage_value_doubled_from_water),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_poisonous),
