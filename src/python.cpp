...
static PyMethodDef python_c_METHODS[] = {
    ZX_ADD_PYTHON_FUNCTION(level_ai_resent_count_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(level_attack_engulf_chance_d1000_at),
    ZX_ADD_PYTHON_FUNCTION(level_attack_poison_chance_d1000_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(level_is_ring_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_item_magical_eater_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_water_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_weapon_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_weapon_equiper_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(level_is_gfx_anim_synced_with_owner_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_item_magical_at),
    ZX_ADD_PYTHON_FUNCTION(level_unused_flag2_at),
    ZX_ADD_PYTHON_FUNCTION(level_unused_flag30_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_ring_at),
    ZX_ADD_PYTHON_FUNCTION(level_is_auto_equipped_at),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_buff_add),
    ZX_ADD_PYTHON_FUNCTION(thing_buff_remove),
    ZX_ADD_PYTHON_FUNCTION(thing_debuff_add),
    ZX_ADD_PYTHON_FUNCTION(thing_debuff_remove),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_attack_engulf_chance_d1000),
    ZX_ADD_PYTHON_FUNCTION(thing_attack_poison_chance_d1000),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_is_ring),
    ZX_ADD_PYTHON_FUNCTION(thing_is_item_magical_eater),
    ZX_ADD_PYTHON_FUNCTION(thing_is_water),
    ZX_ADD_PYTHON_FUNCTION(thing_is_weapon),
    ZX_ADD_PYTHON_FUNCTION(thing_is_weapon_equiper),
    ...
    ZX_ADD_PYTHON_FUNCTION(thing_is_gfx_anim_synced_with_owner),
    ZX_ADD_PYTHON_FUNCTION(thing_is_item_magical),
    ZX_ADD_PYTHON_FUNCTION(thing_unused_flag3),
    ZX_ADD_PYTHON_FUNCTION(thing_unused_flag30),
    ZX_ADD_PYTHON_FUNCTION(thing_is_ring),
    ZX_ADD_PYTHON_FUNCTION(thing_is_auto_equipped),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(gfx_anim_use),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(gfx_equip_carry_anim),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(attack_engulf_chance_d1000),
    ZX_ADD_PYTHON_TP_FUNCTION(attack_poison_chance_d1000),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_random_jump_chance_d1000),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump_distance),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump_on_low_hp_chance_d1000),
    ZX_ADD_PYTHON_TP_FUNCTION(is_key),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_collect_keys),
    ZX_ADD_PYTHON_TP_FUNCTION(is_destroyed_on_hit_or_miss),
    ZX_ADD_PYTHON_TP_FUNCTION(is_destroyed_on_hitting),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_loggable),
    ZX_ADD_PYTHON_TP_FUNCTION(is_loggable),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_able_to_tire),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_ring),
    ZX_ADD_PYTHON_TP_FUNCTION(is_item_magical_eater),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_loves_water),
    ZX_ADD_PYTHON_TP_FUNCTION(is_weapon),
    ZX_ADD_PYTHON_TP_FUNCTION(is_weapon_equiper),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(environ_loves_fire),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_loves_poison),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_loves_spiderwebs),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(on_owner_set_do),
    ZX_ADD_PYTHON_TP_FUNCTION(on_owner_unset_do),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(text_debuff),
    ZX_ADD_PYTHON_TP_FUNCTION(text_buff),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(is_gfx_anim_synced_with_owner),
    ZX_ADD_PYTHON_TP_FUNCTION(is_item_magical),
    ZX_ADD_PYTHON_TP_FUNCTION(unused_flag3),
    ZX_ADD_PYTHON_TP_FUNCTION(unused_flag30),
    ZX_ADD_PYTHON_TP_FUNCTION(is_ring),
    ZX_ADD_PYTHON_TP_FUNCTION(is_auto_equipped),
    ZX_ADD_PYTHON_TP_FUNCTION(is_buff),
    ZX_ADD_PYTHON_TP_FUNCTION(is_debuff),
    ZX_ADD_PYTHON_TP_FUNCTION(attack_undead),
    ZX_ADD_PYTHON_TP_FUNCTION(is_blood_eater),
    ZX_ADD_PYTHON_TP_FUNCTION(attack_blood),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_hates_poison),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_hates_fire),
    ZX_ADD_PYTHON_TP_FUNCTION(unused_flag4),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_hates_water),
    ZX_ADD_PYTHON_TP_FUNCTION(environ_hates_acid),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_detect_secret_doors_when_close),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_down_doors),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_out_of_webs),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_out_of_webs),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_open_doors),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_exit_finder),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_level_explorer),
    ZX_ADD_PYTHON_TP_FUNCTION(unused_flag5),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_learn_skills),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_enchant_weapons),
    ZX_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_attack_generators),
    ...
    ZX_ADD_PYTHON_TP_FUNCTION(equip_carry_anim),
...
static void python_add_consts(void)
{
  ...
  PyModule_AddIntConstant(zx_mod, "MAP_DEPTH_EQUIP", MAP_DEPTH_EQUIP);
