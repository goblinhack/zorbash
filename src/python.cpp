...
static PyMethodDef python_c_METHODS[] = {
    ...
    TP_SET_DECL(tile)
    TP_SET_DECL(tile_bl)
    TP_SET_DECL(tile_bot)
    TP_SET_DECL(tile_br)
    TP_SET_DECL(tile_left)
    TP_SET_DECL(tile_right)
    TP_SET_DECL(tile_tl)
    TP_SET_DECL(tile_top)
    TP_SET_DECL(tile_tr)
...
{_
    ...
    PyModule_AddIntConstant(zx_mod, "MAP_DEPTH_FIRE", MAP_DEPTH_FIRE);
