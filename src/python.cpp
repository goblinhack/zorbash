...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_TP_FUNCTION(on_leader_set_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_leader_unset_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_follower_set_do),
    MY_ADD_PYTHON_TP_FUNCTION(on_follower_unset_do),
