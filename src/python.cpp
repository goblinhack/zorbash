...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_distance_minion_vision_centered_on_manifestor_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_distance_minion_vision_centered_on_manifestor),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(distance_minion_leash),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(distance_minion_vision_centered_on_manifestor),
