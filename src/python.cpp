...
static PyMethodDef python_c_METHODS[] = {
    ...
    {"game_set_move_left",
        (PyCFunction)game_set_move_left_,
        METH_VARARGS | METH_KEYWORDS,
        ""},

    {"game_set_move_right",
        (PyCFunction)game_set_move_right_,
        METH_VARARGS | METH_KEYWORDS,
        ""},

    {"game_set_move_up",
        (PyCFunction)game_set_move_up_,
        METH_VARARGS | METH_KEYWORDS,
        ""},

    {"game_set_move_down",
        (PyCFunction)game_set_move_down_,
        METH_VARARGS | METH_KEYWORDS,
        ""},
...
{_
    ...
    PyModule_AddIntConstant(mm_mod, "ASCII_WIDTH", ASCII_WIDTH);
    PyModule_AddIntConstant(mm_mod, "ASCII_HEIGHT", ASCII_HEIGHT);
...
{_
    ...
    LOG("Calling PyImport_AppendInittab for mm module");
    ...
    LOG("Calling PyImport_ImportModule for mm module");
