...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_TP_FUNCTION(damage_environment_doubled_from_acid),
    MY_ADD_PYTHON_TP_FUNCTION(damage_environment_doubled_from_fire),
    MY_ADD_PYTHON_TP_FUNCTION(damage_environment_doubled_from_poison),
    MY_ADD_PYTHON_TP_FUNCTION(damage_environment_doubled_from_water),
