...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_attack_generators_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_break_down_doors_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_break_out_of_webs_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_collect_keys_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_detect_secret_doors_when_close_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_enchant_weapons_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_jump_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_jump_distance_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_jump_on_low_hp_chance_d1000_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_learn_skills_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_open_doors_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_see_through_doors_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_able_to_walk_through_walls_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_exit_finder_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_item_collector_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_is_level_explorer_at),
    MY_ADD_PYTHON_FUNCTION(level_ai_random_jump_chance_d1000_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_environ_hates_acid_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_hates_fire_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_hates_poison_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_hates_water_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_loves_acid_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_loves_fire_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_loves_poison_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_loves_spiderwebs_at),
    MY_ADD_PYTHON_FUNCTION(level_environ_loves_water_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_attack_poison_chance_d1000_at),
    MY_ADD_PYTHON_FUNCTION(level_is_engulfer_at),
    MY_ADD_PYTHON_FUNCTION(level_is_ethereal_at),
    MY_ADD_PYTHON_FUNCTION(level_is_ethereal_minion_generator_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_hunger_insatiable_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_laser_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_minion_generator_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_treasure_type_chest_at),
    MY_ADD_PYTHON_FUNCTION(level_is_treasure_type_eater_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_weapon_equiper_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_attack_generators),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_break_down_doors),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_break_out_of_webs),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_collect_keys),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_detect_secret_doors_when_close),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_enchant_weapons),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_jump),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_jump_distance),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_jump_on_low_hp_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_learn_skills),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_open_doors),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_see_through_doors),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_able_to_walk_through_walls),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_exit_finder),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_item_collector),
    MY_ADD_PYTHON_FUNCTION(thing_ai_is_level_explorer),
    MY_ADD_PYTHON_FUNCTION(thing_ai_random_jump_chance_d1000),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_decr_poison),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_environ_loves_acid),
    MY_ADD_PYTHON_FUNCTION(thing_environ_loves_fire),
    MY_ADD_PYTHON_FUNCTION(thing_environ_loves_poison),
    MY_ADD_PYTHON_FUNCTION(thing_environ_loves_spiderwebs),
    MY_ADD_PYTHON_FUNCTION(thing_environ_loves_water),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_damage_swallow),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_immediate_minion_owner_id),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_get_poison),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_incr_poison),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_attack_poison_chance_d1000),
    MY_ADD_PYTHON_FUNCTION(thing_is_engulfer),
    MY_ADD_PYTHON_FUNCTION(thing_is_ethereal),
    MY_ADD_PYTHON_FUNCTION(thing_is_ethereal_minion_generator),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_hunger_insatiable),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_minion_generator),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_poison),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_treasure_type_chest),
    MY_ADD_PYTHON_FUNCTION(thing_is_treasure_type_eater),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_weapon_equiper),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_set_poison),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(ai_avoid_distance),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_see_through_doors),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_shove),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_walk_through_walls),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_item_collector),
    MY_ADD_PYTHON_TP_FUNCTION(ai_obstacle),
    MY_ADD_PYTHON_TP_FUNCTION(ai_resent_count),
    MY_ADD_PYTHON_TP_FUNCTION(ai_scent_distance),
    MY_ADD_PYTHON_TP_FUNCTION(ai_shove_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(ai_unprovoked_attack_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(ai_vision_distance),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(damage_swallow_dice),
    MY_ADD_PYTHON_TP_FUNCTION(enchant_level),
    MY_ADD_PYTHON_TP_FUNCTION(enchant_max),
    MY_ADD_PYTHON_TP_FUNCTION(environ_damage_doubled_from_acid),
    MY_ADD_PYTHON_TP_FUNCTION(environ_damage_doubled_from_fire),
    MY_ADD_PYTHON_TP_FUNCTION(environ_damage_doubled_from_poison),
    MY_ADD_PYTHON_TP_FUNCTION(environ_damage_doubled_from_water),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(environ_loves_acid),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(health_hunger_pct),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(attack_poison_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(is_engulfer),
    MY_ADD_PYTHON_TP_FUNCTION(is_ethereal),
    MY_ADD_PYTHON_TP_FUNCTION(is_ethereal_minion_generator),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_hunger_insatiable),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump),
    MY_ADD_PYTHON_TP_FUNCTION(ai_random_jump_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump_distance),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_jump_on_low_hp_chance_d1000),
    MY_ADD_PYTHON_TP_FUNCTION(is_key),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_collect_keys),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_minion_generator),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_poison),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_treasure_type_chest),
    MY_ADD_PYTHON_TP_FUNCTION(is_treasure_type_eater),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(environ_loves_water),
    MY_ADD_PYTHON_TP_FUNCTION(is_weapon),
    MY_ADD_PYTHON_TP_FUNCTION(is_weapon_equiper),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(environ_loves_fire),
    MY_ADD_PYTHON_TP_FUNCTION(environ_loves_poison),
    MY_ADD_PYTHON_TP_FUNCTION(environ_loves_spiderwebs),
    MY_ADD_PYTHON_TP_FUNCTION(minion_leash_distance),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(stat_attack),
    MY_ADD_PYTHON_TP_FUNCTION(stat_constitution),
    MY_ADD_PYTHON_TP_FUNCTION(stat_defence),
    MY_ADD_PYTHON_TP_FUNCTION(stat_strength),
    MY_ADD_PYTHON_TP_FUNCTION(stats01),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(throw_distance),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_detect_secret_doors_when_close),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_down_doors),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_out_of_webs),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_break_out_of_webs),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_open_doors),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_exit_finder),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_level_explorer),
    MY_ADD_PYTHON_TP_FUNCTION(unused_flag5),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_learn_skills),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_enchant_weapons),
    MY_ADD_PYTHON_TP_FUNCTION(ai_is_able_to_attack_generators),
