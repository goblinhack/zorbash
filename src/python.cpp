...
static PyMethodDef python_c_METHODS[] = {
 /*
    ...
    TP_SET_DECL(delay_ai_ms)
    TP_SET_DECL(is_bouncy)
    ...
    TP_SET_DECL(is_initial_health_at)
    TP_SET_DECL(is_hungry_at_health_pct)
    TP_SET_DECL(is_hungry_every_rounds)
    TP_SET_DECL(is_scent_aware_at_distance)
    ...
    TP_SET_DECL(is_collision_use_box)
    TP_SET_DECL(is_collision_detect_use_circle)
