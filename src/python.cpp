...
static PyMethodDef python_c_METHODS[] = {
    ...
    {"level_is_poison_immune_at",                              (PyCFunction)level_is_poison_immune_at,                              METH_VARARGS | METH_KEYWORDS, "thing api"},
    ...
    {"level_is_rrr96_at",                                      (PyCFunction)level_is_rrr96_at,                                      METH_VARARGS | METH_KEYWORDS, "thing api"},
