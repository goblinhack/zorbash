...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_unused_flag_11_at),
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_able_to_use_magic_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_unused_flag_11),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_able_to_use_magic),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(unused_flag_11),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_able_to_use_magic),
