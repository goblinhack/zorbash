...
static PyMethodDef python_c_METHODS[] = {
    ...
    MY_ADD_PYTHON_FUNCTION(level_is_necrotic_at),
    ...
    MY_ADD_PYTHON_FUNCTION(thing_is_necrotic),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(damage_value_doubled_from_necrosis),
    ...
    MY_ADD_PYTHON_TP_FUNCTION(is_necrotic),
