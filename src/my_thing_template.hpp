...
public:
  ...
  const std::string &on_damage_acid_do(void) const;
  const std::string &on_damage_cold_do(void) const;
  const std::string &on_damage_crush_do(void) const;
  const std::string &on_damage_digest_do(void) const;
  const std::string &on_damage_draining_do(void) const;
  const std::string &on_damage_energy_do(void) const;
  const std::string &on_damage_fire_do(void) const;
  const std::string &on_damage_future1_do(void) const;
  const std::string &on_damage_future2_do(void) const;
  const std::string &on_damage_future3_do(void) const;
  const std::string &on_damage_lightning_do(void) const;
  const std::string &on_damage_melee_do(void) const;
  const std::string &on_damage_nat_attack_do(void) const;
  const std::string &on_damage_necrosis_do(void) const;
  const std::string &on_damage_poison_do(void) const;
  const std::string &on_damage_stamina_do(void) const;
  const std::string &on_damage_stat_att_do(void) const;
  const std::string &on_damage_stat_con_do(void) const;
  const std::string &on_damage_stat_str_do(void) const;
  ...
  const std::string &on_owner_damage_acid_do(void) const;
  const std::string &on_owner_damage_cold_do(void) const;
  const std::string &on_owner_damage_crush_do(void) const;
  const std::string &on_owner_damage_digest_do(void) const;
  const std::string &on_owner_damage_draining_do(void) const;
  const std::string &on_owner_damage_energy_do(void) const;
  const std::string &on_owner_damage_fire_do(void) const;
  const std::string &on_owner_damage_future1_do(void) const;
  const std::string &on_owner_damage_future2_do(void) const;
  const std::string &on_owner_damage_future3_do(void) const;
  const std::string &on_owner_damage_lightning_do(void) const;
  const std::string &on_owner_damage_melee_do(void) const;
  const std::string &on_owner_damage_nat_attack_do(void) const;
  const std::string &on_owner_damage_necrosis_do(void) const;
  const std::string &on_owner_damage_poison_do(void) const;
  const std::string &on_owner_damage_stamina_do(void) const;
  const std::string &on_owner_damage_stat_att_do(void) const;
  const std::string &on_owner_damage_stat_con_do(void) const;
  const std::string &on_owner_damage_stat_str_do(void) const;
  ...
  void on_damage_acid_do_set(const std::string &v);
  void on_damage_cold_do_set(const std::string &v);
  void on_damage_crush_do_set(const std::string &v);
  void on_damage_digest_do_set(const std::string &v);
  void on_damage_draining_do_set(const std::string &v);
  void on_damage_energy_do_set(const std::string &v);
  void on_damage_fire_do_set(const std::string &v);
  void on_damage_future1_do_set(const std::string &v);
  void on_damage_future2_do_set(const std::string &v);
  void on_damage_future3_do_set(const std::string &v);
  void on_damage_lightning_do_set(const std::string &v);
  void on_damage_melee_do_set(const std::string &v);
  void on_damage_nat_attack_do_set(const std::string &v);
  void on_damage_necrosis_do_set(const std::string &v);
  void on_damage_poison_do_set(const std::string &v);
  void on_damage_stamina_do_set(const std::string &v);
  void on_damage_stat_att_do_set(const std::string &v);
  void on_damage_stat_con_do_set(const std::string &v);
  void on_damage_stat_str_do_set(const std::string &v);
  ...
  void on_owner_damage_acid_do_set(const std::string &v);
  void on_owner_damage_cold_do_set(const std::string &v);
  void on_owner_damage_crush_do_set(const std::string &v);
  void on_owner_damage_digest_do_set(const std::string &v);
  void on_owner_damage_draining_do_set(const std::string &v);
  void on_owner_damage_energy_do_set(const std::string &v);
  void on_owner_damage_fire_do_set(const std::string &v);
  void on_owner_damage_future1_do_set(const std::string &v);
  void on_owner_damage_future2_do_set(const std::string &v);
  void on_owner_damage_future3_do_set(const std::string &v);
  void on_owner_damage_lightning_do_set(const std::string &v);
  void on_owner_damage_melee_do_set(const std::string &v);
  void on_owner_damage_nat_attack_do_set(const std::string &v);
  void on_owner_damage_necrosis_do_set(const std::string &v);
  void on_owner_damage_poison_do_set(const std::string &v);
  void on_owner_damage_stamina_do_set(const std::string &v);
  void on_owner_damage_stat_att_do_set(const std::string &v);
  void on_owner_damage_stat_con_do_set(const std::string &v);
  void on_owner_damage_stat_str_do_set(const std::string &v);
