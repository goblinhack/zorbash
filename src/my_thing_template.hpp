...
private:
  ...
  std::vector< int > _dmg_acid_chance_d1000 {};
  ...
  std::vector< int > _dmg_lightning_chance_d1000 {};
  std::vector< int > _dmg_melee_chance_d1000 {};
  std::vector< int > _dmg_nat_att_chance_d1000 {};
  std::vector< int > _dmg_necrosis_chance_d1000 {};
  std::vector< int > _dmg_draining_chance_d1000 {};
  std::vector< int > _dmg_poison_chance_d1000 {};
  ...
  std::string _dmg_draining_dice_str;
...
public:
  ...
  const int dmg_draining(void) const;
  ...
  const std::string &dmg_draining_dice_str(void) const;
  ...
  int collateral_dmg_pct(void) const;
  ...
  int dmg_acid_chance_d1000(int index) const;
  int dmg_bite_chance_d1000(int index) const;
  int dmg_claw_chance_d1000(int index) const;
  int dmg_cold_chance_d1000(int index) const;
  int dmg_crush_chance_d1000(int index) const;
  int dmg_digest_chance_d1000(int index) const;
  int dmg_draining_chance_d1000(int index) const;
  ...
  int dmg_poison_chance_d1000(int index) const;
  ...
  void collateral_dmg_pct_set(int v);
  ...
  void dmg_water_chance_d1000_set(int index, int v);
  ...
  void dmg_lightning_chance_d1000_set(int index, int v);
  void dmg_melee_chance_d1000_set(int index, int v);
  void dmg_nat_att_chance_d1000_set(int index, int v);
  void dmg_necrosis_chance_d1000_set(int index, int v);
  void dmg_draining_chance_d1000_set(int index, int v);
  void dmg_poison_chance_d1000_set(int index, int v);
