...
public:
  ...
  const std::string &damage_acid_dice_str_get(void) const;
  const std::string &damage_natural_dice_str_get(void) const;
  const std::string &damage_crush_dice_str_get(void) const;
  const std::string &damage_digest_dice_str_get(void) const;
  const std::string &damage_energy_dice_str_get(void) const;
  const std::string &damage_fire_dice_str_get(void) const;
  const std::string &damage_future1_dice_str_get(void) const;
  const std::string &damage_future2_dice_str_get(void) const;
  const std::string &damage_future3_dice_str_get(void) const;
  const std::string &damage_cold_dice_str_get(void) const;
  const std::string &damage_lightning_dice_str_get(void) const;
  const std::string &damage_melee_dice_str_get(void) const;
  const std::string &damage_necrosis_dice_str_get(void) const;
  const std::string &damage_poison_dice_str_get(void) const;
  const std::string &health_initial_dice_str_get(void) const;
