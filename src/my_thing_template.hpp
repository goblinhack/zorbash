...
private:
  ...
  int _capacity_width {};
  int chance_d10000__crit {};
  int chance_d10000_dmgd {};
  int chance_d1000__appearing {};
  int chance_d1000__attack_engulf {};
  int chance_d1000__is_able_to_grapple {};
  int chance_d1000__is_able_to_jump_attack {};
  int chance_d1000__is_able_to_jump_on_low_hp {};
  int chance_d1000__is_able_to_jump_onto {};
  int chance_d1000__is_able_to_jump_randomly {};
  int chance_d1000__is_able_to_shove {};
  int chance_d1000__is_able_to_teleport_attack {};
  int chance_d1000__is_steal_item {};
  int chance_d1000__melting {};
  int chance_d1000__set_on_fire {};
  int _charge_count {};
...
public:
  ...
  int chance_d1000_is_able_to_grapple(void) const;
  int chance_d1000_is_able_to_jump_attack(void) const;
  int chance_d1000_is_able_to_jump_on_low_hp(void) const;
  int chance_d1000_is_able_to_jump_onto(void) const;
  int chance_d1000_is_able_to_jump_randomly(void) const;
  int chance_d1000_is_able_to_shove(void) const;
  int chance_d1000_is_able_to_teleport_attack(void) const;
  int chance_d1000_is_steal_item(void) const;
  int chance_d1000_melting(void) const;
  int chance_d1000_set_on_fire(void) const;
  ...
  void chance_d1000_is_able_to_grapple_set(int v);
  void chance_d1000_is_able_to_jump_attack_set(int v);
  void chance_d1000_is_able_to_jump_on_low_hp_set(int v);
  void chance_d1000_is_able_to_jump_onto_set(int v);
  void chance_d1000_is_able_to_jump_randomly_set(int v);
  void chance_d1000_is_able_to_shove_set(int v);
  void chance_d1000_is_able_to_teleport_attack_set(int v);
  void chance_d1000_is_steal_item_set(int v);
  void chance_d1000_melting_set(int v);
  void chance_d1000_set_on_fire_set(int v);
