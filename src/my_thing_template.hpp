...
private:
  ...
  int _is_bloodbug {};
  int _is_bodypart_eyes {};
  int _is_bodypart_face {};
  int _is_bodypart_hair {};
  int _is_bodypart_hat {};
  int _is_bodypart_legs {};
  int _is_bodypart_torso {};
  int _is_bones {};
  int _is_boots {};
  int _is_brazier {};
  int _is_bridge {};
...
public:
  ...
  int is_bodypart_eyes(void) const;
  int is_bodypart_face(void) const;
  int is_bodypart_hair(void) const;
  int is_bodypart_hat(void) const;
  int is_bodypart_legs(void) const;
  int is_bodypart_torso(void) const;
  ...
  void is_bodypart_eyes_set(int v);
  void is_bodypart_face_set(int v);
  void is_bodypart_hair_set(int v);
  void is_bodypart_hat_set(int v);
  void is_bodypart_legs_set(int v);
  void is_bodypart_torso_set(int v);
