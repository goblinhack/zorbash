...
private:
  ...
  int _unused_chance9_d1000 {};
  int _unused_chance10_d1000 {};
  ...
  int _enchant_level {};
  int _enchant_max {};
  int _environ_damage_doubled_from_acid {};
  int _environ_damage_doubled_from_fire {};
  int _environ_damage_doubled_from_poison {};
  int _environ_damage_doubled_from_water {};
...
public:
  ...
  int unused_chance9_d1000(void) const;
  int unused_chance10_d1000(void) const;
  ...
  int environ_damage_doubled_from_poison(void) const;
  int environ_damage_doubled_from_water(void) const;
  ...
  void set_unused_chance9_d1000(int);
  void set_unused_chance10_d1000(int);
  ...
  void set_environ_damage_doubled_from_acid(int);
  void set_environ_damage_doubled_from_fire(int);
  void set_environ_damage_doubled_from_poison(int);
  void set_environ_damage_doubled_from_water(int);
