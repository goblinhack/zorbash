...
private:
  ...
  int _gfx_pixelart_health_bar_shown_when_awake_only {};
...
public:
  ...
  int gfx_pixelart_health_bar_shown_when_awake_only(void) const;
  ...
  void gfx_pixelart_health_bar_shown_when_awake_only_set(int v);
...
class Tp *tp_load(int id, const std::string &file, const std::string &text_long_name, const std::string &text_short_name);
