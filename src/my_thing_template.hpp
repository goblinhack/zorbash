...
private:
  ...
  std::string _on_attacking_dmg_nat_attack_do;
  ...
  std::string _on_owner_attacking_dmg_acid_do;
  std::string _on_owner_attacking_dmg_cold_do;
  std::string _on_owner_attacking_dmg_crush_do;
  std::string _on_owner_attacking_dmg_digest_do;
  std::string _on_owner_attacking_dmg_draining_do;
  std::string _on_owner_attacking_dmg_energy_do;
  std::string _on_owner_attacking_dmg_fire_do;
  std::string _on_owner_attacking_dmg_future1_do;
  std::string _on_owner_attacking_dmg_future2_do;
  std::string _on_owner_attacking_dmg_future3_do;
  std::string _on_owner_attacking_dmg_lightning_do;
  std::string _on_owner_attacking_dmg_melee_do;
  std::string _on_owner_attacking_dmg_nat_attack_do;
  std::string _on_owner_attacking_dmg_necrosis_do;
  std::string _on_owner_attacking_dmg_poison_do;
  std::string _on_owner_attacking_dmg_stat_att_do;
  std::string _on_owner_attacking_dmg_stat_con_do;
  std::string _on_owner_attacking_dmg_stat_str_do;
  std::string _on_owner_receiving_dmg_acid_do;
  std::string _on_owner_receiving_dmg_cold_do;
  std::string _on_owner_receiving_dmg_crush_do;
  std::string _on_owner_receiving_dmg_digest_do;
  std::string _on_owner_receiving_dmg_draining_do;
  std::string _on_owner_receiving_dmg_energy_do;
  std::string _on_owner_receiving_dmg_fire_do;
  std::string _on_owner_receiving_dmg_future1_do;
  std::string _on_owner_receiving_dmg_future2_do;
  std::string _on_owner_receiving_dmg_future3_do;
  std::string _on_owner_receiving_dmg_lightning_do;
  std::string _on_owner_receiving_dmg_melee_do;
  std::string _on_owner_receiving_dmg_nat_attack_do;
  std::string _on_owner_receiving_dmg_necrosis_do;
  std::string _on_owner_receiving_dmg_poison_do;
  std::string _on_owner_receiving_dmg_stat_att_do;
  std::string _on_owner_receiving_dmg_stat_con_do;
  std::string _on_owner_receiving_dmg_stat_str_do;
  ...
  std::string _on_receiving_dmg_nat_attack_do;
...
public:
  ...
  const std::string &on_attacking_dmg_nat_attack_do(void) const;
  ...
  const std::string &on_owner_attacking_dmg_acid_do(void) const;
  const std::string &on_owner_attacking_dmg_cold_do(void) const;
  const std::string &on_owner_attacking_dmg_crush_do(void) const;
  const std::string &on_owner_attacking_dmg_digest_do(void) const;
  const std::string &on_owner_attacking_dmg_draining_do(void) const;
  const std::string &on_owner_attacking_dmg_energy_do(void) const;
  const std::string &on_owner_attacking_dmg_fire_do(void) const;
  const std::string &on_owner_attacking_dmg_future1_do(void) const;
  const std::string &on_owner_attacking_dmg_future2_do(void) const;
  const std::string &on_owner_attacking_dmg_future3_do(void) const;
  const std::string &on_owner_attacking_dmg_lightning_do(void) const;
  const std::string &on_owner_attacking_dmg_melee_do(void) const;
  const std::string &on_owner_attacking_dmg_nat_attack_do(void) const;
  const std::string &on_owner_attacking_dmg_necrosis_do(void) const;
  const std::string &on_owner_attacking_dmg_poison_do(void) const;
  const std::string &on_owner_attacking_dmg_stat_att_do(void) const;
  const std::string &on_owner_attacking_dmg_stat_con_do(void) const;
  const std::string &on_owner_attacking_dmg_stat_str_do(void) const;
  const std::string &on_owner_receiving_dmg_acid_do(void) const;
  const std::string &on_owner_receiving_dmg_cold_do(void) const;
  const std::string &on_owner_receiving_dmg_crush_do(void) const;
  const std::string &on_owner_receiving_dmg_digest_do(void) const;
  const std::string &on_owner_receiving_dmg_draining_do(void) const;
  const std::string &on_owner_receiving_dmg_energy_do(void) const;
  const std::string &on_owner_receiving_dmg_fire_do(void) const;
  const std::string &on_owner_receiving_dmg_future1_do(void) const;
  const std::string &on_owner_receiving_dmg_future2_do(void) const;
  const std::string &on_owner_receiving_dmg_future3_do(void) const;
  const std::string &on_owner_receiving_dmg_lightning_do(void) const;
  const std::string &on_owner_receiving_dmg_melee_do(void) const;
  const std::string &on_owner_receiving_dmg_nat_attack_do(void) const;
  const std::string &on_owner_receiving_dmg_necrosis_do(void) const;
  const std::string &on_owner_receiving_dmg_poison_do(void) const;
  const std::string &on_owner_receiving_dmg_stat_att_do(void) const;
  const std::string &on_owner_receiving_dmg_stat_con_do(void) const;
  const std::string &on_owner_receiving_dmg_stat_str_do(void) const;
  ...
  const std::string &on_receiving_dmg_nat_attack_do(void) const;
  ...
  void on_attacking_dmg_nat_attack_do_set(const std::string &v);
  ...
  void on_owner_attacking_dmg_acid_do_set(const std::string &v);
  void on_owner_attacking_dmg_cold_do_set(const std::string &v);
  void on_owner_attacking_dmg_crush_do_set(const std::string &v);
  void on_owner_attacking_dmg_digest_do_set(const std::string &v);
  void on_owner_attacking_dmg_draining_do_set(const std::string &v);
  void on_owner_attacking_dmg_energy_do_set(const std::string &v);
  void on_owner_attacking_dmg_fire_do_set(const std::string &v);
  void on_owner_attacking_dmg_future1_do_set(const std::string &v);
  void on_owner_attacking_dmg_future2_do_set(const std::string &v);
  void on_owner_attacking_dmg_future3_do_set(const std::string &v);
  void on_owner_attacking_dmg_lightning_do_set(const std::string &v);
  void on_owner_attacking_dmg_melee_do_set(const std::string &v);
  void on_owner_attacking_dmg_nat_attack_do_set(const std::string &v);
  void on_owner_attacking_dmg_necrosis_do_set(const std::string &v);
  void on_owner_attacking_dmg_poison_do_set(const std::string &v);
  void on_owner_attacking_dmg_stat_att_do_set(const std::string &v);
  void on_owner_attacking_dmg_stat_con_do_set(const std::string &v);
  void on_owner_attacking_dmg_stat_str_do_set(const std::string &v);
  void on_owner_receiving_dmg_acid_do_set(const std::string &v);
  void on_owner_receiving_dmg_cold_do_set(const std::string &v);
  void on_owner_receiving_dmg_crush_do_set(const std::string &v);
  void on_owner_receiving_dmg_digest_do_set(const std::string &v);
  void on_owner_receiving_dmg_draining_do_set(const std::string &v);
  void on_owner_receiving_dmg_energy_do_set(const std::string &v);
  void on_owner_receiving_dmg_fire_do_set(const std::string &v);
  void on_owner_receiving_dmg_future1_do_set(const std::string &v);
  void on_owner_receiving_dmg_future2_do_set(const std::string &v);
  void on_owner_receiving_dmg_future3_do_set(const std::string &v);
  void on_owner_receiving_dmg_lightning_do_set(const std::string &v);
  void on_owner_receiving_dmg_melee_do_set(const std::string &v);
  void on_owner_receiving_dmg_nat_attack_do_set(const std::string &v);
  void on_owner_receiving_dmg_necrosis_do_set(const std::string &v);
  void on_owner_receiving_dmg_poison_do_set(const std::string &v);
  void on_owner_receiving_dmg_stat_att_do_set(const std::string &v);
  void on_owner_receiving_dmg_stat_con_do_set(const std::string &v);
  void on_owner_receiving_dmg_stat_str_do_set(const std::string &v);
  ...
  void on_receiving_dmg_nat_attack_do_set(const std::string &v);
