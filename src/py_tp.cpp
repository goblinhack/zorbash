...
TP_BODY_SET_INT(is_immune_to_spell_beckoning)
TP_BODY_SET_INT(is_immune_to_spell_of_holding)
TP_BODY_SET_INT(is_immune_to_spell_repulsion)
TP_BODY_SET_INT(is_immune_to_spell_slow)
