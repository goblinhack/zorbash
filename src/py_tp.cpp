...
TP_BODY_SET_INT(is_acid_avoider)
...
TP_BODY_SET_INT(is_fire_avoider)
...
TP_BODY_SET_INT(is_poison_lover)
TP_BODY_SET_INT(is_double_damage_from_poison)
TP_BODY_SET_INT(is_poison_avoider)
...
TP_BODY_SET_INT(is_thrown_automatically_when_selected)
TP_BODY_SET_INT(is_extreme_hazard)
TP_BODY_SET_INT(is_auto_collect_item)
TP_BODY_SET_INT(is_attack_meat)
...
TP_BODY_SET_INT(is_water_avoider)
...
TP_BODY_SET_INT(stats_constitution)
TP_BODY_SET_INT(stats_attack)
TP_BODY_SET_INT(stats17)
TP_BODY_SET_INT(stats_throw_distance)
...
TP_BODY_SET_STRING(stats_health_initial_dice)
