...
TP_BODY_SET_INT(hunger_insatiable)
...
TP_BODY_SET_STRING(on_follower_set_do)
TP_BODY_SET_STRING(on_follower_unset_do)
TP_BODY_SET_STRING(on_leader_set_do)
TP_BODY_SET_STRING(on_leader_unset_do)
