...
TP_BODY_SET_INT(damage_num_attacks)
...
TP_BODY_SET_STRING(on_receiving_damage_stamina_do)
...
TP_BODY_SET_STRING(on_attacking_damage_stamina_do)
...
TP_BODY_SET_STRING(on_owner_receiving_damage_stamina_do)
...
TP_BODY_SET_STRING(on_owner_attacking_damage_stamina_do)
