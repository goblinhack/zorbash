...
TP_BODY_SET_INT(damage_future5_chance_d1000)
TP_BODY_SET_INT(damage_future6_chance_d1000)
TP_BODY_SET_INT(damage_future7_chance_d1000)
TP_BODY_SET_INT(damage_future8_chance_d1000)
TP_BODY_SET_INT(damage_future9_chance_d1000)
TP_BODY_SET_INT(damage_future10_chance_d1000)
...
TP_BODY_SET_STRING(damage_future5_dice)
TP_BODY_SET_STRING(damage_future6_dice)
TP_BODY_SET_STRING(damage_future7_dice)
TP_BODY_SET_STRING(damage_future8_dice)
TP_BODY_SET_STRING(damage_future9_dice)
TP_BODY_SET_STRING(damage_future10_dice)
...
TP_BODY_SET_STRING(on_owner_damage_future5_do)
TP_BODY_SET_STRING(on_owner_damage_future6_do)
TP_BODY_SET_STRING(on_owner_damage_future7_do)
TP_BODY_SET_STRING(on_owner_damage_future8_do)
TP_BODY_SET_STRING(on_owner_damage_future9_do)
TP_BODY_SET_STRING(on_owner_damage_future10_do)
