...
TP_BODY_SET_INT(distance_cast_spell)
...
TP_BODY_SET_INT(is_able_to_cast_spells)
...
TP_BODY_SET_INT(is_immune_to_slow_spell)
...
TP_BODY_SET_INT(is_obs_casting)
...
TP_BODY_SET_INT(is_spell_slowed)
