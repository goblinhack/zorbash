...
TP_BODY_SET_INT(damage_environment_doubled_from_acid)
TP_BODY_SET_INT(damage_environment_doubled_from_fire)
TP_BODY_SET_INT(damage_environment_doubled_from_poison)
TP_BODY_SET_INT(damage_environment_doubled_from_water)
