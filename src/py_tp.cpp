...
TP_BODY_SET_INT(gfx_ascii_mode_color_is_animated)
...
TP_BODY_SET_STRING(on_attacking_dmg_nat_attack_do)
...
TP_BODY_SET_STRING(on_owner_attacking_dmg_acid_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_cold_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_crush_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_digest_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_draining_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_energy_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_fire_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_future1_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_future2_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_future3_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_lightning_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_melee_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_nat_attack_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_necrosis_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_poison_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_stat_att_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_stat_con_do)
TP_BODY_SET_STRING(on_owner_attacking_dmg_stat_str_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_acid_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_cold_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_crush_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_digest_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_draining_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_energy_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_fire_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_future1_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_future2_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_future3_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_lightning_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_melee_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_nat_attack_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_necrosis_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_poison_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_stat_att_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_stat_con_do)
TP_BODY_SET_STRING(on_owner_receiving_dmg_stat_str_do)
...
TP_BODY_SET_STRING(on_receiving_dmg_nat_attack_do)
