...
TP_BODY_SET_INT_INT(dmg_acid_chance_d1000)
TP_BODY_SET_INT_INT(dmg_bite_chance_d1000)
TP_BODY_SET_INT_INT(dmg_claw_chance_d1000)
TP_BODY_SET_INT_INT(dmg_cold_chance_d1000)
TP_BODY_SET_INT_INT(dmg_crush_chance_d1000)
TP_BODY_SET_INT_INT(dmg_digest_chance_d1000)
TP_BODY_SET_INT_INT(dmg_draining_chance_d1000)
TP_BODY_SET_INT_INT(dmg_drown_chance_d1000)
TP_BODY_SET_INT_INT(dmg_energy_chance_d1000)
TP_BODY_SET_INT_INT(dmg_fire_chance_d1000)
TP_BODY_SET_INT_INT(dmg_heat_chance_d1000)
TP_BODY_SET_INT_INT(dmg_lightning_chance_d1000)
TP_BODY_SET_INT_INT(dmg_melee_chance_d1000)
TP_BODY_SET_INT_INT(dmg_missile_chance_d1000)
TP_BODY_SET_INT_INT(dmg_nat_att_chance_d1000)
TP_BODY_SET_INT_INT(dmg_necrosis_chance_d1000)
TP_BODY_SET_INT_INT(dmg_negation_chance_d1000)
TP_BODY_SET_INT_INT(dmg_poison_chance_d1000)
TP_BODY_SET_INT_INT(dmg_water_chance_d1000)
...
TP_BODY_SET_INT(is_able_to_grapple_chance_d1000)
...
TP_BODY_SET_INT(is_able_to_shove_chance_d1000)
...
TP_BODY_SET_INT(is_albe_to_shoot_at)
TP_BODY_SET_INT(is_albe_to_shoot_at_close_range)
...
TP_BODY_SET_STRING(on_want_to_shoot_at_something_do)
