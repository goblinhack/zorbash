...
TP_BODY_SET_INT(avoider_of_acid)
...
TP_BODY_SET_INT(attackable_by_monst)
TP_BODY_SET_INT(attackable_by_player)
...
TP_BODY_SET_INT(avoider_of_fire)
...
TP_BODY_SET_INT(avoider_of_poison)
...
TP_BODY_SET_INT(avoider_of_water)
