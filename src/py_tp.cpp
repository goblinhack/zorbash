...
TP_BODY_SET_INT(gfx_is_weapon_carry_anim)
...
TP_BODY_SET_INT(gfx_show_hiddend)
...
TP_BODY_SET_INT(is_cursor_hover)
...
TP_BODY_SET_STRING(stats_attack_bite_hd)
