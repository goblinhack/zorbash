  ...
  {                                                                                                                  \
    ...
    if (! py_class) {                                                                                                \
      ...
      Py_RETURN_FALSE;                                                                                               \
                                                                                                                     ...
                                                                                                                     \
    if (! value) {                                                                                                   \
      PY_ERR("%s: Missing value", __FUNCTION__);                                                                     \
      Py_RETURN_FALSE;                                                                                               \
    }                                                                                                                \
                                                                                                                     \
...
#define TP_BODY_SET_ENUM(__field__, __str2val__)                                                                     \
  ...
  {                                                                                                                  \
    ...
    if (tp->__field__() == (int) (tp->__field__()) - 1) {                                                            \
      PY_ERR("%s: Cannot find enum %s", __FUNCTION__, value);                                                        \
      goto done;                                                                                                     \
    }                                                                                                                \
                                                                                                                     \
...
PyObject *spawn_next_to_(PyObject *obj, PyObject *args, PyObject *keywds)
{
  ...
  if (! id) {
    PY_ERR("%s: Missing 'id'", __FUNCTION__);
    Py_RETURN_FALSE;
  }

  if (! what) {
    PY_ERR("%s: Missing 'what'", __FUNCTION__);
    Py_RETURN_FALSE;
  }
  ...
  if (unlikely(! t)) {
    PY_ERR("%s: Cannot find thing %08" PRIX32 "", __FUNCTION__, id);
    Py_RETURN_FALSE;
  }
...
PyObject *spawn_using_items_radius_range_(PyObject *obj, PyObject *args, PyObject *keywds)
{
  ...
  if (! parent_id) {
    PY_ERR("%s: Missing 'parent_id'", __FUNCTION__);
    Py_RETURN_FALSE;
  }

  if (! victim_id) {
    PY_ERR("%s: Missing 'victim_id'", __FUNCTION__);
    Py_RETURN_FALSE;
  }
  ...
  auto t = game->thing_find(ThingId(id));
  if (unlikely(! t)) {
    PY_ERR("%s: Cannot find 'me' thing %08" PRIX32 "", __FUNCTION__, id);
    Py_RETURN_FALSE;
  }
  ...
  if (! parent) {
    PY_ERR("%s: Cannot find parent thing %08" PRIX32 "", __FUNCTION__, id);
    Py_RETURN_FALSE;
  }

  auto target = level->thing_find(ThingId(victim_id));
  if (! target) {
    PY_ERR("%s: Cannot find target thing %08" PRIX32 "", __FUNCTION__, id);
    Py_RETURN_FALSE;
  }
...
TP_BODY_SET_INT(chance_d10000_enchanted)
TP_BODY_SET_INT(chance_d10000_runic_class_A)
TP_BODY_SET_INT(chance_d10000_runic_class_B)
...
TP_BODY_SET_INT(chance_d1000_tameable)
...
TP_BODY_SET_INT(distance_spell_cast)
TP_BODY_SET_INT(distance_throw)
TP_BODY_SET_INT(distance_vision)
TP_BODY_SET_INT(dmg_limited_per_tick)
TP_BODY_SET_INT(dmg_num_of_attacks)
TP_BODY_SET_INT(dmg_rcv_doubled_from_acid)
TP_BODY_SET_INT(dmg_rcv_doubled_from_cold)
TP_BODY_SET_INT(dmg_rcv_doubled_from_fire)
TP_BODY_SET_INT(dmg_rcv_doubled_from_necrosis)
TP_BODY_SET_INT(dmg_rcv_doubled_from_poison)
TP_BODY_SET_INT(dmg_rcv_doubled_from_water)
...
TP_BODY_SET_INT(gfx_ascii_show_light_once_seen)
...
TP_BODY_SET_INT(has_a_head)
TP_BODY_SET_INT(has_tentacles)
...
TP_BODY_SET_INT_INT(dmg_chance_d1000_holy)
TP_BODY_SET_INT_INT(dmg_chance_d1000_impact)
...
TP_BODY_SET_INT(is_able_to_attack_totems)
TP_BODY_SET_INT(is_able_to_be_equipped)
TP_BODY_SET_INT(is_able_to_be_reflected)
...
TP_BODY_SET_INT(is_able_to_break_out_of_crystal)
TP_BODY_SET_INT(is_able_to_break_out_of_ice)
TP_BODY_SET_INT(is_able_to_break_out_of_spell_of_holding)
TP_BODY_SET_INT(is_able_to_break_out_of_spell_of_sanctuary)
...
TP_BODY_SET_INT(is_able_to_see_in_magical_darkness)
...
TP_BODY_SET_INT(is_able_to_spell_cast)
...
TP_BODY_SET_INT(is_always_submerged_in_lava)
...
TP_BODY_SET_INT(is_block_of_crystal)
TP_BODY_SET_INT(is_block_of_ice)
TP_BODY_SET_INT(is_bloodbug)
TP_BODY_SET_INT(is_blunt)
...
TP_BODY_SET_INT(is_crystalline)
...
TP_BODY_SET_INT(is_hellpup)
TP_BODY_SET_INT(is_helmet)
TP_BODY_SET_INT(is_herbivore)
TP_BODY_SET_INT(is_hittable)
TP_BODY_SET_INT(is_holy)
TP_BODY_SET_INT(is_holy_water)
TP_BODY_SET_INT(is_humanoid)
TP_BODY_SET_INT(is_icefolk)
TP_BODY_SET_INT(is_immune_to_acid)
TP_BODY_SET_INT(is_immune_to_blinding)
TP_BODY_SET_INT(is_immune_to_cold)
TP_BODY_SET_INT(is_immune_to_confusion)
TP_BODY_SET_INT(is_immune_to_electricity)
TP_BODY_SET_INT(is_immune_to_entrancement)
TP_BODY_SET_INT(is_immune_to_fire)
TP_BODY_SET_INT(is_immune_to_holy_damage)
TP_BODY_SET_INT(is_immune_to_lightning)
TP_BODY_SET_INT(is_immune_to_magic_drain)
TP_BODY_SET_INT(is_immune_to_necrosis)
TP_BODY_SET_INT(is_immune_to_negation)
TP_BODY_SET_INT(is_immune_to_non_magical_weapons)
TP_BODY_SET_INT(is_immune_to_paralysis)
TP_BODY_SET_INT(is_immune_to_poison)
TP_BODY_SET_INT(is_immune_to_spell_of_beckoning)
TP_BODY_SET_INT(is_immune_to_spell_of_holding)
TP_BODY_SET_INT(is_immune_to_spell_of_repulsion)
TP_BODY_SET_INT(is_immune_to_spell_of_sanctuary)
TP_BODY_SET_INT(is_immune_to_spell_of_slowness)
...
TP_BODY_SET_INT(is_immune_to_vorpal_weapons)
...
TP_BODY_SET_INT(is_mob_class_A)
TP_BODY_SET_INT(is_mob_class_B)
TP_BODY_SET_INT(is_mob_class_C)
...
TP_BODY_SET_INT(is_obs_spell_casting)
...
TP_BODY_SET_INT(is_one_per_tile)
TP_BODY_SET_INT(is_ooze)
...
TP_BODY_SET_INT(is_runic_defensive_class_A)
TP_BODY_SET_INT(is_runic_defensive_class_B)
TP_BODY_SET_INT(is_runic_offensive_class_A)
TP_BODY_SET_INT(is_runic_offensive_class_B)
...
TP_BODY_SET_INT(is_spell_always_succeeds)
TP_BODY_SET_INT(is_spellbook)
TP_BODY_SET_INT(is_spell_of_beckoning)
TP_BODY_SET_INT(is_spell_of_holding)
TP_BODY_SET_INT(is_spell_of_holding_barrier)
TP_BODY_SET_INT(is_spell_of_protection)
TP_BODY_SET_INT(is_spell_of_protection_barrier)
TP_BODY_SET_INT(is_spell_of_repulsion)
TP_BODY_SET_INT(is_spell_of_sanctuary)
TP_BODY_SET_INT(is_spell_of_sanctuary_barrier)
TP_BODY_SET_INT(is_spell_of_slowness)
...
TP_BODY_SET_INT(is_turret)
TP_BODY_SET_INT(is_undead)
TP_BODY_SET_INT(is_unobtanium)
...
TP_BODY_SET_INT(is_usable_only_after_equipping)
TP_BODY_SET_INT(is_used_when_thrown)
TP_BODY_SET_INT(is_value_defensive)
TP_BODY_SET_INT(is_value_offensive)
TP_BODY_SET_INT(is_vanquished_on_negation)
...
TP_BODY_SET_INT(temperature_never_changes)
...
TP_BODY_SET_STRING(dmg_holy_dice)
TP_BODY_SET_STRING(dmg_impact_dice)
TP_BODY_SET_STRING(dmg_lightning_dice)
TP_BODY_SET_STRING(dmg_magic_drain_dice)
...
TP_BODY_SET_STRING(on_attacking_dmg_holy_do)
TP_BODY_SET_STRING(on_attacking_dmg_impact_do)
TP_BODY_SET_STRING(on_attacking_dmg_lightning_do)
TP_BODY_SET_STRING(on_attacking_dmg_magic_drain_do)
...
TP_BODY_SET_STRING(on_eaten_do)
TP_BODY_SET_STRING(on_eating_do)
...
TP_BODY_SET_STRING(on_owner_attack_dmg_holy_do)
TP_BODY_SET_STRING(on_owner_attack_dmg_impact_do)
TP_BODY_SET_STRING(on_owner_attack_dmg_lightning_do)
TP_BODY_SET_STRING(on_owner_attack_dmg_magic_drain_do)
...
TP_BODY_SET_STRING(on_owner_rcv_dmg_acid_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_bite_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_claw_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_cold_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_crush_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_digest_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_drown_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_energy_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_fire_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_heat_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_holy_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_impact_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_lightning_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_magic_drain_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_melee_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_missile_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_nat_att_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_necrosis_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_negation_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_poison_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_stamina_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_stat_att_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_stat_con_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_stat_str_do)
TP_BODY_SET_STRING(on_owner_rcv_dmg_water_do)
TP_BODY_SET_STRING(on_owner_unset_do)
TP_BODY_SET_STRING(on_polymorphed_do)
TP_BODY_SET_STRING(on_pre_teleport_do)
TP_BODY_SET_STRING(on_rcv_dmg_acid_do)
TP_BODY_SET_STRING(on_rcv_dmg_bite_do)
TP_BODY_SET_STRING(on_rcv_dmg_claw_do)
TP_BODY_SET_STRING(on_rcv_dmg_cold_do)
TP_BODY_SET_STRING(on_rcv_dmg_crush_do)
TP_BODY_SET_STRING(on_rcv_dmg_digest_do)
TP_BODY_SET_STRING(on_rcv_dmg_drown_do)
TP_BODY_SET_STRING(on_rcv_dmg_energy_do)
TP_BODY_SET_STRING(on_rcv_dmg_fire_do)
TP_BODY_SET_STRING(on_rcv_dmg_heat_do)
TP_BODY_SET_STRING(on_rcv_dmg_holy_do)
TP_BODY_SET_STRING(on_rcv_dmg_impact_do)
TP_BODY_SET_STRING(on_rcv_dmg_lightning_do)
TP_BODY_SET_STRING(on_rcv_dmg_magic_drain_do)
TP_BODY_SET_STRING(on_rcv_dmg_melee_do)
TP_BODY_SET_STRING(on_rcv_dmg_missile_do)
TP_BODY_SET_STRING(on_rcv_dmg_nat_att_do)
TP_BODY_SET_STRING(on_rcv_dmg_necrosis_do)
TP_BODY_SET_STRING(on_rcv_dmg_negation_do)
TP_BODY_SET_STRING(on_rcv_dmg_poison_do)
TP_BODY_SET_STRING(on_rcv_dmg_stamina_do)
TP_BODY_SET_STRING(on_rcv_dmg_stat_att_do)
TP_BODY_SET_STRING(on_rcv_dmg_stat_con_do)
TP_BODY_SET_STRING(on_rcv_dmg_stat_str_do)
TP_BODY_SET_STRING(on_rcv_dmg_water_do)
...
TP_BODY_SET_STRING(text_pluralize)
TP_BODY_SET_STRING(text_apostrophize)
