...
TP_BODY_SET_INT(hates_acid)
TP_BODY_SET_INT(hates_fire)
TP_BODY_SET_INT(hates_poison)
...
TP_BODY_SET_INT(ai_can_learn_skills)
TP_BODY_SET_INT(ai_can_enchant_weapons)
TP_BODY_SET_INT(ai_can_attack_generators)
TP_BODY_SET_INT(is_ai_wanderer)
...
TP_BODY_SET_INT(is_engulf_chance_d1000)
...
TP_BODY_SET_INT(loves_fire)
TP_BODY_SET_INT(loves_poison)
TP_BODY_SET_INT(loves_spiderwebs)
