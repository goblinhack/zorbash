...
TP_BODY_SET_INT(environ_deep_water)
TP_BODY_SET_INT(environ_prefer_lava)
TP_BODY_SET_INT(environ_shallow_water)
...
TP_BODY_SET_INT_INT(dmg_chance_d1000_draining)
