...
TP_BODY_SET_INT(is_attack_blood)
...
TP_BODY_SET_INT(is_gfx_health_bar_shown)
TP_BODY_SET_INT(is_gfx_health_bar_shown_only_when_injured)
TP_BODY_SET_INT(is_gfx_moves_ahead_shown)
...
TP_BODY_SET_INT(is_shown_on_monstbar)
