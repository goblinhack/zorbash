...
TP_BODY_SET_INT(gfx_ascii_mode_shown)
...
TP_BODY_SET_INT(gfx_pixelart_health_bar_shown_when_awake_only)
...
TP_BODY_SET_INT(gfx_ascii_mode_color_spread_green)
TP_BODY_SET_INT(gfx_ascii_mode_color_spread_red)
...
TP_BODY_SET_INT(gfx_ascii_mode_color_spread_hue)
TP_BODY_SET_INT(gfx_ascii_mode_color_spread_alpha)
TP_BODY_SET_INT(gfx_ascii_mode_color_spread_blue)
...
TP_BODY_SET_STRING(damage_nat_attack_type)
...
TP_BODY_SET_STRING(on_attacking_damage_acid_do)
TP_BODY_SET_STRING(on_attacking_damage_cold_do)
TP_BODY_SET_STRING(on_attacking_damage_crush_do)
TP_BODY_SET_STRING(on_attacking_damage_digest_do)
TP_BODY_SET_STRING(on_attacking_damage_draining_do)
TP_BODY_SET_STRING(on_attacking_damage_energy_do)
TP_BODY_SET_STRING(on_attacking_damage_fire_do)
TP_BODY_SET_STRING(on_attacking_damage_future1_do)
TP_BODY_SET_STRING(on_attacking_damage_future2_do)
TP_BODY_SET_STRING(on_attacking_damage_future3_do)
TP_BODY_SET_STRING(on_attacking_damage_lightning_do)
TP_BODY_SET_STRING(on_attacking_damage_melee_do)
TP_BODY_SET_STRING(on_attacking_damage_nat_attack_do)
TP_BODY_SET_STRING(on_attacking_damage_necrosis_do)
TP_BODY_SET_STRING(on_attacking_damage_poison_do)
TP_BODY_SET_STRING(on_attacking_damage_stat_att_do)
TP_BODY_SET_STRING(on_attacking_damage_stat_con_do)
TP_BODY_SET_STRING(on_attacking_damage_stat_str_do)
...
TP_BODY_SET_STRING(on_owner_attacking_damage_acid_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_cold_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_crush_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_digest_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_draining_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_energy_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_fire_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_future1_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_future2_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_future3_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_lightning_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_melee_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_nat_attack_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_necrosis_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_poison_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_stat_att_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_stat_con_do)
TP_BODY_SET_STRING(on_owner_attacking_damage_stat_str_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_acid_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_cold_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_crush_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_digest_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_draining_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_energy_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_fire_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_future1_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_future2_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_future3_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_lightning_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_melee_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_nat_attack_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_necrosis_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_poison_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_stat_att_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_stat_con_do)
TP_BODY_SET_STRING(on_owner_receiving_damage_stat_str_do)
TP_BODY_SET_STRING(on_owner_remove_do)
TP_BODY_SET_STRING(on_polymorphed_do)
TP_BODY_SET_STRING(on_receiving_damage_acid_do)
TP_BODY_SET_STRING(on_receiving_damage_cold_do)
TP_BODY_SET_STRING(on_receiving_damage_crush_do)
TP_BODY_SET_STRING(on_receiving_damage_digest_do)
TP_BODY_SET_STRING(on_receiving_damage_draining_do)
TP_BODY_SET_STRING(on_receiving_damage_energy_do)
TP_BODY_SET_STRING(on_receiving_damage_fire_do)
TP_BODY_SET_STRING(on_receiving_damage_future1_do)
TP_BODY_SET_STRING(on_receiving_damage_future2_do)
TP_BODY_SET_STRING(on_receiving_damage_future3_do)
TP_BODY_SET_STRING(on_receiving_damage_lightning_do)
TP_BODY_SET_STRING(on_receiving_damage_melee_do)
TP_BODY_SET_STRING(on_receiving_damage_nat_attack_do)
TP_BODY_SET_STRING(on_receiving_damage_necrosis_do)
TP_BODY_SET_STRING(on_receiving_damage_poison_do)
TP_BODY_SET_STRING(on_receiving_damage_stat_att_do)
TP_BODY_SET_STRING(on_receiving_damage_stat_con_do)
TP_BODY_SET_STRING(on_receiving_damage_stat_str_do)
...
TP_BODY_SET_STRING(on_you_nat_attack_do)
