...
TP_BODY_SET_INT(is_bodypart_eyes)
TP_BODY_SET_INT(is_bodypart_face)
TP_BODY_SET_INT(is_bodypart_hair)
TP_BODY_SET_INT(is_bodypart_hat)
TP_BODY_SET_INT(is_bodypart_legs)
TP_BODY_SET_INT(is_bodypart_torso)
