...
TP_BODY_SET_INT(gfx_ascii_color_spread_green)
TP_BODY_SET_INT(gfx_ascii_color_spread_red)
...
TP_BODY_SET_INT(gfx_ascii_color_spread_alpha)
TP_BODY_SET_INT(gfx_ascii_color_spread_blue)
