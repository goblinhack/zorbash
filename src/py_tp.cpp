...
TP_BODY_SET_INT(ai_aggression_level)
...
TP_BODY_SET_INT(damage_value_doubled_from_acid)
TP_BODY_SET_INT(damage_value_doubled_from_fire)
TP_BODY_SET_INT(damage_value_doubled_from_necrosis)
TP_BODY_SET_INT(damage_value_doubled_from_poison)
TP_BODY_SET_INT(damage_value_doubled_from_water)
