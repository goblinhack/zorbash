...
TP_BODY_SET_INT(delay_ai_ms)
TP_BODY_SET_INT(is_bouncy)
...
TP_BODY_SET_INT(is_starving_at_health_pct)
TP_BODY_SET_INT(is_initial_health_at)
TP_BODY_SET_INT(is_hungry_at_health_pct)
TP_BODY_SET_INT(is_hungry_every_rounds)
TP_BODY_SET_INT(is_scent_aware_at_distance)
TP_BODY_SET_INT(is_ripple)
TP_BODY_SET_INT(is_light_strength)
TP_BODY_SET_INT(is_dirt)
TP_BODY_SET_INT(is_blood)
TP_BODY_SET_INT(is_animated_can_vflip)
TP_BODY_SET_INT(is_blit_y_offset)
TP_BODY_SET_INT(is_small_shadow_caster)
TP_BODY_SET_INT(is_corridor)
TP_BODY_SET_INT(is_blitted_as_sitting_on_the_ground)
