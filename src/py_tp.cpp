...
TP_BODY_SET_STRING(on_damage_nat_attack_do)
TP_BODY_SET_STRING(on_damage_necrosis_do)
TP_BODY_SET_STRING(on_damage_draining_do)
TP_BODY_SET_STRING(on_damage_stamina_do)
...
TP_BODY_SET_STRING(on_owner_damage_nat_attack_do)
TP_BODY_SET_STRING(on_owner_damage_necrosis_do)
TP_BODY_SET_STRING(on_owner_damage_draining_do)
TP_BODY_SET_STRING(on_owner_damage_stamina_do)
