...
TP_BODY_SET_INT(chance_d1000_is_able_to_grapple)
TP_BODY_SET_INT(chance_d1000_is_able_to_jump_attack)
TP_BODY_SET_INT(chance_d1000_is_able_to_jump_on_low_hp)
TP_BODY_SET_INT(chance_d1000_is_able_to_jump_onto)
TP_BODY_SET_INT(chance_d1000_is_able_to_jump_randomly)
TP_BODY_SET_INT(chance_d1000_is_able_to_shove)
TP_BODY_SET_INT(chance_d1000_is_able_to_teleport_attack)
TP_BODY_SET_INT(chance_d1000_is_steal_item)
TP_BODY_SET_INT(chance_d1000_melting)
TP_BODY_SET_INT(chance_d1000_set_on_fire)
TP_BODY_SET_INT(charge_count)
TP_BODY_SET_INT(collateral_dmg_pct)
...
TP_BODY_SET_INT(is_carrier_of_treasure_class_a_d1000)
TP_BODY_SET_INT(is_carrier_of_treasure_class_b_d1000)
TP_BODY_SET_INT(is_carrier_of_treasure_class_c_d1000)
TP_BODY_SET_INT(is_carrier_of_weapon_class_a_d1000)
TP_BODY_SET_INT(is_carrier_of_weapon_class_b_d1000)
TP_BODY_SET_INT(is_carrier_of_weapon_class_c_d1000)
