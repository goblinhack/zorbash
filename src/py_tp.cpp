...
TP_BODY_SET_INT(noise_decibels_on_jumping)
TP_BODY_SET_INT(noise_decibels_on_born)
TP_BODY_SET_INT(noise_decibels_on_open)
TP_BODY_SET_INT(noise_decibels_on_you_are_hit_and_now_dead)
TP_BODY_SET_INT(noise_decibels_on_you_are_hit_but_still_alive)
...
TP_BODY_SET_INT(noise_decibels_on_moving_or_being_carried)
