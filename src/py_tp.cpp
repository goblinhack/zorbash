...
TP_BODY_SET_STRING(weapon_swing_anim)
...
TP_BODY_SET_INT(weapon_fire_delay_hundredths)
...
TP_BODY_SET_INT(weapon_swing_distance)
TP_BODY_SET_INT(is_weapon_carry_anim)
TP_BODY_SET_INT(is_weapon_swing_effect)
