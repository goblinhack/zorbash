...
TP_BODY_SET_STRING(on_owner_receive_dmg_impact_do)
TP_BODY_SET_STRING(on_owner_receive_dmg_lightning_do)
TP_BODY_SET_STRING(on_owner_receive_dmg_magic_drain_do)
...
TP_BODY_SET_STRING(on_receiving_dmg_impact_do)
TP_BODY_SET_STRING(on_receiving_dmg_lightning_do)
TP_BODY_SET_STRING(on_receiving_dmg_magic_drain_do)
