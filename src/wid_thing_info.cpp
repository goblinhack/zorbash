...
void Game::wid_thing_info_add_dmg_poison(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_poison(index))) / 1000.0) * 100.0);
      if (chance < 100) {
...
void Game::wid_thing_info_add_dmg_drown(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_drown(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_bite(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_bite(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_claw(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_claw(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_cold(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_cold(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_fire(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_fire(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_heat(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_heat(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_crush(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_crush(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_missile(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_missile(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_lightning(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_lightning(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_energy(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_energy(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_negation(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_negation(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_acid(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_acid(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_nat_att(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_nat_att(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_digest(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_digest(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_necrosis(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_necrosis(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
...
void Game::wid_thing_info_add_dmg_draining(WidPopup *w, Thingp t, int index)
{
  ...
  if (t->is_ranged_weapon() || t->is_alive_monst() || t->is_player() || t->is_weapon() || t->is_magical()) {
    ...
    if (min_value > 0) {
      ...
      int chance = (int) (((((float) tp->chance_d1000_dmg_draining(index))) / 1000.0) * 100.0);
      if (chance < 100) {
        snprintf(tmp2, sizeof(tmp2) - 1, "%d percent", chance);
        snprintf(tmp, sizeof(tmp) - 1, "%%fg=gray60$- Chance %20s", tmp2);
        w->log(tmp);
