...
public:
    ...
    int is_gfx_animated(void);
    int is_gfx_animated_can_vflip(void);
    int is_gfx_animated_no_dir(void);
    int is_gfx_bounce_on_move(void);
    int is_gfx_animated_can_hflip(void);
    int is_gfx_an_animation_only(void);
    int is_floor_deco(void);
    int is_wall_deco(void);
    int is_gfx_weapon_carry_anim(void);
    int is_gfx_attack_anim(void);
    int is_gfx_on_fire_anim(void);
    int is_gfx_large_shadow(void);
    int is_gfx_show_outlined(void);
    int is_gfx_oversized_but_sitting_on_the_ground(void);
    int is_gfx_small_shadow_caster(void);
