...
public:
  ...
  bool        ai_create_path_to_single_goal(int minx, int miny, int maxx, int maxy, const Goal &goal,
                                            const struct Dmap_ *saved_dmap);
  ...
  const ThingId &        get_top_owner_id(void) const;
  ...
  uint32_t               get_tick_last_dropped(void) const;
