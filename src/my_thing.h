...
public:
  ...
  bool get_coords(point &blit_tl, point &blit_br, point &pre_effect_blit_tl, point &pre_effect_blit_br, Tilep &tile,
                  bool reflection);
  ...
  bool move(fpoint future_pos, uint8_t up, uint8_t down, uint8_t left, uint8_t right, uint8_t attack, uint8_t idle,
            bool shove_allowed, bool attack_allowed);
  ...
  bool spawn_radius_range(Thingp parent, Thingp target, const std::string &what, uint32_t radius_min,
                          uint32_t radius_max);
