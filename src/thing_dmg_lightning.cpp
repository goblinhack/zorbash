...
int Thing::dmg_lightning_chance_d1000(int index)
{
  TRACE_NO_INDENT();
  return (tp()->dmg_lightning_chance_d1000(index));
}
...
int Tp::dmg_lightning_chance_d1000(int index) const
{
  if (index >= (int) _dmg_lightning_chance_d1000.size()) {
    return 0;
  }
  return _dmg_lightning_chance_d1000[ index ];
}

void Tp::dmg_lightning_chance_d1000_set(int index, int v)
{
  _dmg_lightning_chance_d1000.resize(index + 1);
  _dmg_lightning_chance_d1000[ index ] = v;
}
