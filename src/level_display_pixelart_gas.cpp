...
void Level::display_pixelart_gas_explosive(int fbo, int16_t minx, int16_t miny, int16_t maxx, int16_t maxy)
{
  TRACE_NO_INDENT();
...
#define GAS_TILES 16
  ...
  if (! gas[ 0 ]) {
    set(gas, 0, tile_find_mand("gas_explosive.1"));
    set(gas, 1, tile_find_mand("gas_explosive.2"));
    set(gas, 2, tile_find_mand("gas_explosive.3"));
    set(gas, 3, tile_find_mand("gas_explosive.4"));
    set(gas, 4, tile_find_mand("gas_explosive.5"));
    set(gas, 5, tile_find_mand("gas_explosive.6"));
    set(gas, 6, tile_find_mand("gas_explosive.7"));
    set(gas, 7, tile_find_mand("gas_explosive.8"));
    set(gas, 8, tile_find_mand("gas_explosive.9"));
    set(gas, 9, tile_find_mand("gas_explosive.10"));
    set(gas, 10, tile_find_mand("gas_explosive.11"));
    set(gas, 11, tile_find_mand("gas_explosive.12"));
    set(gas, 12, tile_find_mand("gas_explosive.13"));
    set(gas, 13, tile_find_mand("gas_explosive.14"));
    set(gas, 14, tile_find_mand("gas_explosive.15"));
    set(gas, 15, tile_find_mand("gas_explosive.16"));
  }
      ...
      for (auto x = minx; x < maxx - 1; x++) {
        ...
        for (auto dy = 0; dy < DUNGEON_GAS_RESOLUTION; dy++) {
          for (auto dx = 0; dx < DUNGEON_GAS_RESOLUTION; dx++) {
            ...
            uint8_t  intensity = gas_explosive_cloud[ gx ][ gy ];
...
void Level::display_pixelart_gas_paralysis(int fbo, int16_t minx, int16_t miny, int16_t maxx, int16_t maxy)
{
  TRACE_NO_INDENT();
      ...
      for (auto x = minx; x < maxx - 1; x++) {
        ...
        for (auto dy = 0; dy < DUNGEON_GAS_RESOLUTION; dy++) {
          for (auto dx = 0; dx < DUNGEON_GAS_RESOLUTION; dx++) {
            uint16_t gx        = x * DUNGEON_GAS_RESOLUTION + dx;
            uint16_t gy        = y * DUNGEON_GAS_RESOLUTION + dy;
            uint8_t  intensity = gas_paralysis_cloud[ gx ][ gy ];
...
void Level::display_pixelart_gas_confusion(int fbo, int16_t minx, int16_t miny, int16_t maxx, int16_t maxy)
{
  TRACE_NO_INDENT();
...
#define GAS_TILES 16
  static std::array< Tilep, GAS_TILES > gas;
  if (! gas[ 0 ]) {
    set(gas, 0, tile_find_mand("gas_confusion.1"));
    set(gas, 1, tile_find_mand("gas_confusion.2"));
    set(gas, 2, tile_find_mand("gas_confusion.3"));
    set(gas, 3, tile_find_mand("gas_confusion.4"));
    set(gas, 4, tile_find_mand("gas_confusion.5"));
    set(gas, 5, tile_find_mand("gas_confusion.6"));
    set(gas, 6, tile_find_mand("gas_confusion.7"));
    set(gas, 7, tile_find_mand("gas_confusion.8"));
    set(gas, 8, tile_find_mand("gas_confusion.9"));
    set(gas, 9, tile_find_mand("gas_confusion.10"));
    set(gas, 10, tile_find_mand("gas_confusion.11"));
    set(gas, 11, tile_find_mand("gas_confusion.12"));
    set(gas, 12, tile_find_mand("gas_confusion.13"));
    set(gas, 13, tile_find_mand("gas_confusion.14"));
    set(gas, 14, tile_find_mand("gas_confusion.15"));
    set(gas, 15, tile_find_mand("gas_confusion.16"));
  }
      ...
      for (auto x = minx; x < maxx - 1; x++) {
        ...
        for (auto dy = 0; dy < DUNGEON_GAS_RESOLUTION; dy++) {
          for (auto dx = 0; dx < DUNGEON_GAS_RESOLUTION; dx++) {
            uint16_t gx        = x * DUNGEON_GAS_RESOLUTION + dx;
            uint16_t gy        = y * DUNGEON_GAS_RESOLUTION + dy;
            uint8_t  intensity = gas_confusion_cloud[ gx ][ gy ];
      ...
      for (auto x = minx; x < maxx - 1; x++) {
        ...
        for (auto dy = 0; dy < DUNGEON_GAS_RESOLUTION; dy++) {
          for (auto dx = 0; dx < DUNGEON_GAS_RESOLUTION; dx++) {
            uint16_t gx        = x * DUNGEON_GAS_RESOLUTION + dx;
            uint16_t gy        = y * DUNGEON_GAS_RESOLUTION + dy;
            uint8_t  intensity = darkness_cloud[ gx ][ gy ];
