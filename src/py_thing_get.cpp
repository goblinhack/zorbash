...
THING_BODY_GET_BOOL(thing_dmg_limited_per_tick, dmg_limited_per_tick)
THING_BODY_GET_BOOL(thing_dmg_num_of_attacks, dmg_num_of_attacks)
THING_BODY_GET_BOOL(thing_dmg_rcv_doubled_from_cold, dmg_rcv_doubled_from_cold)
...
THING_BODY_GET_BOOL(thing_gfx_ascii_show_light_once_seen, gfx_ascii_show_light_once_seen)
...
THING_BODY_GET_BOOL(thing_has_a_head, has_a_head)
...
THING_BODY_GET_BOOL(thing_is_able_to_be_reflected, is_able_to_be_reflected)
...
THING_BODY_GET_BOOL(thing_is_able_to_break_out_of_spell_of_sanctuary, is_able_to_break_out_of_spell_of_sanctuary)
...
THING_BODY_GET_BOOL(thing_is_able_to_fall_over, is_able_to_fall_over)
...
THING_BODY_GET_BOOL(thing_is_acid_blob, is_acid_blob)
...
THING_BODY_GET_BOOL(thing_is_blunt, is_blunt)
...
THING_BODY_GET_BOOL(thing_is_buffable, is_buffable)
...
THING_BODY_GET_BOOL(thing_is_icefolk, is_icefolk)
...
THING_BODY_GET_BOOL(thing_is_immune_to_holy_damage, is_immune_to_holy_damage)
...
THING_BODY_GET_BOOL(thing_is_immune_to_non_magical_weapons, is_immune_to_non_magical_weapons)
...
THING_BODY_GET_BOOL(thing_is_immune_to_spell_of_sanctuary, is_immune_to_spell_of_sanctuary)
THING_BODY_GET_BOOL(thing_is_immune_to_spell_of_slowness, is_immune_to_spell_of_slowness)
...
THING_BODY_GET_BOOL(thing_is_immune_to_vorpal_weapons, is_immune_to_vorpal_weapons)
...
THING_BODY_GET_BOOL(thing_is_mantisfolk, is_mantisfolk)
...
THING_BODY_GET_BOOL(thing_is_reflective, is_reflective)
...
THING_BODY_GET_BOOL(thing_is_runic_defensive_class_A, is_runic_defensive_class_A)
THING_BODY_GET_BOOL(thing_is_runic_defensive_class_B, is_runic_defensive_class_B)
THING_BODY_GET_BOOL(thing_is_runic_offensive_class_A, is_runic_offensive_class_A)
THING_BODY_GET_BOOL(thing_is_runic_offensive_class_B, is_runic_offensive_class_B)
...
THING_BODY_GET_BOOL(thing_is_sluud, is_sluud)
...
THING_BODY_GET_BOOL(thing_is_spell_of_sanctuary_barrier, is_spell_of_sanctuary_barrier)
THING_BODY_GET_BOOL(thing_is_spell_of_sanctuary, is_spell_of_sanctuary)
THING_BODY_GET_BOOL(thing_is_spell_of_slowness, is_spell_of_slowness)
...
THING_BODY_GET_BOOL(thing_is_steel, is_steel)
THING_BODY_GET_BOOL(thing_is_sticky, is_sticky)
THING_BODY_GET_BOOL(thing_is_stone, is_stone)
THING_BODY_GET_BOOL(thing_is_swimmer_but_land_dweller, is_swimmer_but_land_dweller)
...
THING_BODY_GET_BOOL(thing_is_tentacle_horror, is_tentacle_horror)
THING_BODY_GET_BOOL(thing_is_tentacle, is_tentacle)
THING_BODY_GET_BOOL(thing_is_tentacleye, is_tentacleye)
THING_BODY_GET_BOOL(thing_is_the_grid, is_the_grid)
...
THING_BODY_GET_BOOL(thing_is_unobtanium, is_unobtanium)
...
THING_BODY_GET_BOOL(thing_is_value_defensive, is_value_defensive)
THING_BODY_GET_BOOL(thing_is_value_offensive, is_value_offensive)
THING_BODY_GET_BOOL(thing_is_vanquished_on_negation, is_vanquished_on_negation)
...
THING_BODY_GET_INT(thing_dmg_holy, dmg_holy)
THING_BODY_GET_INT(thing_dmg_impact, dmg_impact)
THING_BODY_GET_INT(thing_dmg_lightning, dmg_lightning)
THING_BODY_GET_INT(thing_dmg_magic_drain, dmg_magic_drain)
