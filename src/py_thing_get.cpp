...
THING_BODY_GET_THING(thing_get_immediate_mob_id, immediate_mob_id)
THING_BODY_GET_THING(thing_get_immediate_owner_id, immediate_owner_id)
THING_BODY_GET_THING(thing_get_immediate_spawned_owner_id, immediate_spawned_owner_id)
THING_BODY_GET_THING(thing_get_leader_id, leader_id)
THING_BODY_GET_THING(thing_get_top_owner_id, top_owner_id)
