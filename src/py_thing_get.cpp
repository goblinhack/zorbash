...
THING_BODY_GET_BOOL(chance_d1000_thing_is_able_to_jump_attack, chance_d1000_is_able_to_jump_attack)
THING_BODY_GET_BOOL(chance_d1000_thing_is_able_to_jump_on_low_hp, chance_d1000_is_able_to_jump_on_low_hp)
THING_BODY_GET_BOOL(chance_d1000_thing_is_able_to_jump_onto, chance_d1000_is_able_to_jump_onto)
THING_BODY_GET_BOOL(chance_d1000_thing_is_able_to_jump_randomly, chance_d1000_is_able_to_jump_randomly)
THING_BODY_GET_BOOL(chance_d1000_thing_is_able_to_teleport_attack, chance_d1000_is_able_to_teleport_attack)
THING_BODY_GET_BOOL(chance_d1000_thing_is_steal_item, chance_d1000_is_steal_item)
