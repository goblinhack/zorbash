...
THING_BODY_GET_BOOL(thing_damage_cold_chance_d1000, damage_cold_chance_d1000)
...
THING_BODY_GET_BOOL(thing_gfx_health_bar_shown_when_awake_only, gfx_health_bar_shown_when_awake_only)
THING_BODY_GET_BOOL(thing_gfx_long_shadow_caster, gfx_long_shadow_caster)
THING_BODY_GET_BOOL(thing_gfx_show_asleep, gfx_show_asleep)
...
THING_BODY_GET_BOOL(thing_hunger_clock_tick_frequency, hunger_clock_tick_frequency_get)
...
THING_BODY_GET_BOOL(thing_is_breather, is_breather)
...
THING_BODY_GET_BOOL(thing_is_pink_blood_eater, is_pink_blood_eater)
THING_BODY_GET_BOOL(thing_is_pink_blooded, is_pink_blooded)
THING_BODY_GET_BOOL(thing_is_pink_blood, is_pink_blood)
...
THING_BODY_GET_BOOL(thing_is_toughness_very_hard, is_toughness_very_hard)
...
THING_BODY_GET_BOOL(thing_noise_on_jumping, noise_on_jumping)
THING_BODY_GET_BOOL(thing_noise_on_moving_or_being_carried, noise_on_moving_or_being_carried)
...
THING_BODY_GET_BOOL(thing_spawn_group_radius, spawn_group_radius_get)
...
THING_BODY_GET_BOOL(thing_temperature_change_sensitive, temperature_change_sensitive)
...
THING_BODY_GET_INT(thing_get_charge_count, charge_count_get)
THING_BODY_GET_INT(thing_get_current_damage, current_damage_get)
THING_BODY_GET_INT(thing_get_damage_acid, damage_acid_get)
THING_BODY_GET_INT(thing_get_damage_cold, damage_cold_get)
THING_BODY_GET_INT(thing_get_damage_crush, damage_crush_get)
THING_BODY_GET_INT(thing_get_damage_digest, damage_digest_get)
THING_BODY_GET_INT(thing_get_damage_energy, damage_energy_get)
THING_BODY_GET_INT(thing_get_damage_fire, damage_fire_get)
THING_BODY_GET_INT(thing_get_damage_future1, damage_future1_get)
THING_BODY_GET_INT(thing_get_damage_future2, damage_future2_get)
THING_BODY_GET_INT(thing_get_damage_future3, damage_future3_get)
THING_BODY_GET_INT(thing_get_damage_lightning, damage_lightning_get)
THING_BODY_GET_INT(thing_get_damage_melee, damage_melee_get)
THING_BODY_GET_INT(thing_get_damage_natural_attack, damage_natural_attack_get)
THING_BODY_GET_INT(thing_get_damage_necrosis, damage_necrosis_get)
THING_BODY_GET_INT(thing_get_damage_poison, damage_poison_get)
THING_BODY_GET_INT(thing_get_enchant, enchant_get)
THING_BODY_GET_INT(thing_get_enchant_max, enchant_max_get)
THING_BODY_GET_INT(thing_get_health, health_get)
THING_BODY_GET_INT(thing_get_health_max, health_max_get)
THING_BODY_GET_INT(thing_get_initial_charge_count, initial_charge_count_get)
THING_BODY_GET_INT(thing_get_necrotized_amount, necrotized_amount_get)
THING_BODY_GET_INT(thing_get_poisoned_amount, poisoned_amount_get)
THING_BODY_GET_INT(thing_get_stamina, stamina_get)
THING_BODY_GET_INT(thing_get_stamina_max, stamina_max_get)
THING_BODY_GET_INT(thing_get_stat_con, stat_con_get)
THING_BODY_GET_STRING(thing_get_name, text_name)
THING_BODY_GET_THING(thing_get_immediate_mob_id, immediate_mob_id_get)
THING_BODY_GET_THING(thing_get_immediate_owner_id, immediate_owner_id_get)
THING_BODY_GET_THING(thing_get_immediate_spawned_owner_id, immediate_spawned_owner_id_get)
THING_BODY_GET_THING(thing_get_leader_id, leader_id_get)
THING_BODY_GET_THING(thing_get_top_owner_id, top_owner_id_get)
