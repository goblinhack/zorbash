...
THING_BODY_GET_INT(thing_get_damage_current, damage_current)
THING_BODY_GET_INT(thing_get_damage_acid, damage_acid)
THING_BODY_GET_INT(thing_get_damage_cold, damage_cold)
THING_BODY_GET_INT(thing_get_damage_crush, damage_crush)
THING_BODY_GET_INT(thing_get_damage_digest, damage_digest)
THING_BODY_GET_INT(thing_get_damage_energy, damage_energy)
THING_BODY_GET_INT(thing_get_damage_fire, damage_fire)
THING_BODY_GET_INT(thing_get_damage_future1, damage_future1)
THING_BODY_GET_INT(thing_get_damage_future2, damage_future2)
THING_BODY_GET_INT(thing_get_damage_future3, damage_future3)
THING_BODY_GET_INT(thing_get_damage_lightning, damage_lightning)
THING_BODY_GET_INT(thing_get_damage_melee, damage_melee)
THING_BODY_GET_INT(thing_get_damage_natural_attack, damage_natural_attack)
THING_BODY_GET_INT(thing_get_damage_necrosis, damage_necrosis)
THING_BODY_GET_INT(thing_get_damage_poison, damage_poison)
THING_BODY_GET_INT(thing_get_enchant, enchant_get)
THING_BODY_GET_INT(thing_get_enchant_max, enchant_max_current_get)
THING_BODY_GET_INT(thing_get_health, health_get)
THING_BODY_GET_INT(thing_get_health_max, health_max_get)
THING_BODY_GET_INT(thing_get_initial_charge_count, initial_charge_count)
