...
THING_BODY_GET_BOOL(thing_is_immune_to_spell_beckoning, is_immune_to_spell_beckoning)
THING_BODY_GET_BOOL(thing_is_immune_to_spell_of_holding, is_immune_to_spell_of_holding)
THING_BODY_GET_BOOL(thing_is_immune_to_spell_repulsion, is_immune_to_spell_repulsion)
THING_BODY_GET_BOOL(thing_is_immune_to_spell_slow, is_immune_to_spell_slow)
...
THING_BODY_GET_BOOL(thing_is_spell_beckoning, is_spell_beckoning)
...
THING_BODY_GET_BOOL(thing_is_spell_slow, is_spell_slow)
...
THING_BODY_GET_BOOL(thing_is_unused_flag95, is_unused_flag95)
