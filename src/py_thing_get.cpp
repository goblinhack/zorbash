...
THING_BODY_GET_BOOL(thing_is_biome_water, is_biome_water)
...
THING_BODY_GET_BOOL(thing_msg_is_seen, msg_is_seen)
THING_BODY_GET_BOOL(thing_msg_is_wounded, msg_is_wounded)
