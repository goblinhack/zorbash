...
THING_BODY_GET_INT(thing_damage_acid_get, damage_acid)
THING_BODY_GET_INT(thing_damage_cold_get, damage_cold)
THING_BODY_GET_INT(thing_damage_crush_get, damage_crush)
THING_BODY_GET_INT(thing_damage_current_get, damage_current)
THING_BODY_GET_INT(thing_damage_digest_get, damage_digest)
THING_BODY_GET_INT(thing_damage_energy_get, damage_energy)
THING_BODY_GET_INT(thing_damage_fire_get, damage_fire)
THING_BODY_GET_INT(thing_damage_future1_get, damage_future1)
THING_BODY_GET_INT(thing_damage_future2_get, damage_future2)
THING_BODY_GET_INT(thing_damage_future3_get, damage_future3)
THING_BODY_GET_INT(thing_damage_lightning_get, damage_lightning)
THING_BODY_GET_INT(thing_damage_melee_get, damage_melee)
THING_BODY_GET_INT(thing_damage_natural_attack_get, damage_natural_attack)
THING_BODY_GET_INT(thing_damage_necrosis_get, damage_necrosis)
THING_BODY_GET_INT(thing_damage_poison_get, damage_poison)
