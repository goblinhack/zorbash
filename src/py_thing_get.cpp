...
THING_BODY_GET_BOOL(thing_bite_amount, bite_amount)
...
THING_BODY_GET_BOOL(thing_gfx_pixelart_reflection, gfx_pixelart_reflection)
THING_BODY_GET_BOOL(thing_gfx_pixelart_shadow, gfx_pixelart_shadow)
...
THING_BODY_GET_BOOL(thing_is_eater_of_wands, is_eater_of_wands)
...
THING_BODY_GET_BOOL(thing_is_submerged, is_submerged)
...
THING_BODY_GET_BOOL(thing_is_throw_blocker, is_throw_blocker)
