...
THING_BODY_GET_BOOL(thing_is_immune_to_spell_hold, is_immune_to_spell_hold)
...
THING_BODY_GET_BOOL(thing_is_spell_hold_effect, is_spell_hold_effect)
THING_BODY_GET_BOOL(thing_is_spell_hold, is_spell_hold)
