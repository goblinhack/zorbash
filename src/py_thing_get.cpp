...
THING_BODY_GET_BOOL(thing_distance_jump, distance_jump_get)
...
THING_BODY_GET_BOOL(thing_is_very_is_combustible, is_very_is_combustible)
...
THING_BODY_GET_BOOL(thing_stamina_drain_on_swinging, stamina_drain_on_swinging)
...
THING_BODY_GET_BOOL(thing_gfx_wobbles_when_hit, gfx_wobbles_when_hit)
...
THING_BODY_GET_BOOL(thing_distance_teleport, distance_teleport_get)
...
THING_BODY_GET_INT(thing_damage_natural_attack, damage_natural_attack)
...
THING_BODY_GET_INT(thing_distance_teleport_get, distance_teleport_get)
THING_BODY_GET_INT(thing_distance_jump_get, distance_jump_get)
THING_BODY_GET_INT(thing_health_get, health)
...
THING_BODY_GET_INT(thing_stamina_get, stamina_get)
...
THING_BODY_GET_STRING(thing_name_get, text_name)
