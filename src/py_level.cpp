...
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_moving_or_being_carried_at, noise_decibels_on_moving_or_being_carried)
...
LEVEL_BODY_GET_BOOL_AT(level_gfx_health_bar_shown_when_awake_only_at, gfx_health_bar_shown_when_awake_only)
LEVEL_BODY_GET_BOOL_AT(level_gfx_show_asleep_at, gfx_show_asleep)
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_jumping_at, noise_decibels_on_jumping)
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_born_at, noise_decibels_on_born)
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_open_at, noise_decibels_on_open)
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_you_are_hit_and_now_dead_at, noise_decibels_on_you_are_hit_and_now_dead)
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_on_you_are_hit_but_still_alive_at, noise_decibels_on_you_are_hit_but_still_alive)
