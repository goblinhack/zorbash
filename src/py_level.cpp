...
LEVEL_BODY_GET_BOOL_AT(level_is_flammable_at, is_flammable)
...
LEVEL_BODY_GET_BOOL_AT(level_is_gfx_water_at, is_gfx_water)
...
LEVEL_BODY_GET_BOOL_AT(level_is_laser_target_select_automatically_when_chosen_at, is_laser_target_select_automatically_when_chosen)
...
LEVEL_BODY_GET_BOOL_AT(level_is_poison_immune_at, is_poison_immune)
...
LEVEL_BODY_GET_BOOL_AT(level_is_rrr92_at, is_rrr92)
LEVEL_BODY_GET_BOOL_AT(level_is_rrr93_at, is_rrr93)
LEVEL_BODY_GET_BOOL_AT(level_is_rrr94_at, is_rrr94)
LEVEL_BODY_GET_BOOL_AT(level_is_rrr95_at, is_rrr95)
LEVEL_BODY_GET_BOOL_AT(level_is_gfx_flickers_at, is_gfx_flickers)
