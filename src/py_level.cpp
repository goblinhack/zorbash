...
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_see_through_doors_at, ai_is_able_to_see_through_doors)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_walk_through_walls_at, ai_is_able_to_walk_through_walls)
LEVEL_BODY_GET_BOOL_AT(level_is_acid_at, is_acid)
LEVEL_BODY_GET_BOOL_AT(level_environ_loves_acid_at, environ_loves_acid)
...
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_jump_at, ai_is_able_to_jump)
LEVEL_BODY_GET_BOOL_AT(level_ai_random_jump_chance_d1000_at, ai_random_jump_chance_d1000)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_jump_distance_at, ai_is_able_to_jump_distance)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_jump_on_low_hp_chance_d1000_at, ai_is_able_to_jump_on_low_hp_chance_d1000)
LEVEL_BODY_GET_BOOL_AT(level_is_key_at, is_key)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_collect_keys_at, ai_is_able_to_collect_keys)
...
LEVEL_BODY_GET_BOOL_AT(level_ai_aggression_level_at, ai_aggression_level)
...
LEVEL_BODY_GET_BOOL_AT(level_environ_hates_poison_at, environ_hates_poison)
LEVEL_BODY_GET_BOOL_AT(level_environ_hates_fire_at, environ_hates_fire)
LEVEL_BODY_GET_BOOL_AT(level_unused_flag3_at, unused_flag3)
LEVEL_BODY_GET_BOOL_AT(level_environ_hates_water_at, environ_hates_water)
LEVEL_BODY_GET_BOOL_AT(level_environ_hates_acid_at, environ_hates_acid)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_detect_secret_doors_when_close_at,
                       ai_is_able_to_detect_secret_doors_when_close)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_break_down_doors_at, ai_is_able_to_break_down_doors)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_break_out_of_webs_at, ai_is_able_to_break_out_of_webs)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_open_doors_at, ai_is_able_to_open_doors)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_exit_finder_at, ai_is_exit_finder)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_level_explorer_at, ai_is_level_explorer)
LEVEL_BODY_GET_BOOL_AT(level_is_rusty_at, is_rusty)
LEVEL_BODY_GET_BOOL_AT(level_unused_flag4_at, unused_flag4)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_learn_skills_at, ai_is_able_to_learn_skills)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_enchant_weapons_at, ai_is_able_to_enchant_weapons)
LEVEL_BODY_GET_BOOL_AT(level_ai_is_able_to_attack_generators_at, ai_is_able_to_attack_generators)
...
LEVEL_BODY_GET_BOOL_AT(level_attack_poison_chance_d1000_at, attack_poison_chance_d1000)
...
LEVEL_BODY_GET_BOOL_AT(level_ai_is_item_collector_at, ai_is_item_collector)
...
LEVEL_BODY_GET_BOOL_AT(level_environ_loves_fire_at, environ_loves_fire)
LEVEL_BODY_GET_BOOL_AT(level_environ_loves_poison_at, environ_loves_poison)
LEVEL_BODY_GET_BOOL_AT(level_environ_loves_spiderwebs_at, environ_loves_spiderwebs)
