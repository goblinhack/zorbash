...
LEVEL_BODY_GET_BOOL_AT(level_gfx_pixelart_health_bar_shown_when_awake_only_at, gfx_pixelart_health_bar_shown_when_awake_only)
...
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_color_spread_green_at, gfx_ascii_color_spread_green)
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_color_spread_red_at, gfx_ascii_color_spread_red)
...
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_color_spread_alpha_at, gfx_ascii_color_spread_alpha)
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_color_spread_blue_at, gfx_ascii_color_spread_blue)
