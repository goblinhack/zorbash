...
LEVEL_BODY_GET_BOOL_AT(level_hunger_insatiable_at, hunger_insatiable)
...
LEVEL_BODY_GET_BOOL_AT(level_hunger_clock_tick_frequency_at, hunger_clock_tick_frequency)
