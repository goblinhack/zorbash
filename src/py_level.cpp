...
LEVEL_BODY_GET_BOOL_AT(level_noise_on_jumping_at, noise_on_jumping)
LEVEL_BODY_GET_BOOL_AT(level_noise_on_moving_or_being_carried_at, noise_on_moving_or_being_carried)
