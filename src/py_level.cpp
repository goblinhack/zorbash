...
LEVEL_BODY_GET_BOOL_AT(level_dmg_num_of_attacks_at, dmg_num_of_attacks)
LEVEL_BODY_GET_BOOL_AT(level_dmg_rcv_doubled_from_cold_at, dmg_rcv_doubled_from_cold)
...
LEVEL_BODY_GET_BOOL_AT(level_is_able_to_be_resurrected_at, is_able_to_be_resurrected)
LEVEL_BODY_GET_BOOL_AT(level_is_able_to_break_out_of_ice_at, is_able_to_break_out_of_ice)
LEVEL_BODY_GET_BOOL_AT(level_is_able_to_dampen_footsteps_at, is_able_to_dampen_footsteps)
...
LEVEL_BODY_GET_BOOL_AT(level_is_block_of_crystal_at, is_block_of_crystal)
...
LEVEL_BODY_GET_BOOL_AT(level_is_crystalline_at, is_crystalline)
...
LEVEL_BODY_GET_BOOL_AT(level_is_gas_explosion_blocker_at, is_gas_explosion_blocker)
...
LEVEL_BODY_GET_BOOL_AT(level_is_immune_to_holy_damage_at, is_immune_to_holy_damage)
LEVEL_BODY_GET_BOOL_AT(level_is_immune_to_magic_drain_at, is_immune_to_magic_drain)
...
LEVEL_BODY_GET_BOOL_AT(level_is_immune_to_stamina_drain_at, is_immune_to_stamina_drain)
...
LEVEL_BODY_GET_BOOL_AT(level_is_item_targeted_at, is_item_targeted)
...
LEVEL_BODY_GET_BOOL_AT(level_is_obs_shoving_at, is_obs_shoving)
LEVEL_BODY_GET_BOOL_AT(level_is_obs_spawn_at, is_obs_spawn)
LEVEL_BODY_GET_BOOL_AT(level_is_obs_spawn_monst_at, is_obs_spawn_monst)
LEVEL_BODY_GET_BOOL_AT(level_is_obs_spell_casting_at, is_obs_spell_casting)
LEVEL_BODY_GET_BOOL_AT(level_is_obs_throwing_at, is_obs_throwing)
...
LEVEL_BODY_GET_BOOL_AT(level_is_on_want_to_shoot_at, is_on_fire)
LEVEL_BODY_GET_BOOL_AT(level_is_ooze_at, is_ooze)
...
LEVEL_BODY_GET_BOOL_AT(level_is_portal_at, is_portal)
...
LEVEL_BODY_GET_BOOL_AT(level_is_spectral_blade_at, is_spectral_blade)
LEVEL_BODY_GET_BOOL_AT(level_is_spell_at, is_spell)
LEVEL_BODY_GET_BOOL_AT(level_is_spell_of_holding_at, is_spell_of_holding)
LEVEL_BODY_GET_BOOL_AT(level_is_spell_of_sanctuary_at, is_spell_of_sanctuary)
LEVEL_BODY_GET_BOOL_AT(level_is_spellbook_at, is_spellbook)
...
LEVEL_BODY_GET_BOOL_AT(level_is_trap_at, is_trap)
