...
LEVEL_BODY_GET_BOOL_AT(level_distance_jump_at, distance_jump)
...
LEVEL_BODY_GET_BOOL_AT(level_is_follower_at, is_follower)
LEVEL_BODY_GET_BOOL_AT(level_distance_leader_max_at, distance_leader_max)
LEVEL_BODY_GET_BOOL_AT(level_distance_minion_vision_shared_at, distance_minion_vision_shared)
