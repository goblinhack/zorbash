...
LEVEL_BODY_GET_BOOL_AT(level_distance_teleport_at, distance_teleport_get)
...
LEVEL_BODY_GET_BOOL_AT(level_gfx_wobbles_when_hit_at, gfx_wobbles_when_hit)
...
LEVEL_BODY_GET_BOOL_AT(level_is_very_is_combustible_at, is_very_is_combustible)
...
LEVEL_BODY_GET_BOOL_AT(level_stamina_drain_on_swinging, stamina_drain_on_swinging)
