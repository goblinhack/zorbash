...
LEVEL_BODY_GET_BOOL_AT(level_is_noise_blocker_at, is_noise_blocker)
...
LEVEL_BODY_GET_BOOL_AT(level_noise_decibels_at, noise_decibels)
...
LEVEL_BODY_GET_BOOL_AT(level_is_noise_level_able_to_hear_at, is_noise_level_able_to_hear)
