...
LEVEL_BODY_GET_BOOL_AT(level_is_key_collector_at, is_key_collector)
...
LEVEL_BODY_GET_BOOL_AT(level_is_treasure_type_collector_at, is_treasure_type_collector)
