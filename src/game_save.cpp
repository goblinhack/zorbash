...
{_
    ...
    /* point        level_changed_at          */ out << bits(my.t->level_changed_at);
...
{_
    ...
    /* std::array<std::array<bool, MAP_HEIGHT>, MAP_WIDTH> _is_movement_blocking {}; */ out << bits(my.t->_is_movement_blocking);
