...
std::ostream &operator<<(std::ostream &out, Bits< ThingInfop & > const my)
{
  ...
  out << bits(my.t->stats08);
  out << bits(my.t->stats09);
  out << bits(my.t->stats10);
  out << bits(my.t->stats11);
...
std::ostream &operator<<(std::ostream &out, Bits< const Thingp & > const my)
{
  ...
  uint64_t bits64 = 0;
  int      shift  = 0;
  bits64 |= (my.t->has_ever_moved ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->has_laser ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->has_light ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->has_projectile ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_activated ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_attached ? 1LLU : 0LLU) << shift;
  shift++;
  ...
  shift++;
  bits64 |= (my.t->is_dead ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_dying ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_facing_left ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_fadeup ? 1LLU : 0LLU) << shift;
  shift++;
  ...
  shift++;
  bits64 |= (my.t->is_in_lava ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_in_water ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_jumping ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_moving ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_offscreen ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_open ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_resurrected ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_resurrecting ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_resurrection_blocked ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_scheduled_for_death ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_scheduled_for_jump_end ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_sleeping ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_starving ? 1LLU : 0LLU) << shift;
  shift++;
  ...
  shift++;
  bits64 |= (my.t->is_waiting_to_descend_dungeon ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_waiting_to_descend_sewer ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->is_waiting_to_leave_level_has_completed_fall ? 1LLU : 0LLU) << shift;
  shift++;
  ...
  shift++;
  bits64 |= (my.t->i_set_is_ascend_dungeon ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_ascend_sewer ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_barrel ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_blood ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_brazier ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_bridge ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_chasm ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_corpse ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_corridor ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_deep_water ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_descend_dungeon ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_descend_sewer ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_dirt ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_door ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_dry_grass ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_enchantstone ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_cursor_path_hazard_for_player ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_heavy ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_fire ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_floor ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_foilage ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_food ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_gold ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_hazard ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_key ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_lava ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_light_blocker ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_minion_generator ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_monst ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_obs_wall_or_door ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_obs_destructable ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_poisonous_danger_level ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_necrotic_danger_level ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_potion ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_ripple ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_rock ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_secret_door ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_shallow_water ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_skillstone ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_smoke ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_spiderweb ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_sticky ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_shovable ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_treasure_class_a ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_treasure_class_b ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_treasure_class_c ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_treasure_type ? 1LLU : 0LLU) << shift;
  shift++;
  bits64 |= (my.t->i_set_is_wall ? 1LLU : 0LLU) << shift;
  shift++;
...
std::ostream &operator<<(std::ostream &out, Bits< Levelp & > const my)
{
  ...
  out << bits(my.t->_is_treasure_class_a);
  out << bits(my.t->_is_treasure_class_b);
  out << bits(my.t->_is_treasure_class_c);
...
std::ostream &operator<<(std::ostream &out, Bits< const Config & > const my)
{
  ...
  out << bits(my.t.ui_pix_scale_height);
  out << bits(my.t.ui_pix_scale_width);
