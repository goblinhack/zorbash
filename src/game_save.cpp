...
{_
    ...
    /////////////////////////////////////////////////////////////////////////
    /* ThingId     */ out << bits(my.t->on_fire_id_anim);
    /* ThingId     */ out << bits(my.t->owner_id);
    /* ThingId     */ out << bits(my.t->weapon_id);
    /* ThingId     */ out << bits(my.t->weapon_id_carry_anim);
    /* ThingId     */ out << bits(my.t->weapon_id_use_anim);
    ...
    /* std::list<ThingId>   */ out << bits(my.t->carrying);
    /* std::string          */ out << bits(my.t->msg);
    /* std::vector<ThingId> */ out << bits(my.t->actionbar_id);
    /* std::vector<ThingId> */ out << bits(my.t->enemies);
    ...
    /* uint32_t    */ out << bits(my.t->tick_last_did_something);
    /* uint32_t    */ out << bits(my.t->tick_last_escape);
    /////////////////////////////////////////////////////////////////////////
    // ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^
    // | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
    //
...
{_
    ...
    /* uint32_t           key_unused10                 */ out << bits(my.t.key_unused10                 );
    /* uint32_t           key_unused11                 */ out << bits(my.t.key_unused11                 );
    /* uint32_t           key_unused12                 */ out << bits(my.t.key_unused12                 );
    /* uint32_t           key_unused13                 */ out << bits(my.t.key_unused13                 );
    /* uint32_t           key_unused14                 */ out << bits(my.t.key_unused14                 );
    /* uint32_t           key_unused15                 */ out << bits(my.t.key_unused15                 );
    /* uint32_t           key_unused16                 */ out << bits(my.t.key_unused16                 );
    /* uint32_t           key_unused17                 */ out << bits(my.t.key_unused17                 );
