...
{_
    ...
    /* int          stats_constitution                   */ out << bits(my.t->stats_constitution);
    /* int          stats_attack                   */ out << bits(my.t->stats_attack);
    /* int          stats17                   */ out << bits(my.t->stats17);
    /* int          stats_throw_distance      */ out << bits(my.t->stats_throw_distance);
