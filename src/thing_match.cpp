...
bool Thing::matches(const std::string &what)
{
  ...
  if (is_air_breathher() && (what == "is_air_breathher")) {
    return true;
  }
...
std::function< int(Thingp) > Thing::matches_to_func(const std::string &what)
{
  ...
  if (what == "gfx_ascii_shown_in_bg") {
    return &Thing::gfx_ascii_shown_in_bg;
  }
  ...
  if (what == "is_air_breathher") {
    return &Thing::is_air_breathher;
  }
