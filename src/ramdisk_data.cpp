...
{
  {
    extern unsigned char             *data_font_large_tga_start_ asm("data_font_large_tga_start_");
    extern unsigned char             *data_font_large_tga_end_ asm("data_font_large_tga_end_");
    static const unsigned char *const start = (const unsigned char *const) (char *) &data_font_large_tga_start_;
    static const unsigned char *const end   = (const unsigned char *const) (char *) &data_font_large_tga_end_;
    ramdisk_t                         r;
    r.data                                      = start;
    r.len                                       = end - start;
    ramdisk_data[ "data/fonts/font-large.tga" ] = r;
  }

  {
    extern unsigned char             *data_font_small_tga_start_ asm("data_font_small_tga_start_");
    extern unsigned char             *data_font_small_tga_end_ asm("data_font_small_tga_end_");
    static const unsigned char *const start = (const unsigned char *const) (char *) &data_font_small_tga_start_;
    static const unsigned char *const end   = (const unsigned char *const) (char *) &data_font_small_tga_end_;
    ramdisk_t                         r;
    r.data                                      = start;
    r.len                                       = end - start;
    ramdisk_data[ "data/fonts/font-small.tga" ] = r;
  }
  ...
  {
    extern unsigned char             *data_ui_inventory_tga_start_ asm("data_ui_inventory_tga_start_");
    extern unsigned char             *data_ui_inventory_tga_end_ asm("data_ui_inventory_tga_end_");
    static const unsigned char *const start = (const unsigned char *const) (char *) &data_ui_inventory_tga_start_;
    static const unsigned char *const end   = (const unsigned char *const) (char *) &data_ui_inventory_tga_end_;
    ramdisk_t                         r;
    r.data                                      = start;
    r.len                                       = end - start;
  ...
  {
    extern unsigned char             *data_ui_tabs_tga_start_ asm("data_ui_tabs_tga_start_");
    extern unsigned char             *data_ui_tabs_tga_end_ asm("data_ui_tabs_tga_end_");
    static const unsigned char *const start = (const unsigned char *const) (char *) &data_ui_tabs_tga_start_;
    static const unsigned char *const end   = (const unsigned char *const) (char *) &data_ui_tabs_tga_end_;
    ramdisk_t                         r;
    r.data                                 = start;
    r.len                                  = end - start;
  ...
  {
    extern unsigned char             *data_DST_PhaserSwitch_ogg_start_ asm("data_DST_PhaserSwitch_ogg_start_");
    extern unsigned char             *data_DST_PhaserSwitch_ogg_end_ asm("data_DST_PhaserSwitch_ogg_end_");
    static const unsigned char *const start = (const unsigned char *const) (char *) &data_DST_PhaserSwitch_ogg_start_;
    static const unsigned char *const end   = (const unsigned char *const) (char *) &data_DST_PhaserSwitch_ogg_end_;
    ramdisk_t                         r;
    r.data                                            = start;
    r.len                                             = end - start;
    ramdisk_data[ "data/music/DST-PhaserSwitch.ogg" ] = r;
  }
  ...
  {
    extern unsigned char *data_23733__tim_kahn__squeakyrat_wav_start_ asm(
        "data_23733__tim_kahn__squeakyrat_wav_start_");
  ...
  {
    extern unsigned char *data_434462__dersuperanton__getting_hit_hugh_wav_start_ asm(
        "data_434462__dersuperanton__getting_hit_hugh_wav_start_");
    extern unsigned char *data_434462__dersuperanton__getting_hit_hugh_wav_end_ asm(
        "data_434462__dersuperanton__getting_hit_hugh_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_437650__dersuperanton__getting_hit_damage_scream_wav_start_ asm(
        "data_437650__dersuperanton__getting_hit_damage_scream_wav_start_");
    extern unsigned char *data_437650__dersuperanton__getting_hit_damage_scream_wav_end_ asm(
        "data_437650__dersuperanton__getting_hit_damage_scream_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_437653__dersuperanton__moan_male_beat_punch_wav_start_ asm(
        "data_437653__dersuperanton__moan_male_beat_punch_wav_start_");
    extern unsigned char *data_437653__dersuperanton__moan_male_beat_punch_wav_end_ asm(
        "data_437653__dersuperanton__moan_male_beat_punch_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_443293__deathscyp__wood_break_wav_start_ asm(
        "data_443293__deathscyp__wood_break_wav_start_");
    extern unsigned char *data_443293__deathscyp__wood_break_wav_end_ asm(
        "data_443293__deathscyp__wood_break_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_268227__xxchr0nosxx__swing_wav_start_ asm(
        "data_268227__xxchr0nosxx__swing_wav_start_");
  ...
  {
    extern unsigned char *data_59992__qubodup__swosh_sword_swing_wav_start_ asm(
        "data_59992__qubodup__swosh_sword_swing_wav_start_");
    extern unsigned char *data_59992__qubodup__swosh_sword_swing_wav_end_ asm(
        "data_59992__qubodup__swosh_sword_swing_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_82388__robinhood76__01308_man_hit_9_wav_start_ asm(
        "data_82388__robinhood76__01308_man_hit_9_wav_start_");
    extern unsigned char *data_82388__robinhood76__01308_man_hit_9_wav_end_ asm(
        "data_82388__robinhood76__01308_man_hit_9_wav_end_");
    static const unsigned char *const start =
  ...
  {
    extern unsigned char *data_404109__deathscyp__damage_1_wav_start_ asm(
        "data_404109__deathscyp__damage_1_wav_start_");
  ...
  {
    extern unsigned char *data_554153__danielvj__door_open_wav_start_ asm(
        "data_554153__danielvj__door_open_wav_start_");
  ...
  {
    extern unsigned char *data_507466__danjocross__clean_fast_swoosh_wav_start_ asm(
        "data_507466__danjocross__clean_fast_swoosh_wav_start_");
    extern unsigned char *data_507466__danjocross__clean_fast_swoosh_wav_end_ asm(
        "data_507466__danjocross__clean_fast_swoosh_wav_end_");
    static const unsigned char *const start =
