...
void ramdisk_init (void)
{
    ...
    {
        extern unsigned char *data_tiles1_dungeon_tga_start_ asm("data_tiles1_dungeon_tga_start_");
        extern unsigned char *data_tiles1_dungeon_tga_end_ asm("data_tiles1_dungeon_tga_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data_tiles1_dungeon_tga_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data_tiles1_dungeon_tga_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
        ramdisk_data["data/gfx/tiles1_dungeon.tga"] = r;
    }
