...
void ramdisk_init (void)
{
    ...
    {
        extern unsigned char *data_laser_lightning_tga_start_ asm("data_laser_lightning_tga_start_");
        extern unsigned char *data_laser_lightning_tga_end_ asm("data_laser_lightning_tga_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data_laser_lightning_tga_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data_laser_lightning_tga_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___special_b_wav_start_ asm("data___special_b_wav_start_");
        extern unsigned char *data___special_b_wav_end_ asm("data___special_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___special_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___special_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___special_a_wav_start_ asm("data___special_a_wav_start_");
        extern unsigned char *data___special_a_wav_end_ asm("data___special_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___special_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___special_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___disarm_single_wav_start_ asm("data___disarm_single_wav_start_");
        extern unsigned char *data___disarm_single_wav_end_ asm("data___disarm_single_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___disarm_single_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___disarm_single_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___disarm_success_wav_start_ asm("data___disarm_success_wav_start_");
        extern unsigned char *data___disarm_success_wav_end_ asm("data___disarm_success_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___disarm_success_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___disarm_success_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___attack_a_wav_start_ asm("data___attack_a_wav_start_");
        extern unsigned char *data___attack_a_wav_end_ asm("data___attack_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___attack_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___attack_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___summon_wav_start_ asm("data___summon_wav_start_");
        extern unsigned char *data___summon_wav_end_ asm("data___summon_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___summon_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___summon_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___disarm_multi_a_wav_start_ asm("data___disarm_multi_a_wav_start_");
        extern unsigned char *data___disarm_multi_a_wav_end_ asm("data___disarm_multi_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___disarm_multi_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___disarm_multi_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___spell_b_wav_start_ asm("data___spell_b_wav_start_");
        extern unsigned char *data___spell_b_wav_end_ asm("data___spell_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___spell_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___spell_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___shoot_b_wav_start_ asm("data___shoot_b_wav_start_");
        extern unsigned char *data___shoot_b_wav_end_ asm("data___shoot_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___shoot_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___shoot_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___woosh_b_wav_start_ asm("data___woosh_b_wav_start_");
        extern unsigned char *data___woosh_b_wav_end_ asm("data___woosh_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___woosh_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___woosh_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___lightning_b_wav_start_ asm("data___lightning_b_wav_start_");
        extern unsigned char *data___lightning_b_wav_end_ asm("data___lightning_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___lightning_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___lightning_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___lightning_a_wav_start_ asm("data___lightning_a_wav_start_");
        extern unsigned char *data___lightning_a_wav_end_ asm("data___lightning_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___lightning_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___lightning_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___telepathy_wav_start_ asm("data___telepathy_wav_start_");
        extern unsigned char *data___telepathy_wav_end_ asm("data___telepathy_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___telepathy_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___telepathy_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___reload_wav_start_ asm("data___reload_wav_start_");
        extern unsigned char *data___reload_wav_end_ asm("data___reload_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___reload_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___reload_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___heal_a_wav_start_ asm("data___heal_a_wav_start_");
        extern unsigned char *data___heal_a_wav_end_ asm("data___heal_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___heal_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___heal_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___laser_b_wav_start_ asm("data___laser_b_wav_start_");
        extern unsigned char *data___laser_b_wav_end_ asm("data___laser_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___laser_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___laser_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___spell_a_wav_start_ asm("data___spell_a_wav_start_");
        extern unsigned char *data___spell_a_wav_end_ asm("data___spell_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___spell_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___spell_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___fire_a_wav_start_ asm("data___fire_a_wav_start_");
        extern unsigned char *data___fire_a_wav_end_ asm("data___fire_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___fire_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___fire_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___blaster_wav_start_ asm("data___blaster_wav_start_");
        extern unsigned char *data___blaster_wav_end_ asm("data___blaster_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___blaster_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___blaster_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___teleport_wav_start_ asm("data___teleport_wav_start_");
        extern unsigned char *data___teleport_wav_end_ asm("data___teleport_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___teleport_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___teleport_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___disarm_multi_b_wav_start_ asm("data___disarm_multi_b_wav_start_");
        extern unsigned char *data___disarm_multi_b_wav_end_ asm("data___disarm_multi_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___disarm_multi_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___disarm_multi_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___attack_b_wav_start_ asm("data___attack_b_wav_start_");
        extern unsigned char *data___attack_b_wav_end_ asm("data___attack_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___attack_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___attack_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___bazooka_wav_start_ asm("data___bazooka_wav_start_");
        extern unsigned char *data___bazooka_wav_end_ asm("data___bazooka_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___bazooka_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___bazooka_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___swing_wav_start_ asm("data___swing_wav_start_");
        extern unsigned char *data___swing_wav_end_ asm("data___swing_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___swing_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___swing_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___jump_a_wav_start_ asm("data___jump_a_wav_start_");
        extern unsigned char *data___jump_a_wav_end_ asm("data___jump_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___jump_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___jump_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___jump_b_wav_start_ asm("data___jump_b_wav_start_");
        extern unsigned char *data___jump_b_wav_end_ asm("data___jump_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___jump_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___jump_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___shoot_a_wav_start_ asm("data___shoot_a_wav_start_");
        extern unsigned char *data___shoot_a_wav_end_ asm("data___shoot_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___shoot_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___shoot_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___woosh_a_wav_start_ asm("data___woosh_a_wav_start_");
        extern unsigned char *data___woosh_a_wav_end_ asm("data___woosh_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___woosh_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___woosh_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___sorcery_wav_start_ asm("data___sorcery_wav_start_");
        extern unsigned char *data___sorcery_wav_end_ asm("data___sorcery_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___sorcery_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___sorcery_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___shotgun_wav_start_ asm("data___shotgun_wav_start_");
        extern unsigned char *data___shotgun_wav_end_ asm("data___shotgun_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___shotgun_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___shotgun_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___laser_a_wav_start_ asm("data___laser_a_wav_start_");
        extern unsigned char *data___laser_a_wav_end_ asm("data___laser_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___laser_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___laser_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___heal_b_wav_start_ asm("data___heal_b_wav_start_");
        extern unsigned char *data___heal_b_wav_end_ asm("data___heal_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___heal_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___heal_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___fire_b_wav_start_ asm("data___fire_b_wav_start_");
        extern unsigned char *data___fire_b_wav_end_ asm("data___fire_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___fire_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___fire_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___fire_c_wav_start_ asm("data___fire_c_wav_start_");
        extern unsigned char *data___fire_c_wav_end_ asm("data___fire_c_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___fire_c_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___fire_c_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___snake_wav_start_ asm("data___snake_wav_start_");
        extern unsigned char *data___snake_wav_end_ asm("data___snake_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___snake_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___snake_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___wings_wav_start_ asm("data___wings_wav_start_");
        extern unsigned char *data___wings_wav_end_ asm("data___wings_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___wings_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___wings_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___skeleton_wav_start_ asm("data___skeleton_wav_start_");
        extern unsigned char *data___skeleton_wav_end_ asm("data___skeleton_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___skeleton_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___skeleton_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___beetle_wav_start_ asm("data___beetle_wav_start_");
        extern unsigned char *data___beetle_wav_end_ asm("data___beetle_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___beetle_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___beetle_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___76962__michel88__deaths_wav_start_ asm("data___76962__michel88__deaths_wav_start_");
        extern unsigned char *data___76962__michel88__deaths_wav_end_ asm("data___76962__michel88__deaths_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___76962__michel88__deaths_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___76962__michel88__deaths_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___frog_wav_start_ asm("data___frog_wav_start_");
        extern unsigned char *data___frog_wav_end_ asm("data___frog_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___frog_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___frog_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___bird_wav_start_ asm("data___bird_wav_start_");
        extern unsigned char *data___bird_wav_end_ asm("data___bird_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___bird_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___bird_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___swarm_wav_start_ asm("data___swarm_wav_start_");
        extern unsigned char *data___swarm_wav_end_ asm("data___swarm_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___swarm_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___swarm_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___claw_wav_start_ asm("data___claw_wav_start_");
        extern unsigned char *data___claw_wav_end_ asm("data___claw_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___claw_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___claw_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___mystical_wav_start_ asm("data___mystical_wav_start_");
        extern unsigned char *data___mystical_wav_end_ asm("data___mystical_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___mystical_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___mystical_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___mouse_wav_start_ asm("data___mouse_wav_start_");
        extern unsigned char *data___mouse_wav_end_ asm("data___mouse_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___mouse_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___mouse_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___jelly_wav_start_ asm("data___jelly_wav_start_");
        extern unsigned char *data___jelly_wav_end_ asm("data___jelly_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___jelly_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___jelly_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___magic_crumble_wav_start_ asm("data___magic_crumble_wav_start_");
        extern unsigned char *data___magic_crumble_wav_end_ asm("data___magic_crumble_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___magic_crumble_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___magic_crumble_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___spike_trap_b_wav_start_ asm("data___spike_trap_b_wav_start_");
        extern unsigned char *data___spike_trap_b_wav_end_ asm("data___spike_trap_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___spike_trap_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___spike_trap_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___explosion_c_wav_start_ asm("data___explosion_c_wav_start_");
        extern unsigned char *data___explosion_c_wav_end_ asm("data___explosion_c_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___explosion_c_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___explosion_c_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___impact_b_wav_start_ asm("data___impact_b_wav_start_");
        extern unsigned char *data___impact_b_wav_end_ asm("data___impact_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___impact_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___impact_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___boom_a_wav_start_ asm("data___boom_a_wav_start_");
        extern unsigned char *data___boom_a_wav_end_ asm("data___boom_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___boom_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___boom_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___magic_dust_a_wav_start_ asm("data___magic_dust_a_wav_start_");
        extern unsigned char *data___magic_dust_a_wav_end_ asm("data___magic_dust_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___magic_dust_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___magic_dust_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___spike_trap_a_wav_start_ asm("data___spike_trap_a_wav_start_");
        extern unsigned char *data___spike_trap_a_wav_end_ asm("data___spike_trap_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___spike_trap_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___spike_trap_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___437650__dersuperanton__getting_hit_damage_scream_wav_start_ asm("data___437650__dersuperanton__getting_hit_damage_scream_wav_start_");
        extern unsigned char *data___437650__dersuperanton__getting_hit_damage_scream_wav_end_ asm("data___437650__dersuperanton__getting_hit_damage_scream_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___437650__dersuperanton__getting_hit_damage_scream_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___437650__dersuperanton__getting_hit_damage_scream_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___pit_trap_damage_wav_start_ asm("data___pit_trap_damage_wav_start_");
        extern unsigned char *data___pit_trap_damage_wav_end_ asm("data___pit_trap_damage_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___pit_trap_damage_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___pit_trap_damage_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___explosion_b_wav_start_ asm("data___explosion_b_wav_start_");
        extern unsigned char *data___explosion_b_wav_end_ asm("data___explosion_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___explosion_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___explosion_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___area_effect_a_wav_start_ asm("data___area_effect_a_wav_start_");
        extern unsigned char *data___area_effect_a_wav_end_ asm("data___area_effect_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___area_effect_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___area_effect_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___impact_a_wav_start_ asm("data___impact_a_wav_start_");
        extern unsigned char *data___impact_a_wav_end_ asm("data___impact_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___impact_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___impact_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___434462__dersuperanton__getting_hit_hugh_wav_start_ asm("data___434462__dersuperanton__getting_hit_hugh_wav_start_");
        extern unsigned char *data___434462__dersuperanton__getting_hit_hugh_wav_end_ asm("data___434462__dersuperanton__getting_hit_hugh_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___434462__dersuperanton__getting_hit_hugh_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___434462__dersuperanton__getting_hit_hugh_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___pit_trap_fall_wav_start_ asm("data___pit_trap_fall_wav_start_");
        extern unsigned char *data___pit_trap_fall_wav_end_ asm("data___pit_trap_fall_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___pit_trap_fall_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___pit_trap_fall_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___sear_wav_start_ asm("data___sear_wav_start_");
        extern unsigned char *data___sear_wav_end_ asm("data___sear_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___sear_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___sear_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___area_effect_b_wav_start_ asm("data___area_effect_b_wav_start_");
        extern unsigned char *data___area_effect_b_wav_end_ asm("data___area_effect_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___area_effect_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___area_effect_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___hit_wav_start_ asm("data___hit_wav_start_");
        extern unsigned char *data___hit_wav_end_ asm("data___hit_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___hit_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___hit_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___explosion_a_wav_start_ asm("data___explosion_a_wav_start_");
        extern unsigned char *data___explosion_a_wav_end_ asm("data___explosion_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___explosion_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___explosion_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___boom_b_wav_start_ asm("data___boom_b_wav_start_");
        extern unsigned char *data___boom_b_wav_end_ asm("data___boom_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___boom_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___boom_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___404109__deathscyp__damage_1_wav_start_ asm("data___404109__deathscyp__damage_1_wav_start_");
        extern unsigned char *data___404109__deathscyp__damage_1_wav_end_ asm("data___404109__deathscyp__damage_1_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___404109__deathscyp__damage_1_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___404109__deathscyp__damage_1_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___443293__deathscyp__wood_break_wav_start_ asm("data___443293__deathscyp__wood_break_wav_start_");
        extern unsigned char *data___443293__deathscyp__wood_break_wav_end_ asm("data___443293__deathscyp__wood_break_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___443293__deathscyp__wood_break_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___443293__deathscyp__wood_break_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___magic_dust_b_wav_start_ asm("data___magic_dust_b_wav_start_");
        extern unsigned char *data___magic_dust_b_wav_end_ asm("data___magic_dust_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___magic_dust_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___magic_dust_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___click_wav_start_ asm("data___click_wav_start_");
        extern unsigned char *data___click_wav_end_ asm("data___click_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___click_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___click_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___error_wav_start_ asm("data___error_wav_start_");
        extern unsigned char *data___error_wav_end_ asm("data___error_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___error_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___error_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___lose_b_wav_start_ asm("data___lose_b_wav_start_");
        extern unsigned char *data___lose_b_wav_end_ asm("data___lose_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___lose_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___lose_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___select_a_wav_start_ asm("data___select_a_wav_start_");
        extern unsigned char *data___select_a_wav_end_ asm("data___select_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___select_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___select_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___score_wav_start_ asm("data___score_wav_start_");
        extern unsigned char *data___score_wav_end_ asm("data___score_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___score_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___score_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___1up_b_wav_start_ asm("data___1up_b_wav_start_");
        extern unsigned char *data___1up_b_wav_end_ asm("data___1up_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___1up_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___1up_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___coin_wav_start_ asm("data___coin_wav_start_");
        extern unsigned char *data___coin_wav_end_ asm("data___coin_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___coin_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___coin_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___dong_wav_start_ asm("data___dong_wav_start_");
        extern unsigned char *data___dong_wav_end_ asm("data___dong_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___dong_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___dong_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___select_b_wav_start_ asm("data___select_b_wav_start_");
        extern unsigned char *data___select_b_wav_end_ asm("data___select_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___select_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___select_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___click_long_wav_start_ asm("data___click_long_wav_start_");
        extern unsigned char *data___click_long_wav_end_ asm("data___click_long_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___click_long_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___click_long_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___ding_wav_start_ asm("data___ding_wav_start_");
        extern unsigned char *data___ding_wav_end_ asm("data___ding_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___ding_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___ding_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___level_up_wav_start_ asm("data___level_up_wav_start_");
        extern unsigned char *data___level_up_wav_end_ asm("data___level_up_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___level_up_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___level_up_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___paper_wav_start_ asm("data___paper_wav_start_");
        extern unsigned char *data___paper_wav_end_ asm("data___paper_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___paper_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___paper_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___1up_a_wav_start_ asm("data___1up_a_wav_start_");
        extern unsigned char *data___1up_a_wav_end_ asm("data___1up_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___1up_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___1up_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___blip_wav_start_ asm("data___blip_wav_start_");
        extern unsigned char *data___blip_wav_end_ asm("data___blip_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___blip_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___blip_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___bonus_wav_start_ asm("data___bonus_wav_start_");
        extern unsigned char *data___bonus_wav_end_ asm("data___bonus_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___bonus_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___bonus_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___end_turn_wav_start_ asm("data___end_turn_wav_start_");
        extern unsigned char *data___end_turn_wav_end_ asm("data___end_turn_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___end_turn_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___end_turn_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___lose_a_wav_start_ asm("data___lose_a_wav_start_");
        extern unsigned char *data___lose_a_wav_end_ asm("data___lose_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___lose_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___lose_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___new_turn_wav_start_ asm("data___new_turn_wav_start_");
        extern unsigned char *data___new_turn_wav_end_ asm("data___new_turn_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___new_turn_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___new_turn_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___gold_wav_start_ asm("data___gold_wav_start_");
        extern unsigned char *data___gold_wav_end_ asm("data___gold_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___gold_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___gold_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___mushroom_wav_start_ asm("data___mushroom_wav_start_");
        extern unsigned char *data___mushroom_wav_end_ asm("data___mushroom_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___mushroom_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___mushroom_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___transistor_wav_start_ asm("data___transistor_wav_start_");
        extern unsigned char *data___transistor_wav_end_ asm("data___transistor_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___transistor_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___transistor_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___close_shut_wav_start_ asm("data___close_shut_wav_start_");
        extern unsigned char *data___close_shut_wav_end_ asm("data___close_shut_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___close_shut_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___close_shut_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___close_wav_start_ asm("data___close_wav_start_");
        extern unsigned char *data___close_wav_end_ asm("data___close_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___close_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___close_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___fall_wav_start_ asm("data___fall_wav_start_");
        extern unsigned char *data___fall_wav_end_ asm("data___fall_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___fall_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___fall_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___step_wav_start_ asm("data___step_wav_start_");
        extern unsigned char *data___step_wav_end_ asm("data___step_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___step_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___step_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___collect_a_wav_start_ asm("data___collect_a_wav_start_");
        extern unsigned char *data___collect_a_wav_end_ asm("data___collect_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___collect_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___collect_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___drip_wav_start_ asm("data___drip_wav_start_");
        extern unsigned char *data___drip_wav_end_ asm("data___drip_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___drip_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___drip_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___collect_b_wav_start_ asm("data___collect_b_wav_start_");
        extern unsigned char *data___collect_b_wav_end_ asm("data___collect_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___collect_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___collect_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___whistle_wav_start_ asm("data___whistle_wav_start_");
        extern unsigned char *data___whistle_wav_end_ asm("data___whistle_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___whistle_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___whistle_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___shriek_wav_start_ asm("data___shriek_wav_start_");
        extern unsigned char *data___shriek_wav_end_ asm("data___shriek_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___shriek_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___shriek_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___open_wav_start_ asm("data___open_wav_start_");
        extern unsigned char *data___open_wav_end_ asm("data___open_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___open_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___open_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___rebound_wav_start_ asm("data___rebound_wav_start_");
        extern unsigned char *data___rebound_wav_end_ asm("data___rebound_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___rebound_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___rebound_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___chime_wav_start_ asm("data___chime_wav_start_");
        extern unsigned char *data___chime_wav_end_ asm("data___chime_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___chime_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___chime_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___blurb_wav_start_ asm("data___blurb_wav_start_");
        extern unsigned char *data___blurb_wav_end_ asm("data___blurb_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___blurb_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___blurb_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___scatter_wav_start_ asm("data___scatter_wav_start_");
        extern unsigned char *data___scatter_wav_end_ asm("data___scatter_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___scatter_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___scatter_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___twing_wav_start_ asm("data___twing_wav_start_");
        extern unsigned char *data___twing_wav_end_ asm("data___twing_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___twing_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___twing_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___zong_wav_start_ asm("data___zong_wav_start_");
        extern unsigned char *data___zong_wav_end_ asm("data___zong_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___zong_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___zong_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___wiggle_b_wav_start_ asm("data___wiggle_b_wav_start_");
        extern unsigned char *data___wiggle_b_wav_end_ asm("data___wiggle_b_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___wiggle_b_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___wiggle_b_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___unlock_wav_start_ asm("data___unlock_wav_start_");
        extern unsigned char *data___unlock_wav_end_ asm("data___unlock_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___unlock_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___unlock_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___bay_door_open_wav_start_ asm("data___bay_door_open_wav_start_");
        extern unsigned char *data___bay_door_open_wav_end_ asm("data___bay_door_open_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___bay_door_open_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___bay_door_open_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___rubberband_wav_start_ asm("data___rubberband_wav_start_");
        extern unsigned char *data___rubberband_wav_end_ asm("data___rubberband_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___rubberband_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___rubberband_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___resurrect_wav_start_ asm("data___resurrect_wav_start_");
        extern unsigned char *data___resurrect_wav_end_ asm("data___resurrect_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___resurrect_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___resurrect_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___swerve_wav_start_ asm("data___swerve_wav_start_");
        extern unsigned char *data___swerve_wav_end_ asm("data___swerve_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___swerve_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___swerve_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___wave_wav_start_ asm("data___wave_wav_start_");
        extern unsigned char *data___wave_wav_end_ asm("data___wave_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___wave_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___wave_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___clack_wav_start_ asm("data___clack_wav_start_");
        extern unsigned char *data___clack_wav_end_ asm("data___clack_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___clack_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___clack_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___wiggle_a_wav_start_ asm("data___wiggle_a_wav_start_");
        extern unsigned char *data___wiggle_a_wav_end_ asm("data___wiggle_a_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___wiggle_a_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___wiggle_a_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___shut_wav_start_ asm("data___shut_wav_start_");
        extern unsigned char *data___shut_wav_end_ asm("data___shut_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___shut_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___shut_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___scramble_wav_start_ asm("data___scramble_wav_start_");
        extern unsigned char *data___scramble_wav_end_ asm("data___scramble_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___scramble_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___scramble_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___bay_door_close_wav_start_ asm("data___bay_door_close_wav_start_");
        extern unsigned char *data___bay_door_close_wav_end_ asm("data___bay_door_close_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___bay_door_close_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___bay_door_close_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___ping_wav_start_ asm("data___ping_wav_start_");
        extern unsigned char *data___ping_wav_end_ asm("data___ping_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___ping_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___ping_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___burn_wav_start_ asm("data___burn_wav_start_");
        extern unsigned char *data___burn_wav_end_ asm("data___burn_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___burn_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___burn_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___curse_wav_start_ asm("data___curse_wav_start_");
        extern unsigned char *data___curse_wav_end_ asm("data___curse_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___curse_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___curse_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___poison_wav_start_ asm("data___poison_wav_start_");
        extern unsigned char *data___poison_wav_end_ asm("data___poison_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___poison_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___poison_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___confuse_wav_start_ asm("data___confuse_wav_start_");
        extern unsigned char *data___confuse_wav_end_ asm("data___confuse_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___confuse_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___confuse_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___freeze_wav_start_ asm("data___freeze_wav_start_");
        extern unsigned char *data___freeze_wav_end_ asm("data___freeze_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___freeze_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___freeze_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___charm_wav_start_ asm("data___charm_wav_start_");
        extern unsigned char *data___charm_wav_end_ asm("data___charm_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___charm_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___charm_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___disease_wav_start_ asm("data___disease_wav_start_");
        extern unsigned char *data___disease_wav_end_ asm("data___disease_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___disease_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___disease_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
    ...
    {
        extern unsigned char *data___mutation_wav_start_ asm("data___mutation_wav_start_");
        extern unsigned char *data___mutation_wav_end_ asm("data___mutation_wav_end_");
        static const unsigned char *const start = (const unsigned char *const) (char*)&data___mutation_wav_start_;
        static const unsigned char *const end   = (const unsigned char *const) (char*)&data___mutation_wav_end_;
        ramdisk_t r;
        r.data = start;
        r.len = end - start;
