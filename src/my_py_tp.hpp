...
TP_SET_PROTO(on_owner_poison_damage_do)
TP_SET_PROTO(on_owner_constitution_damage_do)
TP_SET_PROTO(on_owner_strength_damage_do)
TP_SET_PROTO(on_owner_melee_damage_do)
TP_SET_PROTO(on_owner_necrosis_damage_do)
TP_SET_PROTO(on_owner_bite_damage_do)
