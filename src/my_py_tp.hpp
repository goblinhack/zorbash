...
TP_SET_PROTO(damage_environment_doubled_from_acid)
TP_SET_PROTO(damage_environment_doubled_from_fire)
TP_SET_PROTO(damage_environment_doubled_from_poison)
TP_SET_PROTO(damage_environment_doubled_from_water)
