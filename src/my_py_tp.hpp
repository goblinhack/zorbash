...
TP_SET_PROTO(is_bodypart_eyes)
TP_SET_PROTO(is_bodypart_face)
TP_SET_PROTO(is_bodypart_hair)
TP_SET_PROTO(is_bodypart_hat)
TP_SET_PROTO(is_bodypart_legs)
TP_SET_PROTO(is_bodypart_torso)
