...
TP_SET_PROTO(chance_d1000_is_able_to_grapple)
TP_SET_PROTO(chance_d1000_is_able_to_jump_attack)
TP_SET_PROTO(chance_d1000_is_able_to_jump_on_low_hp)
TP_SET_PROTO(chance_d1000_is_able_to_jump_onto)
TP_SET_PROTO(chance_d1000_is_able_to_jump_randomly)
TP_SET_PROTO(chance_d1000_is_able_to_shove)
TP_SET_PROTO(chance_d1000_is_able_to_teleport_attack)
TP_SET_PROTO(chance_d1000_is_steal_item)
TP_SET_PROTO(chance_d1000_melting)
TP_SET_PROTO(chance_d1000_set_on_fire)
