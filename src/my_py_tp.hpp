...
TP_SET_PROTO(gfx_ascii_color_spread_green)
TP_SET_PROTO(gfx_ascii_color_spread_red)
...
TP_SET_PROTO(gfx_ascii_color_spread_hue)
TP_SET_PROTO(gfx_ascii_color_spread_alpha)
TP_SET_PROTO(gfx_ascii_color_spread_blue)
