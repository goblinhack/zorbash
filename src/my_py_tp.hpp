...
TP_SET_PROTO(distance_cast_spell)
...
TP_SET_PROTO(is_able_to_cast_spells)
...
TP_SET_PROTO(is_immune_to_slow_spell)
TP_SET_PROTO(is_immune_to_spell_hold)
...
TP_SET_PROTO(is_spell_hold)
TP_SET_PROTO(is_spell_slowed)
