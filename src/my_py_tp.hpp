...
TP_SET_PROTO(damage_xxx1_chance_d1000)
TP_SET_PROTO(damage_xxx2_chance_d1000)
TP_SET_PROTO(damage_xxx3_chance_d1000)
TP_SET_PROTO(damage_xxx4_chance_d1000)
TP_SET_PROTO(damage_xxx5_chance_d1000)
TP_SET_PROTO(damage_xxx6_chance_d1000)
TP_SET_PROTO(damage_xxx7_chance_d1000)
TP_SET_PROTO(damage_xxx8_chance_d1000)
TP_SET_PROTO(damage_xxx9_chance_d1000)
TP_SET_PROTO(damage_xxx10_chance_d1000)
TP_SET_PROTO(damage_poison_dice)
TP_SET_PROTO(damage_xxx1_dice)
TP_SET_PROTO(damage_xxx2_dice)
TP_SET_PROTO(damage_xxx3_dice)
TP_SET_PROTO(damage_xxx4_dice)
TP_SET_PROTO(damage_xxx5_dice)
TP_SET_PROTO(damage_xxx6_dice)
TP_SET_PROTO(damage_xxx7_dice)
TP_SET_PROTO(damage_xxx8_dice)
TP_SET_PROTO(damage_xxx9_dice)
TP_SET_PROTO(damage_xxx10_dice)
...
TP_SET_PROTO(on_owner_damage_xxx1_do)
TP_SET_PROTO(on_owner_damage_xxx2_do)
TP_SET_PROTO(on_owner_damage_xxx3_do)
TP_SET_PROTO(on_owner_damage_xxx4_do)
TP_SET_PROTO(on_owner_damage_xxx5_do)
TP_SET_PROTO(on_owner_damage_xxx6_do)
TP_SET_PROTO(on_owner_damage_xxx7_do)
TP_SET_PROTO(on_owner_damage_xxx8_do)
TP_SET_PROTO(on_owner_damage_xxx9_do)
TP_SET_PROTO(on_owner_damage_xxx10_do)
