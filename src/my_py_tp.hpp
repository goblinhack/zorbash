...
TP_SET_PROTO(noise_on_jumping)
TP_SET_PROTO(noise_on_moving_or_being_carried)
...
TP_SET_PROTO(on_damage_stat_att_do)
...
TP_SET_PROTO(on_owner_damage_stat_att_do)
