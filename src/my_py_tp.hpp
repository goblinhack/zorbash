...
TP_SET_PROTO(damage_value_doubled_from_acid)
TP_SET_PROTO(damage_value_doubled_from_fire)
TP_SET_PROTO(damage_value_doubled_from_poison)
TP_SET_PROTO(damage_value_doubled_from_water)
