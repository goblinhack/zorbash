...
TP_SET_PROTO(chance_d10000_enchanted)
TP_SET_PROTO(chance_d10000_runic_class_A)
TP_SET_PROTO(chance_d10000_runic_class_B)
...
TP_SET_PROTO(dmg_chance_d1000_holy)
...
TP_SET_PROTO(dmg_holy_dice)
TP_SET_PROTO(dmg_impact_dice)
TP_SET_PROTO(dmg_lightning_dice)
TP_SET_PROTO(dmg_limited_per_tick)
...
TP_SET_PROTO(gfx_ascii_show_light_once_seen)
...
TP_SET_PROTO(is_able_to_fall_over)
...
TP_SET_PROTO(is_immune_to_holy_damage)
...
TP_SET_PROTO(is_immune_to_non_magical_weapons)
...
TP_SET_PROTO(is_runic_defensive_class_A)
TP_SET_PROTO(is_runic_defensive_class_B)
TP_SET_PROTO(is_runic_offensive_class_A)
TP_SET_PROTO(is_runic_offensive_class_B)
...
TP_SET_PROTO(is_tentacle_horror)
...
TP_SET_PROTO(is_vanquished_on_negation)
...
TP_SET_PROTO(on_attacking_dmg_holy_do)
...
TP_SET_PROTO(on_eaten_do)
TP_SET_PROTO(on_eating_do)
...
TP_SET_PROTO(on_owner_attack_dmg_holy_do)
...
TP_SET_PROTO(on_owner_rcv_dmg_holy_do)
...
TP_SET_PROTO(on_rcv_dmg_holy_do)
