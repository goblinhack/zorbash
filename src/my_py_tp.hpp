...
TP_SET_PROTO(noise_decibels_on_jumping)
TP_SET_PROTO(noise_decibels_on_born)
TP_SET_PROTO(noise_decibels_on_open)
TP_SET_PROTO(noise_decibels_on_you_are_hit_and_now_dead)
TP_SET_PROTO(noise_decibels_on_you_are_hit_but_still_alive)
...
TP_SET_PROTO(noise_decibels_on_moving_or_being_carried)
