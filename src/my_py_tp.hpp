...
TP_SET_PROTO(ai_is_able_to_shove)
TP_SET_PROTO(ai_shove_chance_d1000)
TP_SET_PROTO(ai_unprovoked_attack_chance_d1000)
...
TP_SET_PROTO(damage_swallow_dice)
TP_SET_PROTO(environ_damage_doubled_from_acid)
TP_SET_PROTO(environ_damage_doubled_from_fire)
TP_SET_PROTO(environ_damage_doubled_from_poison)
TP_SET_PROTO(environ_damage_doubled_from_water)
...
TP_SET_PROTO(ai_is_able_to_see_through_doors)
TP_SET_PROTO(ai_is_able_to_walk_through_walls)
TP_SET_PROTO(is_acid)
TP_SET_PROTO(environ_loves_acid)
...
TP_SET_PROTO(environ_loves_spiderwebs)
...
TP_SET_PROTO(ai_is_able_to_jump)
TP_SET_PROTO(ai_random_jump_chance_d1000)
TP_SET_PROTO(ai_is_able_to_jump_distance)
TP_SET_PROTO(ai_is_able_to_jump_on_low_hp_chance_d1000)
TP_SET_PROTO(is_key)
...
TP_SET_PROTO(environ_loves_poison)
...
TP_SET_PROTO(ai_aggression_level)
...
TP_SET_PROTO(ai_is_able_to_detect_secret_doors_when_close)
TP_SET_PROTO(ai_is_able_to_break_down_doors)
TP_SET_PROTO(ai_is_able_to_break_out_of_webs)
TP_SET_PROTO(ai_is_able_to_break_out_of_webs)
TP_SET_PROTO(ai_is_able_to_open_doors)
TP_SET_PROTO(ai_is_exit_finder)
TP_SET_PROTO(ai_is_level_explorer)
TP_SET_PROTO(is_rusty)
TP_SET_PROTO(ai_is_able_to_learn_skills)
TP_SET_PROTO(ai_is_able_to_enchant_weapons)
TP_SET_PROTO(ai_is_able_to_attack_generators)
...
TP_SET_PROTO(ai_is_able_to_collect_keys)
TP_SET_PROTO(ai_is_item_collector)
...
TP_SET_PROTO(environ_loves_fire)
TP_SET_PROTO(is_projectile)
...
TP_SET_PROTO(attack_poison_chance_d1000)
...
TP_SET_PROTO(is_ring)
TP_SET_PROTO(environ_loves_water)
...
TP_SET_PROTO(on_you_miss_do_do)
