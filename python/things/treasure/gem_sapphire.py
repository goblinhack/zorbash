...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(self, "1d150")
    ...
    my.tp_set_long_text_description(self, "Magnificent and blessed sapphire, in all its celestial hues. It is a stone of wisdom, prophecy and divine good portents. Putting all that aside, it's worth a few bob. Grab it!")
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_rarity(self, my.RARITY_UNCOMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Polished blue sapphire.")
