...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d75")
    ...
    my.tp_set_long_text_description(mytp, "A precious purple amethyst that glints in the dark. It's a bit of a safety hazard. Best pick it up.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Sparkling purple amethyst.")
