...
def tp_init(name, text_long_name):
    ...
    my.text_long_description(self, "A precious purple amethyst that glints in the dark. It's a bit of a safety hazard. Best pick it up.")
    my.text_short_description(self, "Sparkling purple amethyst.")
