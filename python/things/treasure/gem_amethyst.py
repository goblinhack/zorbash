...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(self, "1d75")
    ...
    my.tp_set_long_text_description(self, "A precious purple amethyst that glints in the dark. It's a bit of a safety hazard. Best pick it up.")
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Sparkling purple amethyst.")
