...
def tp_init(name, text_name):
    ...
    my.long_text_description(self, "A precious purple amethyst that glints in the dark. It's a bit of a safety hazard. Best pick it up.")
    my.normal_placement_rules(self, True)
    my.rarity(self, my.RARITY_COMMON)
    my.text_a_or_an(self, "a")
    my.text_description(self, "Sparkling purple amethyst.")
