...
def tp_init(name, text_long_name):
    ...
    my.text_description_long(self, "If you are need of luck, adventurine is the stone for you. It has a few drops of blood on it, ignore those. You will be more lucky.")
    my.text_description_short(self, "Some adventurine, the luckiest stone.")
