...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d50")
    ...
    my.tp_set_long_text_description(mytp, "If you are need of luck, adventurine is the stone for you. It has a few drops of blood on it, ignore those. You will be more lucky.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Some adventurine, the luckiest stone.")
