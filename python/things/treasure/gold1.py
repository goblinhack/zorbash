...
def gold_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(self, "1")
    ...
    my.tp_set_text_description(self, "A gold goin.")
    my.tp_set_z_depth(self, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(self, my.MAP_PRIO_BEHIND)

    my.tp_set_tile(self, tile=name + ".1", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".2", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".3", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".4", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".5", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".6", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".7", is_dir_none=True, delay_ms=50)
    my.tp_set_tile(self, tile=name + ".8", is_dir_none=True, delay_ms=50)
