...
def tp_init(name, text_name):
    ...
    my.tp_set_long_text_description(self, "A small leathery brown bag.")
    ...
    my.tp_set_text_description(self, "A small brown bag.")
    my.tp_set_z_depth(self, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(self, my.MAP_PRIO_BEHIND)

    my.tp_set_tile(self, tile="bag_s", delay_ms=1000)
    my.tp_update(self)
