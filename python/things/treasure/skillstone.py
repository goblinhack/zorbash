...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_is_skillstone(self, True)
    ...
    my.tp_set_long_text_description(self, "Use this magical stone to learn some new skills into your brain matter thing.")
    ...
    my.tp_set_text_description(self, "A glowing skillstone.")
