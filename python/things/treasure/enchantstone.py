...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_is_enchantstone(mytp, True)
    ...
    my.tp_set_long_text_description(mytp, "Use this magical stone to bestow powers on other items you carry.")
    ...
    my.tp_set_text_description(mytp, "A glowing enchantstone.")
