...
def gold_init(name, text_long_name, text_short_name):
    ...
    my.text_apostrophize(self, "gold coins'")
    my.text_description_long(self, "A handful of gold coins.")
    my.text_description_short(self, "A handful of gold coins.")
...
def init():
    gold_init(name="gold3",
            text_long_name="gold coins",
