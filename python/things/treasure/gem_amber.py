...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d30")
    ...
    my.tp_set_long_text_description(mytp, "A rough hunk of amber. Quite how it got here and from what tree it fell, no one knows.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Translucent amber, no flies in it.")
