...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d250")
    ...
    my.tp_set_long_text_description(mytp, "Blood red ruby. A bit too red if you ask me. Actually it looks wet and red. Anyway, best pick it up and clean it off.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_UNCOMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Blood-red ruby, but who's blood?")
