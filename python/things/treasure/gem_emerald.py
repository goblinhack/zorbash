...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(self, "1d200")
    ...
    my.tp_set_long_text_description(self, "The stone of loyalty. Can't be that loyal as someone left it lying here. Best to pick it up for safe keeping.")
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_rarity(self, my.RARITY_UNCOMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Grass green emerald.")
