...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d200")
    ...
    my.tp_set_long_text_description(mytp, "The stone of loyalty. Can't be that loyal as someone left it lying here. Best to pick it up for safe keeping.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_UNCOMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Grass green emerald.")
