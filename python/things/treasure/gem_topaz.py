...
def tp_init(name, text_name):
    ...
    my.tp_set_gold_value_dice(mytp, "1d100")
    ...
    my.tp_set_long_text_description(mytp, "Topaz is prized for its ability to help you make friends. Just what you need. There are some entrails left on this piece. Just wipe them off.")
    my.tp_set_normal_placement_rules(mytp, True)
    my.tp_set_rarity(mytp, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Clean cut topaz.")
    my.tp_set_z_depth(mytp, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(mytp, my.MAP_PRIO_BEHIND)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_none=True, delay_ms=2000)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_none=True, delay_ms=100)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_none=True, delay_ms=100)
