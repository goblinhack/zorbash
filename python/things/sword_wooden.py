...
def init_swing(name):
    ...
    x.set_text_description("Thy wooden mechanism of justice.")
...
def init_weapon(name, text_name, short_text_name):
    ...
    x.set_gfx_anim_attack("sword_wooden_swing")
    x.set_gfx_animated(True)
    x.set_gfx_animated_can_hflip(True)
    x.set_gfx_show_outlined(True)
    x.set_gfx_small_shadow_caster(True)
    ...
    x.set_on_use_do("sword_wooden.on_use()")
    x.set_text_a_or_an("a");
    x.set_text_description("Thy wooden means of justice.")
    x.set_weapon_carry_anim("sword_wooden_carry")
