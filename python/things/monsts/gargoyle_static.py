...
def tp_init(name, text_name):
    ...
    my.tp_set_gfx_health_bar_shown_when_awake_only(mytp, True)
    ...
    my.tp_set_is_debug_type(mytp, True)
    ...
    my.tp_set_long_text_description(mytp, "These monstrous creatures guard the dungeon from the likes of you. Gargoyles lurk amongst the ruins and delight in the art of surprise...")
    ...
    my.tp_set_on_awake_do(mytp, "me.on_awake()")
    ...
    delay = 10000
    my.tp_set_tile(mytp, "gargoyle.sleeping.1", is_sleeping=True, delay_ms=delay)
    my.tp_set_tile(mytp, "gargoyle.sleeping.2", is_sleeping=True, delay_ms=delay)
    delay = 300
    my.tp_set_tile(mytp, "gargoyle.1", delay_ms=delay)
    my.tp_set_tile(mytp, "gargoyle.2", delay_ms=delay)
    my.tp_set_tile(mytp, "gargoyle.3", delay_ms=delay)
    my.tp_set_tile(mytp, "gargoyle.dead", is_dead=True, delay_ms=delay)
