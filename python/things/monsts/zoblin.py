...
def tp_init(name, text_name):
    ...
    my.tp_set_long_text_description(mytp, "A once proud zorblin, this poor creature has been resurrected as a zombie!")
    ...
    my.tp_set_stat_dex(mytp, 8)
    my.tp_set_stat_luck(mytp, 10)
    my.tp_set_stat_str(mytp, 8)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "A staggering zorblin zombie, a zoblin!")
