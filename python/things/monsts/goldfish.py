...
def tp_init(name, text_long_name):
    ...
    my.damage_bite_chance_d1000(self, 0, 50)
    my.damage_bite_dice(self, "1d1+1")
    my.damage_nat_att_chance_d1000(self, 0, 100)
    my.damage_nat_att_dice(self, "1d1+2")
    ...
    my.text_long_description(self, "A tiny little goldfish.")
    my.text_short_description(self, "An goldfish.")
