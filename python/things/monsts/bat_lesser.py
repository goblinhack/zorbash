...
def tp_init(name, text_name):
    ...
    my.tp_set_aggression_level_pct(self, 10)
    ...
    my.tp_set_damage_natural_attack_type(self, "nibble")
    ...
    my.tp_set_health_initial_dice(self, "1d10")
    ...
    my.tp_set_long_text_description(self, "A snarling mass of flying cuteness. They don't see so well, so best to keep far away.")
