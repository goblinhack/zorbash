...
def tp_init(name, text_name):
    ...
    my.tp_set_damage_natural_dice(self, "1d8+2")
    my.tp_set_damage_poison_chance_d1000(self, 100)
    my.tp_set_damage_poison_dice(self, "2d8+1")
    ...
    my.tp_set_health_initial_dice(self, "2d12")
    ...
    my.tp_set_long_text_description(self, "A snarling mass of flying death. These creatures of the night tend to hang around the graves of the newly undead.")
    ...
    my.tp_set_text_description(self, "An enormous bat.")
