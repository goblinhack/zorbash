...
def tp_init(name, text_name):
    ...
    my.tp_set_health_initial_dice(self, "4")
    ...
    my.tp_set_long_text_description(self, "A collection of burning tortured bones, driven to wander the dungeon forever. Or at least until you release them. Such creatures abhor the cleansing powers of water.")
