...
def tp_init(name, text_name):
    ...
    my.damage_natural_attack_chance_d1000(self, 900)
    ...
    delay = 150
    my.tile(self, "spider_giant.1", delay_ms=delay)
    my.tile(self, "spider_giant.2", delay_ms=delay)
    my.tile(self, "spider_giant.3", delay_ms=delay)
    my.tile(self, "spider_giant.4", delay_ms=delay)
    my.tile(self, "spider_giant.5", delay_ms=delay)
    my.tile(self, "spider_giant.dead", is_dead=True, delay_ms=delay)
