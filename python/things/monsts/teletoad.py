...
def tp_init(name, text_name):
    ...
    my.is_able_to_teleport_attack_chance_d1000(self, 1000)
    ...
    my.long_text_description(self, "An oddly aggressive, shortsighted and intensely venomous toad with a knack for escaping delicate situations by teleporting. How a creature like this evolved is beyond me... Tastes awful on toast, probably due to its poison.")
