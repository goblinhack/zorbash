...
def tp_init(name, text_name):
    ...
    my.tp_set_long_text_description_extra(mytp, "This particular zorblin has risen through the ranks. As tough as stone nails in a stone coffin, this zorblin is not prepared to take any of your cheek.")
    ...
    my.tp_set_text_description(mytp, "A grizzled war-weary zorblin.")
