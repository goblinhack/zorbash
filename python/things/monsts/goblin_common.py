...
def tp_init(name, text_name):
    ...
    mytp.set_on_death_do("goblin_common.on_death()")
    mytp.set_on_death_drop_all_items(True)
    mytp.set_on_you_are_hit_but_still_alive_do("goblin_common.on_you_are_hit_but_still_alive()")
    mytp.set_on_you_bite_attack_do("goblin_common.on_you_bite_attack()")
    mytp.set_on_you_miss_do("goblin_common.on_you_miss_do()")
