...
def tp_init(name, text_name):
    ...
    my.tp_set_ai_resent_count(mytp, 3)
    ...
    my.tp_set_damage_natural_dice(mytp, "1")
    ...
    my.tp_set_is_able_to_jump_attack_chance_d1000(mytp, 20)
    ...
    my.tp_set_is_jelly_baby(mytp, True)
    ...
    my.tp_set_long_text_description(mytp, "Jelly jumpers are numerous, bouncy and lots of fun! They will eat almost anything, including their own. They have the annoying habit of jumping when threatened. This one is a baby jelly. It tends to avoid adults of its kind. So should you.")
    my.tp_set_monst_size(mytp, my.MONST_SIZE_TINY)
    ...
    my.tp_set_stat_def(mytp, 5)
    my.tp_set_stat_dex(mytp, 10)
    my.tp_set_stat_luck(mytp, 10)
    my.tp_set_stat_str(mytp, 5)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "A small pile of semi sentient jelly.")
