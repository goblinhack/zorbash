...
def tp_init(name, text_name):
    ...
    my.tp_set_damage_natural_dice(self, "1d5")
    ...
    my.tp_set_is_able_to_jump_attack_chance_d1000(self, 200)
    ...
    my.tp_set_is_able_to_jump_randomly_chance_d1000(self, 2)
    ...
    my.tp_set_is_jelly_parent(self, True)
    ...
    my.tp_set_long_text_description(self, "Jelly jumpers are numerous, bouncy and carnivorous. They will eat almost anything, including their own. They have the annoying habit of jumping when threatened and dividing when defeated . This is an adult. It will eat its own children!")
    ...
    my.tp_set_tile(self, tile=name + ".7.100", is_hp_100_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".8.100", is_hp_100_percent=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".5.75", is_hp_75_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".6.75", is_hp_75_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".7.75", is_hp_75_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".8.75", is_hp_75_percent=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".5.50", is_hp_50_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".6.50", is_hp_50_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".7.50", is_hp_50_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".8.50", is_hp_50_percent=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".5.25", is_hp_25_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".6.25", is_hp_25_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".7.25", is_hp_25_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".8.25", is_hp_25_percent=True, delay_ms=delay)
