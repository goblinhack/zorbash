...
def tp_init(name, text_name):
    ...
    my.tp_set_damage_natural_attack_type(mytp, "touch")
    my.tp_set_damage_natural_dice(mytp, "1d6+6")
    ...
    my.tp_set_gfx_anim_use(mytp, "scythe_swing")
    ...
    my.tp_set_health_initial_dice(mytp, "2d20+200")
    ...
    my.tp_set_long_text_description(mytp, "A lesser reaper. You cannot defeat what does not live!")
    ...
    my.tp_set_rarity(mytp, my.RARITY_VERY_RARE)
    my.tp_set_resurrect_dice(mytp, "1d10+30")
    my.tp_set_stat_con(mytp, 25)
    my.tp_set_stat_def(mytp, 25)
    my.tp_set_stat_dex(mytp, 10)
    my.tp_set_stat_luck(mytp, 10)
    my.tp_set_stat_str(mytp, 25)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "A lesser reaper. Death incarnate.")
