...
def tp_init(name, text_long_name):
    ...
    my.damage_bite_dice(self, "1d8")
    my.damage_nat_att_chance_d1000(self, 0, 900)
    my.damage_nat_att_dice(self, "1d10+3")
    ...
    my.text_long_description(self, "A delightfully pet giant pirhana. It has friends and they want to play.")
    my.text_short_description(self, "Giant pirhana.")
...
def init():
    tp_init(name="pirhana", text_long_name="giant pirhana")
