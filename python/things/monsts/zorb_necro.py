...
def tp_init(name, text_name):
    ...
    my.tp_set_long_text_description_extra(mytp, "This particular zorblin is learned in the dark arts. Withered of body, but sharp of mind, beware the abilities of this zorblin.")
    ...
    my.tp_set_text_description(mytp, "A master of the darkest arts.")
    my.tp_set_is_carrier_of_treasure_class_b(mytp, True)
    my.tp_set_is_monst_class_b(mytp, True)
    my.tp_set_is_biome_dungeon(mytp, True)
    my.tp_set_stat_str(mytp, 6)
    my.tp_set_distance_avoid(mytp, 5)
    my.tp_set_health_initial_dice(mytp, "2d3+4")
