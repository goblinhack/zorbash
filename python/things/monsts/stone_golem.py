...
def tp_init(name, text_name):
    ...
    my.long_text_description(self, "A hideous mass of animated and moss covered stone. Stone golems are immune to cold, poison, fire and stamina/draining attacks. Stone golems are also able to slowly recharge health. Makes an excellent patio ornament.")
