...
def tp_init(name, text_name):
    ...
    mytp.set_aggression_level_pct(10)
    ...
    mytp.set_distance_manifestor_max(12)
    ...
    mytp.set_on_you_are_hit_but_still_alive_do("bat_greater.on_you_are_hit_but_still_alive()")
    mytp.set_on_you_bite_attack_do("bat_greater.on_you_bite_attack()")
    mytp.set_on_you_miss_do("bat_greater.on_you_miss_do()")
