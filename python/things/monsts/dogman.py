...
def tp_init(name, text_name):
    ...
    my.tile(self, "dogman.sleeping.1", is_sleeping=True, delay_ms=delay)
    my.tile(self, "dogman.sleeping.2", is_sleeping=True, delay_ms=delay)
    my.tile(self, "dogman.dead.1", is_dead=True, delay_ms=delay)
    my.tile(self, "dogman.dead.2", is_dead=True, delay_ms=delay)
    my.tile(self, "dogman.dead.3", is_dead=True, delay_ms=delay, is_end_of_anim=True)
