...
def tp_init(name, text_name):
    ...
    my.tp_set_damage_natural_dice(self, "1d6")
    ...
    my.tp_set_long_text_description(self, "A monstrous skeleton. It towers above you. It seems unhappy. Quite what body this skeleton came from, you hope not to find out. Water and fire are your friends here with creatures like this. Watch, these can rise again!")
    ...
    my.tp_set_stat_str(self, 21)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "A monstrous skeleton, possibly unfriendly.")
    my.tp_set_text_hits(self, "claws")
    my.tp_set_z_depth(self, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(self, my.MAP_PRIO_NORMAL)

    delay = 200
    my.tp_set_tile(self, tile=name + ".1", is_dir_left=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_left=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_left=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_left=True, is_moving=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_up=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_up=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_up=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_up=True, is_moving=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_down=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_down=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_down=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_down=True, is_moving=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_right=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_right=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_right=True, is_moving=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_right=True, is_moving=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_left=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_left=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_left=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_left=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_up=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_up=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_up=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_up=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_down=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_down=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_down=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_down=True, delay_ms=delay)

    my.tp_set_tile(self, tile=name + ".1", is_dir_right=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".2", is_dir_right=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".3", is_dir_right=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4", is_dir_right=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".4.dead", is_dead=True, delay_ms=delay, is_end_of_anim=True)
