...
def tp_init(name, text_name):
    ...
    mytp.set_distance_manifestor_max(10)
    ...
    mytp.set_on_you_are_hit_but_still_alive_do("skeleton_minion.on_you_are_hit_but_still_alive()")
    mytp.set_on_you_bite_attack_do("skeleton_minion.on_you_bite_attack()")
    mytp.set_on_you_miss_do("skeleton_minion.on_you_miss_do()")
