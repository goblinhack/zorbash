...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("A slice of chef prepared salmon. No sign of the chef in sight. Might not be salmon. It's wriggling a bit.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("1d25")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=brown$Salmon.")
