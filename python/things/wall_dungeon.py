...
def init():
    ...
    tp_init(name="wall_dungeon.6",
            tiles=[       "wall_dungeon.6.1", "wall_dungeon.6.2", "wall_dungeon.6.3", "wall_dungeon.6.4",
                          "wall_dungeon.6.5", "wall_dungeon.6.6", "wall_dungeon.6.7", "wall_dungeon.6.8",
                          "wall_dungeon.6.9", "wall_dungeon.6.10", "wall_dungeon.6.11", "wall_dungeon.6.12",
                          "wall_dungeon.6.13", "wall_dungeon.6.14", "wall_dungeon.6.15", "wall_dungeon.6.16",
                          "wall_dungeon.6.17", "wall_dungeon.6.18", "wall_dungeon.6.19", ],
            left1_tiles=[ "wall_deco1.left.1", "wall_deco1.left.2",
                          "wall_deco1.left.3", "wall_deco1.left.4",
                          "wall_deco1.left.5", "wall_deco1.left.6", ],
            right1_tiles=["wall_deco1.right.1", "wall_deco1.right.2",
