...
def tp_init(name):
    ...
    mytp.set_tile(tile=name + ".2", delay_ms=50)
    mytp.set_tile(tile=name + ".3", delay_ms=50)
    mytp.set_tile(tile=name + ".4", delay_ms=50)
    mytp.set_tile(tile=name + ".5", delay_ms=50)
    mytp.set_tile(tile=name + ".6", delay_ms=50)
    mytp.set_tile(tile=name + ".7", delay_ms=50)
    mytp.set_tile(tile=name + ".8", delay_ms=50)
    mytp.set_tile(tile=name + ".9", delay_ms=50)
    mytp.set_tile(tile=name + ".10", delay_ms=50)
    mytp.set_tile(tile=name + ".11", delay_ms=50)
    mytp.set_tile(tile=name + ".12", delay_ms=50)
    mytp.set_tile(tile=name + ".13", delay_ms=50)
    mytp.set_tile(tile=name + ".14", delay_ms=50)
    mytp.set_tile(tile=name + ".15", delay_ms=50)
    mytp.set_tile(tile=name + ".16", delay_ms=50, is_end_of_anim = True, is_dead_on_end_of_anim=True)
