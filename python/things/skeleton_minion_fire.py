...
def tp_init(name, text_name):
    ...
    x.set_long_text_description("A collection of burning tortured bones, driven to wander the dungeon forever. Or at least until you release them. Such creatures abhor the cleansing powers of water.")
