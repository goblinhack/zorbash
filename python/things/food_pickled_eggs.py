...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("Pickled eggs. What kind of eggs? Don't ask.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("10+1d60")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=white$Pickled eggs.")
...
def init():
    tp_init(name="food_pickled_eggs", text_name="pickled eggs", short_text_name="pickled eggs")
