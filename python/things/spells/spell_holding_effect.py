...
def tp_init(name, text_long_name):
    ...
    my.is_spell_of_holding_effect(self, True)
    ...
    my.tile(self, ascii_fg_char="block", ascii_fg_col_name="cyan", ascii_fg_alpha=255,
            delay_ms=delay, tile="spell_of_holding_effect.1")
    my.tile(self, ascii_fg_char="block", ascii_fg_col_name="cyan", ascii_fg_alpha=255,
            delay_ms=delay, tile="spell_of_holding_effect.2")
    my.tile(self, ascii_fg_char="block", ascii_fg_col_name="cyan", ascii_fg_alpha=255,
            delay_ms=delay, tile="spell_of_holding_effect.3")
    my.tile(self, ascii_fg_char="block", ascii_fg_col_name="cyan", ascii_fg_alpha=200,
            delay_ms=delay, tile="spell_of_holding_effect.4")
    my.tile(self, ascii_fg_char="block", ascii_fg_col_name="cyan", ascii_fg_alpha=200,
            delay_ms=delay, tile="spell_of_holding_effect.1")
...
def init():
    tp_init(name="spell_of_holding_effect", text_long_name="spell hold barrier")
