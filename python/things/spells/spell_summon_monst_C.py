...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.spell_replaces(self, "spell_summon_monst_B")
    ...
    my.text_description_short(self, "Spell, summon monst C.")
    my.text_description_very_short(self, "SumMonstA")
    my.z_depth(self, my.MAP_DEPTH_OBJ)
    my.z_prio(self, my.MAP_Z_PRIO_BEHIND)
    # end sort marker

    my.tile(self, tile="spell_summon_monst_C")
    my.tile(self, tile="spell_summon_monst_C_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_summon_monst_C", text_long_name="summon monst C", text_short_name="summon monst C")
