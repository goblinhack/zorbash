...
def on_use(owner, item, target, x, y):
    ...
    my.place_at(target, "spell_of_sanctuary_barrier", x, y)
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.is_spell_of_sanctuary(self, True)
    ...
    my.text_description_short(self, "Spell of sanctuary.")
    my.text_description_very_short(self, "Holding")
    my.z_depth(self, my.MAP_DEPTH_OBJ)
    my.z_prio(self, my.MAP_Z_PRIO_BEHIND)
    # end sort marker

    my.tile(self, tile="spell_of_sanctuary")
    my.tile(self, tile="spell_of_sanctuary_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_of_sanctuary", text_long_name="sanctuary", text_short_name="sanctuary")
