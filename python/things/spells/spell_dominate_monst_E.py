...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.spell_replaces(self, "spell_dominate_monst_D")
    ...
    my.text_description_short(self, "Spell, dominate monst E.")
    my.text_description_very_short(self, "DomMonstA")
    my.z_depth(self, my.MAP_DEPTH_OBJ)
    my.z_prio(self, my.MAP_Z_PRIO_BEHIND)
    # end sort marker

    my.tile(self, tile="spell_dominate_monst_E")
    my.tile(self, tile="spell_dominate_monst_E_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_dominate_monst_E", text_long_name="dominate monst E", text_short_name="dominate monst E")
