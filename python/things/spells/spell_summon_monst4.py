...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.spell_replaces(self, "spell_summon_monst3")
    ...
    my.tile(self, tile="spell_summon_monst4")
    my.tile(self, tile="spell_summon_monst4_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_summon_monst4", text_long_name="summon monst IV", text_short_name="summon monst IV")
