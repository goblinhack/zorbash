...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.is_spell_of_beckoning(self, True)
    my.is_target_select(self, True)
    my.is_usable(self, True)
    my.on_use_do(self, "me.on_use()")
    my.range_max(self, 9)
    my.gfx_targeted_laser(self, "laser_magic")
    ...
    my.tile(self, tile="spell_of_beckoning")
    my.tile(self, tile="spell_of_beckoning_activated")
    my.tp_update(self)
