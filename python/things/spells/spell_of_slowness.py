...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.is_spell_of_slowness(self, True)
    ...
    my.tile(self, tile="spell_of_slowness")
    my.tile(self, tile="spell_of_slowness_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_of_slowness", text_long_name="slow", text_short_name="slow")
