...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.spell_replaces(self, "spell_summon_monst_C")
    ...
    my.text_description_short(self, "Spell, summon monst D.")
    my.text_description_very_short(self, "SumMonstD")
    my.z_depth(self, my.MAP_DEPTH_OBJ)
    my.z_prio(self, my.MAP_Z_PRIO_BEHIND)
    # end sort marker

    my.tile(self, tile="spell_summon_monst_D")
    my.tile(self, tile="spell_summon_monst_D_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_summon_monst_D", text_long_name="summon monst D", text_short_name="summon monst D")
