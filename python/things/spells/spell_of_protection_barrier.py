...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=255,
            delay_ms=delay, tile="spell_of_protection_barrier.1")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=200,
            delay_ms=delay, tile="spell_of_protection_barrier.2")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=200,
            delay_ms=delay, tile="spell_of_protection_barrier.3")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=150,
            delay_ms=delay, tile="spell_of_protection_barrier.4")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=150,
            delay_ms=delay, tile="spell_of_protection_barrier.1")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=100,
            delay_ms=delay, tile="spell_of_protection_barrier.2")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=100,
            delay_ms=delay, tile="spell_of_protection_barrier.3")
    my.tile(self, ascii_bg_char="block", ascii_bg_col_name="yellow", ascii_bg_alpha=50,
            delay_ms=delay, tile="spell_of_protection_barrier.4")
...
def init():
    tp_init(name="spell_of_protection_barrier", text_long_name="magic barrier", text_short_name="magic barrier")
