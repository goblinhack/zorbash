...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.is_spell_of_slowing(self, True)
    ...
    my.tile(self, tile="spell_of_slowing")
    my.tile(self, tile="spell_of_slowing_activated")
    my.tp_update(self)


def init():
    tp_init(name="spell_of_slowing", text_long_name="slow", text_short_name="slow")
