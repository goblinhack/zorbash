...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("A pot of golden spider honey. A rare variety. Tasty with a unique aftertaste of fly.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("10+1d30")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=yellow$Honey.")
