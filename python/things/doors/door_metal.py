...
def tp_init(name):
    ...
    my.tp_set_health_initial_dice(mytp, "5d20")
    ...
    my.tp_set_noise_on_you_are_hit_and_now_dead(mytp, 100)
    my.tp_set_noise_on_you_are_hit_but_still_alive(mytp, 100)
    ...
    my.tp_set_text_description(mytp, "A metal door that's not for opening.")
