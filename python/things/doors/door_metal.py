...
def tp_init(name):
    ...
    my.tp_set_health_initial_dice(self, "5d20")
    ...
    my.tp_set_noise_on_you_are_hit_and_now_dead(self, 100)
    my.tp_set_noise_on_you_are_hit_but_still_alive(self, 100)
    ...
    my.tp_set_text_description(self, "A metal door that's not for opening.")
