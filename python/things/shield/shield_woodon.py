...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_description_long(self, "Woodon shield. Yes. Woodon. This is a low quality shield sprayed with patented Woodon (tm), to give a nice woody sheen. Not to be confused with an actual wooden shield made of actual wood.")
