...
def init():
    init_swing(name="sword_short_rusty_swing")
    init_carry(name="sword_short_rusty_carry")
    init_weapon(name="sword_short_rusty", text_name="rusty short sword", short_text_name="rusty short sword")
