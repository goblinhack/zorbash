...
def tp_init(name, text_name, short_text_name):
    ...
    x.set_long_text_description("This most dangerous wand will transport you to the next level by the most efficacious means possible...")
    x.set_normal_placement_rules(True)
    x.set_on_use_do("wand_descent.on_use()")
    x.set_text_a_or_an("a");
    x.set_text_description("%%fg=cyan$A swirling milky blue wand of descent.")
...
def init():
    tp_init(name="wand_health", text_name="wand of descent", short_text_name="wand.descent")
