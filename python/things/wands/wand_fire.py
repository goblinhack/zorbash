...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "Discharges a powerful blast of fire upon an unwitting recipient...")
    ...
    my.tp_set_projectile_name(mytp, "projectile_fire")
    my.tp_set_range_max(mytp, 7)
    my.tp_set_temperature(mytp, 30)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "A wand of fire.")
