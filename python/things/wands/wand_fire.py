...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Discharges a powerful blast of fire upon an unwitting recipient...")
    ...
    my.tp_set_projectile_name(self, "projectile_fire")
    my.tp_set_range_max(self, 7)
    my.tp_set_temperature(self, 30)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "A wand of fire.")
