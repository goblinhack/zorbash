...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_damage_lightning_dice(mytp, "1d10+6")
    my.tp_set_equip_carry_anim(mytp, "wand_lightning_carry")
    ...
    my.tp_set_laser_name(mytp, "laser_light")
    my.tp_set_long_text_description(mytp, "This wand blasts a charge of lightning at its unwitting target. Be careful when standing in the same pool as your target... Also do not use in the bath.")
    ...
    my.tp_set_text_description(mytp, "A wand of lightning.")
