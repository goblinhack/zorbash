...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("A jug of apple cider.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("1d20")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=brown$A jug of apple cider. Made from juicy dungeon apples with a particular taste all of their own.")
