...
def on_enchant(me, x, y):
    ...
    if my.thing_is_player(owner):
        my.thing_topcon(me, "The fire cloak burns brighter.")
...
def on_waiting(me, x, y):
    ...
    if my.level_is_lava_at(owner, x, y):
        ...
        if my.thing_is_player(owner):
            my.thing_topcon(owner, "You wait inside the lava and feel invigoratied.")
        return True
    ...
    if my.level_is_fire_at(owner, x, y) or my.level_is_lava_at(owner, x, y):
        ...
        if my.thing_is_player(owner):
            my.thing_topcon(owner, "You wait inside the fire and feel invigorated.")
        return True
