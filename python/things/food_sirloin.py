...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("Sirloin steak. Jusy lying their in the dirt for who knows how long. But you'll still eat it right?")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("10+1d45")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=brown$Sirloin steak.")
