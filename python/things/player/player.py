...
def tp_init(name, text_name, short_text_name, title):
    ...
    my.tp_set_long_text_description(self, "You. A most noble adventurer of no particular race, gender or creed. Devoid of fear and stout of heart. Likes kittens.")
