...
def tp_init(name, text_name, short_text_name, title):
    ...
    my.tp_set_ai_shove_chance_d1000(self, 50)
    my.tp_set_ai_wanderer(self, True)
    my.tp_set_attack_undead(self, True)
    my.tp_set_capacity_height(self, 20)
    my.tp_set_capacity_width(self, 20)
    my.tp_set_collateral_damage_pct(self, 90)
    ...
    my.tp_set_damage_natural_dice(self, "1d6+1")
    my.tp_set_distance_avoid(self, 3)
    my.tp_set_distance_jump(self, 2)
    my.tp_set_distance_throw(self, 5)
    ...
    my.tp_set_health_initial_dice(self, "100")
    my.tp_set_health_starving_pct(self, 5)
    my.tp_set_hunger_clock_tick_frequency(self, 50)
    my.tp_set_hunger_health_pct(self, 5)
    ...
    my.tp_set_is_able_to_use_helmet(self, True)
    my.tp_set_is_able_to_use_rings(self, True)
    my.tp_set_is_able_to_use_shield(self, True)
    ...
    my.tp_set_is_exit_finder(self, True)
    ...
    my.tp_set_is_player(self, True)
    my.tp_set_is_red_blooded(self, True)
    my.tp_set_is_shovable(self, True)
    my.tp_set_is_tickable(self, True)
    my.tp_set_light_power(self, 10)
    my.tp_set_long_text_description(self, "Our most noble adventurer of no particular race or gender or creed. Devoid of fear and stout of heart. Likes kittens.")
    my.tp_set_monst_size(self, my.MONST_SIZE_NORMAL)
    my.tp_set_noise_decibels_hearing(self, 30)
    my.tp_set_noise_on_jumping(self, 20)
    my.tp_set_noise_on_moving_or_being_carried(self, 20)
    my.tp_set_on_born_do(self, "player.on_born()")
    my.tp_set_on_damage_acid_do(self, "player.on_damage_acid()")
    my.tp_set_on_damage_cold_do(self, "player.on_damage_cold()")
    my.tp_set_on_damage_crush_do(self, "player.on_damage_crush()")
    my.tp_set_on_damage_digest_do(self, "player.on_damage_digest()")
    my.tp_set_on_damage_energy_do(self, "player.on_damage_energy()")
    my.tp_set_on_damage_fire_do(self, "player.on_damage_fire()")
    my.tp_set_on_damage_future1_do(self, "player.on_damage_future1()")
    my.tp_set_on_damage_future2_do(self, "player.on_damage_future2()")
    my.tp_set_on_damage_future3_do(self, "player.on_damage_future3()")
    my.tp_set_on_damage_lightning_do(self, "player.on_damage_lightning()")
    my.tp_set_on_damage_melee_do(self, "player.on_damage_melee()")
    my.tp_set_on_damage_natural_attack_do(self, "player.on_damage_natural_attack()")
    my.tp_set_on_damage_necrosis_do(self, "player.on_damage_necrosis()")
    my.tp_set_on_damage_poison_do(self, "player.on_damage_poison()")
    my.tp_set_on_damage_stat_con_do(self, "player.on_damage_stat_con()")
    my.tp_set_on_damage_stat_str_do(self, "player.on_damage_stat_str()")
    my.tp_set_on_death_do(self, "player.on_death()")
    my.tp_set_on_move_do(self, "player.on_move()")
    my.tp_set_on_you_are_hit_but_still_alive_do(self, "player.on_you_are_hit_but_still_alive()")
    my.tp_set_on_you_natural_attack_do(self, "player.on_you_natural_attack()")
    ...
    my.tp_set_temperature_change_sensitive(self, True)
    my.tp_set_text_a_or_an(self, "the")
    my.tp_set_text_description(self, "Our most noble adventurer. Press 'h' for help.")
    my.tp_set_text_hits(self, "hits")
    my.tp_set_text_title(self, title)
    my.tp_set_z_depth(self, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(self, my.MAP_PRIO_NORMAL)

    delay = 900
    my.tp_set_tile(self, tile=name + ".1", is_dir_left=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_left=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_left=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_left=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_left=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_left=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_up=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_up=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_up=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_up=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_up=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_up=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_down=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_down=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_down=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_down=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_down=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_down=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_right=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_right=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_right=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_right=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_right=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_right=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_left=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_left=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_left=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_left=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_left=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_left=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_up=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_up=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_up=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_up=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_up=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_up=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_down=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_down=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_down=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_down=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_down=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_down=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_right=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_right=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_right=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_right=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_right=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_right=True, delay_ms=delay, frame=6)

    my.tp_set_tile(self, tile=name + ".1", is_dir_none=True, delay_ms=delay, frame=1)
    my.tp_set_tile(self, tile=name + ".2", is_dir_none=True, delay_ms=delay, frame=2)
    my.tp_set_tile(self, tile=name + ".3", is_dir_none=True, delay_ms=delay, frame=3)
    my.tp_set_tile(self, tile=name + ".4", is_dir_none=True, delay_ms=delay, frame=4)
    my.tp_set_tile(self, tile=name + ".5", is_dir_none=True, delay_ms=delay, frame=5)
    my.tp_set_tile(self, tile=name + ".6", is_dir_none=True, delay_ms=delay, frame=6)
