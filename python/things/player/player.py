...
def tp_init(name, text_name, short_text_name, title):
    ...
    my.tp_set_ai_shove_chance_d1000(mytp, 50)
    my.tp_set_ai_wanderer(mytp, True)
    my.tp_set_attack_undead(mytp, True)
    my.tp_set_capacity_height(mytp, 20)
    my.tp_set_capacity_width(mytp, 20)
    my.tp_set_collateral_damage_pct(mytp, 90)
    ...
    my.tp_set_damage_natural_dice(mytp, "1d6+1")
    my.tp_set_distance_avoid(mytp, 3)
    my.tp_set_distance_jump(mytp, 2)
    my.tp_set_distance_throw(mytp, 5)
    ...
    my.tp_set_health_initial_dice(mytp, "100")
    my.tp_set_health_starving_pct(mytp, 5)
    my.tp_set_hunger_clock_tick_frequency(mytp, 50)
    my.tp_set_hunger_health_pct(mytp, 5)
    ...
    my.tp_set_is_able_to_use_helmet(mytp, True)
    my.tp_set_is_able_to_use_rings(mytp, True)
    my.tp_set_is_able_to_use_shield(mytp, True)
    ...
    my.tp_set_is_exit_finder(mytp, True)
    ...
    my.tp_set_is_player(mytp, True)
    my.tp_set_is_red_blooded(mytp, True)
    my.tp_set_is_shovable(mytp, True)
    my.tp_set_is_tickable(mytp, True)
    my.tp_set_light_power(mytp, 10)
    my.tp_set_long_text_description(mytp, "Our most noble adventurer of no particular race or gender or creed. Devoid of fear and stout of heart. Likes kittens.")
    my.tp_set_monst_size(mytp, my.MONST_SIZE_NORMAL)
    my.tp_set_noise_decibels_hearing(mytp, 30)
    my.tp_set_noise_on_jumping(mytp, 20)
    my.tp_set_noise_on_moving_or_being_carried(mytp, 20)
    my.tp_set_on_born_do(mytp, "player.on_born()")
    my.tp_set_on_damage_acid_do(mytp, "player.on_damage_acid()")
    my.tp_set_on_damage_cold_do(mytp, "player.on_damage_cold()")
    my.tp_set_on_damage_crush_do(mytp, "player.on_damage_crush()")
    my.tp_set_on_damage_digest_do(mytp, "player.on_damage_digest()")
    my.tp_set_on_damage_energy_do(mytp, "player.on_damage_energy()")
    my.tp_set_on_damage_fire_do(mytp, "player.on_damage_fire()")
    my.tp_set_on_damage_future1_do(mytp, "player.on_damage_future1()")
    my.tp_set_on_damage_future2_do(mytp, "player.on_damage_future2()")
    my.tp_set_on_damage_future3_do(mytp, "player.on_damage_future3()")
    my.tp_set_on_damage_lightning_do(mytp, "player.on_damage_lightning()")
    my.tp_set_on_damage_melee_do(mytp, "player.on_damage_melee()")
    my.tp_set_on_damage_natural_attack_do(mytp, "player.on_damage_natural_attack()")
    my.tp_set_on_damage_necrosis_do(mytp, "player.on_damage_necrosis()")
    my.tp_set_on_damage_poison_do(mytp, "player.on_damage_poison()")
    my.tp_set_on_damage_stat_con_do(mytp, "player.on_damage_stat_con()")
    my.tp_set_on_damage_stat_str_do(mytp, "player.on_damage_stat_str()")
    my.tp_set_on_death_do(mytp, "player.on_death()")
    my.tp_set_on_move_do(mytp, "player.on_move()")
    my.tp_set_on_you_are_hit_but_still_alive_do(mytp, "player.on_you_are_hit_but_still_alive()")
    my.tp_set_on_you_natural_attack_do(mytp, "player.on_you_natural_attack()")
    ...
    my.tp_set_temperature_change_sensitive(mytp, True)
    my.tp_set_text_a_or_an(mytp, "the")
    my.tp_set_text_description(mytp, "Our most noble adventurer. Press 'h' for help.")
    my.tp_set_text_hits(mytp, "hits")
    my.tp_set_text_title(mytp, title)
    my.tp_set_z_depth(mytp, my.MAP_DEPTH_OBJ)
    my.tp_set_z_prio(mytp, my.MAP_PRIO_NORMAL)

    delay = 900
    my.tp_set_tile(mytp, tile=name + ".1", is_dir_left=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_left=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_left=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_left=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_left=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_left=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_up=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_up=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_up=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_up=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_up=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_up=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_down=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_down=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_down=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_down=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_down=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_down=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_right=True, is_moving=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_right=True, is_moving=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_right=True, is_moving=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_right=True, is_moving=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_right=True, is_moving=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_right=True, is_moving=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_left=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_left=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_left=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_left=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_left=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_left=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_up=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_up=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_up=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_up=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_up=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_up=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_down=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_down=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_down=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_down=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_down=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_down=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_right=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_right=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_right=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_right=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_right=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_right=True, delay_ms=delay, frame=6)

    my.tp_set_tile(mytp, tile=name + ".1", is_dir_none=True, delay_ms=delay, frame=1)
    my.tp_set_tile(mytp, tile=name + ".2", is_dir_none=True, delay_ms=delay, frame=2)
    my.tp_set_tile(mytp, tile=name + ".3", is_dir_none=True, delay_ms=delay, frame=3)
    my.tp_set_tile(mytp, tile=name + ".4", is_dir_none=True, delay_ms=delay, frame=4)
    my.tp_set_tile(mytp, tile=name + ".5", is_dir_none=True, delay_ms=delay, frame=5)
    my.tp_set_tile(mytp, tile=name + ".6", is_dir_none=True, delay_ms=delay, frame=6)
