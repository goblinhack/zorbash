...
def on_born(me, x, y):
    my.thing_sound_play_channel(me, my.CHANNEL_EXPLOSION, "explosion_crystal")
...
def tp_init(name):
    ...
    delay = 100
    my.tile(self,
            ascii_bg_char="*", ascii_bg_col_name="white", ascii_fg_col_name="",
...
def init():
    tp_init(name="crystal_explosion")
