...
def tp_init(name, text_name):
    ...
    my.tp_set_text_description(self, "Claw attack.")
    ...
    my.tp_set_tile(self, tile=name + ".4", delay_ms=delay, is_dir_left=True)
    my.tp_set_tile(self, tile=name + ".5", delay_ms=delay, is_dir_left=True)
    self.set_tile(
        tile=name + ".6",
        delay_ms=delay,
        is_dir_left=True,
    ...
    my.tp_set_tile(self, tile=name + ".4", delay_ms=delay, is_dir_right=True)
    my.tp_set_tile(self, tile=name + ".5", delay_ms=delay, is_dir_right=True)
    self.set_tile(
        tile=name + ".6",
        delay_ms=delay,
        is_dir_right=True,
    ...
    my.tp_set_tile(self, tile=name + ".4", delay_ms=delay, is_dir_up=True)
    my.tp_set_tile(self, tile=name + ".5", delay_ms=delay, is_dir_up=True)
    self.set_tile(
        tile=name + ".6",
        delay_ms=delay,
        is_dir_up=True,
    ...
    my.tp_set_tile(self, tile=name + ".4", delay_ms=delay, is_dir_down=True)
    my.tp_set_tile(self, tile=name + ".5", delay_ms=delay, is_dir_down=True)
    self.set_tile(
        tile=name + ".6",
        delay_ms=delay,
        is_dir_down=True,
