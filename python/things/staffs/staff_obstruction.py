...
def explode(me, x, y):
    ...
    if owner:
        if owner and my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of obstruction explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of obstruction explodes.")
    else:
        my.thing_msg(me, "The staff of obstruction explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_obstruction_carry")
    ...
    my.is_tickable(self, True)  # So it can interact with obstruction
    ...
    my.text_description_short(self, "A staff of obstruction.")
