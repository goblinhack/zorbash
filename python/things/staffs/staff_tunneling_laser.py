...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beams of tunnelings")
    my.text_apostrophize(self, "beam of tunneling's")
...
def init():
    tp_init(name="staff_tunneling_laser",
            text_long_name="beam of tunneling",
            text_short_name="laser.tunneling")
