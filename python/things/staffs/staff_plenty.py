...
def explode(me, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of plenty explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of plenty explodes.")
    else:
        my.thing_msg(me, "The staff of plenty explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    # my.is_able_to_spawn_things(self, False) else we end up owning crystal blocks
    ...
    my.text_pluralize(self, "staffs of plentys")
    my.text_apostrophize(self, "staff of plenty's")
    ...
    my.text_description_short(self, "A staff of plenty.")
...
def init():
    tp_init(name="staff_plenty",
            text_long_name="staff of plenty",
            text_short_name="staff, plenty")
