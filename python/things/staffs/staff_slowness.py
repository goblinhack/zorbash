        ...
        for dy in range(-radius, radius + 1):
            ...
            for it in my.level_get_all(me, x1, y1):
                if my.thing_possible_to_attack(me, it):
                    my.thing_debuff_add(it, "debuff_temporary_slow")
...
def explode(me, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of slowness explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of slowness explodes.")
    else:
        my.thing_msg(me, "The staff of slowness explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_slowness_carry")
    ...
    my.gfx_targeted_laser(self, "laser_slowness")
    ...
    my.text_pluralize(self, "staffs of slownesss")
    my.text_apostrophize(self, "staff of slowness'")
    my.text_description_enchant(self, "+1 radius")
    my.text_description_long(self, "Gives a temporary slowdown in speed to you, a friend, or a beloved enemy.")
    my.text_description_short(self, "A staff of slowness.")
...
def init():
    tp_init(name="staff_slowness",
            text_long_name="staff of slowness",
            text_short_name="staff, slowness")
