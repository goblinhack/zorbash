...
def tp_init(name, text_name, short_text_name):
    ...
    my.long_text_description(self, "Discharges a powerful ray of energy upon an unwitting recipient...")
    ...
    my.text_description(self, "A staff of energy.")
...
def init():
    tp_init(
        name="staff_energy",
        text_name="staff of dept of energy",
        short_text_name="staff of energy",
    )
