...
def on_targeted(me, x, y):
    ...
    for dx in range(-radius, radius + 1):
        for dy in range(-radius, radius + 1):
            ...
            my.place_at(me, "explosion_destroy_wall", x1, y1)
...
def explode(me, x, y):
    ...
    if owner:
        if owner and my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of tunneling explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of tunneling explodes.")
    else:
        my.thing_msg(me, "The staff of tunneling explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_tunneling_carry")
    ...
    my.gfx_targeted_radial(self, "staff_tunneling_radial")
