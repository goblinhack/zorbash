...
def explode(me, x, y):
    ...
    if owner:
        if owner and my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of haste explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of haste explodes.")
    else:
        my.thing_msg(me, "The staff of haste explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_haste_carry")
    ...
    my.gfx_targeted_laser(self, "laser_haste")
    ...
    my.is_tickable(self, True)  # So it can interact with haste
...
def init():
    tp_init(name="staff_haste", text_long_name="staff of haste", text_short_name="staff of haste")
