...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beams of haste")
    my.text_apostrophize(self, "beam of haste's")
...
def init():
    tp_init(name="laser_haste",
            text_long_name="beam of haste",
            text_short_name="laser.haste")
