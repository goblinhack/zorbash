...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beams of descent")
    my.text_apostrophize(self, "beam of descent's")
...
def init():
    tp_init(name="staff_descent_laser",
            text_long_name="beam of descent",
            text_short_name="laser.descent")
