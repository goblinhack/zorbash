...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beam of slowness")
    my.text_apostrophize(self, "beam of sloness's")
...
def init():
    tp_init(name="laser_slowness",
            text_long_name="beam of slow",
            text_short_name="laser.slow")
