...
def explode(me, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of holding explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of holding explodes.")
    else:
        my.thing_msg(me, "The staff of holding explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_holding_carry")
    ...
    my.text_pluralize(self, "staffs of holding")
    my.text_apostrophize(self, "staff of holding's")
    ...
    my.text_description_long(self, "This staff will conjure a barrier of holding around the target.")
    my.text_description_short(self, "A staff of holding.")
...
def init():
    tp_init(name="staff_holding",
            text_long_name="staff of holding",
            text_short_name="staff, holding")
