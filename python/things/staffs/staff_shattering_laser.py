...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beams of shatterings")
    my.text_apostrophize(self, "beam of shattering's")
...
def init():
    tp_init(name="staff_shattering_laser",
            text_long_name="beam of shattering",
            text_short_name="laser.shattering")
