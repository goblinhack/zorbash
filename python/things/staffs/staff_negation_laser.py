...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beams of negation")
    my.text_apostrophize(self, "beam of negation's")
...
def init():
    tp_init(name="laser_negation",
            text_long_name="beam of negation",
            text_short_name="laser.negation")
