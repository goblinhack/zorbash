...
def explode(me, x, y):
    ...
    if owner:
        if owner and my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of sanctuary explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of sanctuary explodes.")
    else:
        my.thing_msg(me, "The staff of sanctuary explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_sanctuary_carry")
    ...
    my.text_description_long(self, "This staff will conjure a barrier of sanctuary around the target.")
    my.text_description_short(self, "A staff of sanctuary.")
...
def init():
    tp_init(name="staff_sanctuary", text_long_name="staff of sanctuary", text_short_name="staff, sanctuary")
