...
def on_targeted(me, x, y):
    for it in my.level_get_all(me, x, y):
        if my.thing_is_monst(it) or my.thing_is_player(it):
            spell = my.place_at(it, "spell_of_protection_barrier", x, y)
            if spell:
                my.thing_set_leader(spell, it)
...
def explode(me, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of protection explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of protection explodes.")
    else:
        my.thing_msg(me, "The staff of protection explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_protection_carry")
