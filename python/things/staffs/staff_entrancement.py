        ...
        for dy in range(-radius, radius + 1):
            ...
            for it in my.level_get_all(me, x1, y1):
                if my.thing_possible_to_attack(me, it):
                    my.thing_entranced_count_incr(it, 10)
...
def explode(me, x, y):
    ...
    if owner:
        if owner and my.thing_is_player(owner):
            my.thing_msg(me, "Your staff of entrancement explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s staff of entrancement explodes.")
    else:
        my.thing_msg(me, "The staff of entrancement explodes.")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.equip_carry_anim(self, "staff_entrancement_carry")
    ...
    my.gfx_targeted_laser(self, "laser_entrancement")  # just reuse it
    my.gfx_targeted_radial(self, "staff_entrancement_radial")
    ...
    my.is_tickable(self, True)  # So it can interact with entrancement
