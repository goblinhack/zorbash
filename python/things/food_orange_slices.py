...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("Some orange slices. Perfect with a cocktail that you do not have.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("10+1d10")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=orange$Orange slices.")
...
def init():
    tp_init(name="food_orange_slices", text_name="orange slices", short_text_name="orange slices")
