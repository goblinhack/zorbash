...
def tp_init(name,
    ...
    x.set_health_initial_dice("999")
    x.set_is_able_to_fall(False)
    x.set_is_attackable_by_monst(False)
    x.set_is_attackable_by_player(False)
    x.set_is_cursor_can_hover_over(True)
    x.set_is_described_when_hovering_over(True)
    x.set_is_indestructible(True)
    ...
    x.set_text_description("Rocky the indestructible rock.")
