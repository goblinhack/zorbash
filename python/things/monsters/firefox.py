...
def tp_init(name, text_long_name):
    ...
    my.text_description_long(self, "Noble and brave, the firefox is fears nothing, and why should it, with it's ability to breathe balls of fire!")
    ...
    my.tile(self,
            ...
            tile="firefox.1", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="firefox.2", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="orange",
            tile="firefox.1", delay_ms=delay)
    my.tile(self,
    ...
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="orange",
            tile="firefox.3", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="firefox.4", delay_ms=delay)
    delay = 1500
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="orange",
            tile="firefox.sleeping.1", is_sleeping=True, delay_ms=delay)
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="orange",
            tile="firefox.sleeping.2", is_sleeping=True, delay_ms=delay)
    delay = 150
    my.tile(self,
            ascii_fg_char="f", ascii_bg_col_name="", ascii_fg_col_name="gray30",
            tile="firefox.dead", is_dead=True, delay_ms=delay)
