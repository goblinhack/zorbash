...
def tp_init(name, text_long_name):
    ...
    my.dmg_poison_chance_d1000(self, 0, 500)
    ...
    my.text_long_description2(self, "It seems friendly and definitely non non venomous. Want to pet it...?")
    my.text_long_description(self, "A two foot long snake with shiny yellow irises and a cutely upturned snout giving it the appearance of a small spike.")
