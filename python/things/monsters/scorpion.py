...
def tp_init(name, text_long_name):
    ...
    my.chance_d1000_is_able_to_jump_attack(self, 800)
    my.chance_d1000_is_able_to_jump_onto(self, 100)
    ...
    my.text_description_long(self, "A venomous scorpion. Beware its sting, bite and the fact that it can see heat signatures. So, hiding inside your invisibility cloak will not help you avoid me...")
    ...
    my.tile(self,
            ...
            tile="scorpion.1", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="scorpion.2", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="scorpion.3", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="scorpion.4", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="scorpion.5", delay_ms=delay)
