...
def tp_init(name, text_long_name):
    ...
    my.text_description_long2(self, "Watch out for its poisonoous mandibles!")
    my.text_description_long(self, "A hideous, and thankfully slow moving, crawling insectoid with sickly flesh coloured skin. This creature has a use however, that of clearing the dungeon of extraneous meaty detritius. Like you.")
    ...
    my.tile(self,
            ...
            tile="carcas_creeper.1", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="c", ascii_bg_col_name="", ascii_fg_col_name="pink",
            tile="carcas_creeper.2", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="c", ascii_bg_col_name="", ascii_fg_col_name="pink",
            tile="carcas_creeper.3", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="c", ascii_bg_col_name="", ascii_fg_col_name="pink",
            tile="carcas_creeper.4", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="c", ascii_bg_col_name="", ascii_fg_col_name="pink",
            tile="carcas_creeper.5", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="c", ascii_bg_col_name="", ascii_fg_col_name="pink",
            tile="carcas_creeper.6", delay_ms=delay)
    my.tile(self,
