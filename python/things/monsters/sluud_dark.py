...
def on_death(me, x, y):
    my.thing_msg(me, "The dark sluud curses and dies!")
...
def tp_init(name, text_long_name):
    ...
    my.dmg_nat_att_dice(self, "1d8+1")
    ...
    my.health_initial_dice(self, "5d6+20")
    ...
    my.text_description_short(self, "A dark sluud.")
    ...
    delay = 900
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="darkgreen",
