...
def tp_init(name, text_long_name):
    ...
    my.text_description_long2(self, "Onyx widows are roamers and are reknowned for being fast moving. And poisonous. I mean the widow thing kind of gives it away...")
    ...
    my.tile(self,
            ...
            tile="spider_onyx_widow.1", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="spider_onyx_widow.2", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="spider_onyx_widow.3", delay_ms=delay)
    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="red",
            tile="spider_onyx_widow.4", delay_ms=delay)

    my.tile(self,
            ascii_fg_char="s", ascii_bg_col_name="", ascii_fg_col_name="gray30",
            tile="spider_onyx_widow.dead", is_dead=True, delay_ms=delay)
