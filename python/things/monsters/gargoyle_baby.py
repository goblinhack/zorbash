...
def tp_init(name, text_long_name):
    ...
    my.text_description_long(self, "This particular gargoyle is just starting out in its career, hence the diminutive stature. It is not as capabale as its mature form, but is still to be feared...")
