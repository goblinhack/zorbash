...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "Vampire roses grow rapidly and primarily feed on blood and rotting corpses. Be a good gardener and don't allow them to spread.")
    my.text_short_description(self, "A beatiful vampire rose.")
