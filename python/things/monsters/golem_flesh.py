...
def tp_init(name, text_long_name):
    ...
    my.is_allied_with(self, "golem_flesh")
    ...
    my.text_pluralize(self, "flesh golems")
    my.text_apostrophize(self, "flesh golem's")
...
def init():
    tp_init(name="golem_flesh",
            text_long_name="flesh golem")
