...
def tp_init(name, text_long_name):
    ...
    my.text_description_long2(self, "Watch out for its jumping rat attack!")
    my.text_description_long3(self, "Sometimes answers to the name of Mr Squeakles.")
    my.text_description_long(self, "An enormous giant dwarf undersized titan rat... Blood drips from its teeth. Will eat almost anything, especially you.")
    my.text_description_short(self, "A giant dwarf rat, no more, no less. Slightly cute. Rabid?")
