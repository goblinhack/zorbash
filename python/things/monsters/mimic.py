...
def tp_init(name, text_long_name):
    ...
    my.tile(self,
            ...
            tile="mimic.sleeping", is_sleeping=True, delay_ms=delay)
    my.tile(self,
            ascii_fg_char="up_triangle", ascii_bg_col_name="", ascii_fg_col_name="gold",
    ...
    my.tile(self,
            ascii_fg_char="up_triangle", ascii_bg_col_name="", ascii_fg_col_name="gold",
            tile=name + ".7", delay_ms=delay, frame=6)
    my.tile(self,
...
def init():
    tp_init(name="mimic", text_long_name="treasure chest")
