...
def tp_init(name, text_long_name):
    ...
    my.chance_d1000_jump_randomly(self, 2)
    ...
    my.text_pluralize(self, "slime jumpers")
    my.text_apostrophize(self, "slime jumper's")
...
def init():
    tp_init(name="slime_parent",
            text_long_name="slime jumper")
