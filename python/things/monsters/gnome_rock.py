...
def tp_init(name, text_long_name):
    ...
    my.dmg_nat_att_type(self, "pound")
    ...
    my.stat_dex(self, 6)
    my.stat_str(self, 12)
    my.text_description_long2(self, "This particular gnome is a rock gnome. Having spend so long underground, these gnomes have developed a dusty, rock like skin. This makes them exceptionally tough to hit.")
