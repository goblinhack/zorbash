...
def tp_init(name, text_long_name):
    ...
    my.text_description_long(self, "Molekin spend much of their lives underground and have developed large bulbous eyes that glow in the dark. They have powerful upper bodies and long serated claws, perfect for digging... and goring those that get in their way.")
