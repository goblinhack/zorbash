...
def tp_init(name, text_long_name):
    ...
    my.text_description_long3(self, "Ogres can naturally regenerate health. You have been warned.")
    my.text_description_long(self, "An enormous creature that seems to be a collection of boulders strung together and brough to life, otherwise known as a hill ogre.")
