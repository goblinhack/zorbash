...
def tp_init(name, text_name):
    ...
    x.set_modifier_strength(8)
    x.set_monst_size(zx.MONST_SIZE_NORMAL)
    x.set_move_speed_ms(150)
    x.set_normal_placement_rules(True)
    x.set_on_bite_do("goblin1.on_bite()")
    x.set_on_death_do("goblin1.on_death()")
    x.set_on_death_drop_all_items(True)
    x.set_on_hit_do("goblin1.on_hit()")
    x.set_on_miss_do("goblin1.on_miss()")
...
def init():
    tp_init(name="goblin1", text_name="lesser goblin")
