...
def on_use(owner, item, target, x, y):
    ...
    for it in my.level_get_all(item, x, y):
        if my.thing_is_alive_monst(it) or my.thing_is_player(it):
            my.thing_buff_add(it, "buff_temporary_floating")
...
def explode(me, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(me, "Your potion of levitation visibly explodes.")
        else:
            my.thing_msg(me, f"The {my.thing_name_get(owner)}'s potion of levitation visibly explodes.")
    else:
        my.thing_msg(me, "The potion of levitation visibly explodes.")
