...
def on_use(owner, item, target, x, y):
    ...
    my.thing_buff_add(target, "buff_temporary_telepathy")
    my.thing_wake(target, "potion")
    my.game_set_request_to_update_same_level()
...
def shatters(item, target, x, y):
    ...
    if owner:
        if my.thing_is_player(owner):
            my.thing_msg(owner, "Your potion of telepathy shatters.")
        else:
            my.thing_msg(owner, f"The {my.thing_name_get(owner)}'s potion of telepathy shatters.")
    else:
        my.thing_msg(item, "The potion of telepathy shatters.")

    my.spawn_at_my_position(target, "water")
