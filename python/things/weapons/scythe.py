...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_damage_melee_dice(self, "3d6+1")
    my.tp_set_equip_carry_anim(self, "scythe_carry")
    ...
    my.tp_set_gold_value_dice(self, "250")
    ...
    my.tp_set_long_text_description(self, "A huge gleaming scythe. Ideal for gardening and other uses.")
    ...
    my.tp_set_text_description(self, "Thy swingy means of justice.")
