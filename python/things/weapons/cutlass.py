...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_equip_carry_anim(mytp, "cutlass_carry")
    my.tp_set_gfx_animated_can_hflip(mytp, True)
    my.tp_set_gfx_animated(mytp, True)
    my.tp_set_gfx_anim_use(mytp, "cutlass_swing")
    ...
    my.tp_set_long_text_description(mytp, "A gleaming cutlass. Ideal for the entry level pirate.")
    my.tp_set_noise_on_moving_or_being_carried(mytp, 10)
    my.tp_set_on_use_do(mytp, "me.on_use()")
    my.tp_set_rarity(mytp, my.RARITY_RARE)
    my.tp_set_text_a_or_an(mytp, "a")
    my.tp_set_text_description(mytp, "Thy curved and pointy means of justice. Aar.")
