...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_equip_carry_anim(self, "cutlass_carry")
    my.tp_set_gfx_animated_can_hflip(self, True)
    my.tp_set_gfx_animated(self, True)
    my.tp_set_gfx_anim_use(self, "cutlass_swing")
    ...
    my.tp_set_long_text_description(self, "A gleaming cutlass. Ideal for the entry level pirate.")
    my.tp_set_noise_on_moving_or_being_carried(self, 10)
    my.tp_set_on_use_do(self, "me.on_use()")
    my.tp_set_rarity(self, my.RARITY_RARE)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Thy curved and pointy means of justice. Aar.")
