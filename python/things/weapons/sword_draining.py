...
def on_owner_attacking_dmg_draining(me, owner, victim, x, y, damage):
    # my.con("on_owner_attacking_dmg_draining")
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.on_owner_attacking_dmg_draining_do(self, "me.on_owner_attacking_dmg_draining()")
