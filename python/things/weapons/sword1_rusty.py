...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_damage_melee_dice(self, "1d6+1")
    my.tp_set_damage_poison_chance_d1000(self, 100)
    my.tp_set_damage_poison_dice(self, "1d2+1")
    my.tp_set_equip_carry_anim(self, "sword1_rusty_carry")
    my.tp_set_gfx_animated_can_hflip(self, True)
    my.tp_set_gfx_animated(self, True)
    my.tp_set_gfx_anim_use(self, "sword1_rusty_swing")
    ...
    my.tp_set_long_text_description(self, "A rusting short sword. Ideal for absolutely no one.")
    ...
    my.tp_set_text_description(self, "Thy rusty means of justice.")
