...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_damage_melee_dice(mytp, "1d6+1")
    my.tp_set_damage_poison_chance_d1000(mytp, 100)
    my.tp_set_damage_poison_dice(mytp, "1d2+1")
    my.tp_set_equip_carry_anim(mytp, "sword1_rusty_carry")
    my.tp_set_gfx_animated_can_hflip(mytp, True)
    my.tp_set_gfx_animated(mytp, True)
    my.tp_set_gfx_anim_use(mytp, "sword1_rusty_swing")
    ...
    my.tp_set_long_text_description(mytp, "A rusting short sword. Ideal for absolutely no one.")
    ...
    my.tp_set_text_description(mytp, "Thy rusty means of justice.")
