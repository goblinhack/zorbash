...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_damage_melee_dice("1d8+1")
    mytp.set_equip_carry_anim("sword_short_basic_carry")
    mytp.set_gfx_animated_can_hflip(True)
    mytp.set_gfx_animated(True)
    mytp.set_gfx_anim_use("sword_short_basic_swing")
...
def init():
    tp_init(name="sword_short_basic", text_name="short sword", short_text_name="short sword")
