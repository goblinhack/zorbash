...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_equip_carry_anim("sword_short_rusty_carry")
    mytp.set_gfx_animated_can_hflip(True)
    mytp.set_gfx_animated(True)
    mytp.set_gfx_anim_use("sword_short_rusty_swing")
    ...
    mytp.set_on_use_do("sword_short_rusty.on_use()")
...
def init():
    tp_init(name="sword_short_rusty", text_name="rusty short sword", short_text_name="rusty short sword")
