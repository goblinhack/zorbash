...
def key_init(name, text_name):
    ...
    my.long_text_description(self, "An old metal key. What more can you say. It's a bit dusty?")
    my.normal_placement_rules(self, True)
    my.text_a_or_an(self, "an")
    my.text_description(self, "A keys.")
...
def init():
    key_init(name="key_single", text_name="a key")
