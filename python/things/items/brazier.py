...
def tp_init(name, text_name, tiles=[]):
    ...
    my.tp_set_damage_crush_dice(self, "1d6")
    ...
    my.tp_set_is_brazier(self, True)
    my.tp_set_is_corpse_on_death(self, True)
    my.tp_set_is_dead_on_shove(self, True)
    ...
    my.tp_set_spawn_on_shoved(self, "fire")
    my.tp_set_temperature(self, 100)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "A beacon of light in this blighted place.")
    ...
    my.tp_set_tile(self, tile=name + ".dead", is_dead=True, delay_ms=delay)
