        ...
        if my.thing_is_alive_monst(it) or my.thing_is_player(it):
            if not my.thing_confused_count_incr(it, 10):
                ...
                if owner and my.thing_is_player(owner):
                    my.thing_msg(owner, "%%fg=red$Your confusion dart has no effect.")
            else:
                if my.thing_is_player(it):
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.gfx_targeted_projectile(self, "projectile_dart_confusion")
    ...
    my.text_pluralize(self, "confusion darts")
    my.text_apostrophize(self, "confusion dart's")
    my.text_description_enchant(self, "+1 DMG")
    my.text_description_long(self, "This dart will bring a confused look to your enemies faces. If they have faces...")
    my.text_description_short(self, "A confusion tipped dart.")
