...
def tp_init(name, text_name):
    ...
    my.tp_set_long_text_description(self, "A bone portal which spews the angry spirits of those long passed.")
    my.tp_set_minion_limit(self, 3)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_on_death_do(self, "me.on_death()")
    my.tp_set_on_idle_tick_frequency_dice(self, "1d20+20:me.on_idle_tick_frequency_dice()")
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "A cursed pile of bones, spawning spirits.")
    ...
    my.tp_set_tile(self, tile=name + ".3.75", is_hp_75_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4.75", is_hp_75_percent=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".3.50", is_hp_50_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4.50", is_hp_50_percent=True, delay_ms=delay)
    ...
    my.tp_set_tile(self, tile=name + ".3.25", is_hp_25_percent=True, delay_ms=delay)
    my.tp_set_tile(self, tile=name + ".4.25", is_hp_25_percent=True, delay_ms=delay)
