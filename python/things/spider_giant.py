...
def tp_init(name, text_name):
    ...
    x.set_health_initial_dice("4d15+4")
    ...
    delay=150
    x.set_tile("spider_giant.1", delay_ms=delay)
    x.set_tile("spider_giant.2", delay_ms=delay)
    x.set_tile("spider_giant.dead", is_dead=True, delay_ms=delay)
