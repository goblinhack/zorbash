...
def tp_init(name, text_name, short_text_name):
    ...
    my.long_text_description(self, "Gauntlets of shoving. No longer will you get pushed around with this slight boost to your shoving ability! Works in both offensive and defensive capabilities. Not that you would ever try to shove something into a chasm... right?")
    ...
    my.text_description(self, "Gauntlets of shoving.")
...
def init():
    tp_init(
        ...
        text_name="gauntlets of shoving",
        short_text_name="gauntlets of shoving",
    )
