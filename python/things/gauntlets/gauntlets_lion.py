...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "Gauntlets of lion armor as modelled by Henry II. With these gauntlets, your hide is as tough as a lion and you find you are able to better dodge attacks.")
    my.text_short_description(self, "Gauntlets of lion armor.")
