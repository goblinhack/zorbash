...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_equip_carry_anim(self, "armor_lime_scale_carry")
    ...
    my.tp_set_long_text_description(self, "Lime scale armor. Very tough while it lasts. Which is not long...")
    ...
    my.tp_set_text_description(self, "Lime scale mail armor.")
