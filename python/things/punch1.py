...
def init1(name, text_name):
    ...
    x.set_is_loggable_for_important_stuff(TrueTrue
    ...
    x.set_tile(tile=name + ".4", delay_ms=delay, is_dir_down=True, is_end_of_anim = True, is_dead_on_end_of_anim=True)
    ...
    x.set_tile(tile=name + ".4", delay_ms=delay, is_dir_up=True, is_end_of_anim = True, is_dead_on_end_of_anim=True)
    ...
    x.set_tile(tile=name + ".4", delay_ms=delay, is_dir_left=True, is_end_of_anim = True, is_dead_on_end_of_anim=True)
    ...
    x.set_tile(tile=name + ".4", delay_ms=delay, is_dir_right=True, is_end_of_anim = True, is_dead_on_end_of_anim=True)
    ...
    x.set_tile(tile=name + ".4", delay_ms=delay, is_dir_none=True, is_end_of_anim = True, is_dead_on_end_of_anim=True)
