...
def on_tick_when_activated(owner, skill, x, y):
    ...
    if my.py_pcg_random_range_inclusive(1, 100) < 75:
        my.thing_stamina_incr(owner, 10)
...
def tp_init(name, text_long_name, text_short_name):
    ...
    # begin sort marker
    my.skill_replaces(self, "skill_super_health4")
    my.stat_con_bonus(self, 8)
    my.text_description_long4(self, "You will gain 10 stamina and 5 health at a 50 percent chance per turn.")
    my.text_description_long5(self, "Cold, poison, necrosis and constitution damage will be reduced by 90 percent.")
    my.text_description_very_short(self, "SupHealt5")
