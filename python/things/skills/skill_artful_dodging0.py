...
def tp_init(self):
    ...
    my.text_description_long2(self, "As part of your training you will receive enhanced dexterity and defensive bonuses, but also the ability to recover stamina more quickly.")
