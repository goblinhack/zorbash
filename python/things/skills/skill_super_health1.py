...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_description_long3(self, "You will gain 2 stamina and 1 health at a 50 percent chance per turn.")
...
def init():
    tp_init(name="skill_super_health1", text_long_name="super health 1", text_short_name="super health 1")
