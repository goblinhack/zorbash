...
def on_owner_receive_dmg(me, owner, hitter, real_hitter, x, y, damage):
    return skill_vampiric_touch0.do_vampiric_touch(me, owner, hitter, real_hitter, x, y, damage, 30)
...
def init():
    tp_init(name="skill_vampiric_touch3", text_long_name="vampiric touch 3", text_short_name="vampiric touch 3")
