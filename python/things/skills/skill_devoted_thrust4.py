...
def on_use(owner, skill, target, x, y):
    ...
    bonus = int(my.thing_stamina(owner) / 10) * 75
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_description_very_short(self, "DevtThr 4")
...
def init():
    tp_init(name="skill_devoted_thrust4", text_long_name="devoted thrust 4", text_short_name="devoted thrust 4")
