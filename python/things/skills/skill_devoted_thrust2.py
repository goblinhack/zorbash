...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_description_long4(self, "When activated, 30 percent of your stamina will be converted to damage.")
    my.text_description_long5(self, "When activated, 10 percent chance of draining stamina by 1.")
    my.text_description_very_short(self, "DevThrst2")
    # end sort marker
...
def init():
    tp_init(name="skill_devoted_thrust2",
            text_long_name="devoted thrust 2",
            text_short_name="devoted thrust 2")
