...
def on_tick_when_activated(owner, skill, x, y):
    ...
    if owner and my.py_pcg_random_range_inclusive(1, 100) < 30:
...
def init():
    tp_init(name="skill_artful_dodging3",
            text_long_name="artful dodging 3",
            text_short_name="artful dodging 3")
