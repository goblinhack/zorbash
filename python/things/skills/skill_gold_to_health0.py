...
def tp_init(self):
    ...
    my.text_description_long2(self, "When in use, your skin glows radiantly. However you will feel sluggish and less dextrous than normal as your slightly metallic skin becomes less agile.")
