...
def on_use(owner, skill, target, x, y):
    ...
    bonus = int(my.thing_stamina(owner) / 10) * 90
...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_description_long(self, "Uses 90 percent of your stamina points up in one mighty strike.")
    my.text_description_short(self, "Devoted thrust skill.")
    my.text_description_very_short(self, "DevtThr 5")
...
def init():
    tp_init(name="skill_devoted_thrust5", text_long_name="devoted thrust 5", text_short_name="devoted thrust 5")
