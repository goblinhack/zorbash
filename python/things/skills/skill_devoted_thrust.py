...
def tp_init(name, text_long_name):
    ...
    my.text_long_description2(self, "Can be used multiple times, but beware, your stamina will rapidly drop and you may end up unable to attack or jump away.")
    my.text_long_description3(self, "Each enchant will add 10 percent to the damage, but will take the additional bonus off your stamina.")
