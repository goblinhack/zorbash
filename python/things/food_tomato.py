...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("A tomato big enough to live in.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("1d20")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=brown$Tomato.")
...
def init():
    tp_init(name="food_tomato", text_name="tomato", short_text_name="tomato")
