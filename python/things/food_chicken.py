...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("A roast chicken possibly. No farms nearby. It could, frankly, be a roast anything.")
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("1d50")
    mytp.set_rarity(zx.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("%%fg=brown$Roast chicken.")
