...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_gfx_health_bar_shown_only_when_injured(False)
    mytp.set_gfx_long_shadow_caster(False)
    mytp.set_gfx_on_fire_anim(False)
    mytp.set_gfx_oversized_but_sitting_on_the_ground(False)
    ...
    mytp.set_is_cursor_can_hover_over_but_needs_double_click(False)
    ...
    mytp.set_is_movement_blocking_but_destructable(False)
    mytp.set_is_movement_blocking_wall_or_locked_door(False)
    ...
    mytp.set_is_rrr10(False)
    mytp.set_is_rrr11(False)
    mytp.set_is_rrr12(False)
    mytp.set_is_rrr13(False)
    mytp.set_is_rrr14(False)
    mytp.set_is_rrr15(False)
    mytp.set_is_rrr16(False)
    mytp.set_is_rrr17(False)
    mytp.set_is_rrr18(False)
    mytp.set_is_rrr19(False)
    mytp.set_is_rrr1(False)
    mytp.set_is_rrr20(False)
    mytp.set_is_rrr21(False)
    mytp.set_is_rrr22(False)
    mytp.set_is_rrr23(False)
    mytp.set_is_rrr24(False)
    mytp.set_is_rrr25(False)
    mytp.set_is_rrr26(False)
    mytp.set_is_rrr27(False)
    mytp.set_is_rrr28(False)
    mytp.set_is_rrr29(False)
    mytp.set_is_rrr2(False)
    mytp.set_is_rrr30(False)
    mytp.set_is_rrr31(False)
    mytp.set_is_rrr32(False)
    mytp.set_is_rrr33(False)
    mytp.set_is_rrr34(False)
    mytp.set_is_rrr35(False)
    mytp.set_is_rrr36(False)
    mytp.set_is_rrr37(False)
    mytp.set_is_rrr38(False)
    mytp.set_is_rrr39(False)
    mytp.set_is_rrr3(False)
    mytp.set_is_rrr40(False)
    mytp.set_is_rrr41(False)
    mytp.set_is_rrr42(False)
    mytp.set_is_rrr43(False)
    mytp.set_is_rrr44(False)
    mytp.set_is_rrr45(False)
    mytp.set_is_rrr46(False)
    mytp.set_is_rrr47(False)
    mytp.set_is_rrr48(False)
    mytp.set_is_rrr49(False)
    mytp.set_is_rrr4(False)
    mytp.set_is_rrr50(False)
    mytp.set_is_rrr51(False)
    mytp.set_is_rrr52(False)
    mytp.set_is_rrr5(False)
    mytp.set_is_rrr6(False)
    mytp.set_is_rrr7(False)
    mytp.set_is_rrr8(False)
    mytp.set_is_rrr9(False)
    ...
    mytp.set_is_target_select_automatically_when_chosen(False)
