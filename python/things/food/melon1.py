...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Ripe slice of melon. With a dash of ginger and less dirt on it, this might be nice.")
    my.tp_set_noise_on_moving_or_being_carried(self, 1)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_nutrition_dice(self, "10+1d10")
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Slice of melon.")
...
def init():
    tp_init(name="food_melon1", text_name="slice of melon", short_text_name="slice of melon")
