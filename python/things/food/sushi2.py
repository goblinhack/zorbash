...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Dungeon sushi. The last sushi you'll ever try...")
    ...
    my.tp_set_text_description(self, "Sushi. Possibly.")
...
def init():
    tp_init(name="food_sushi2", text_name="sushi", short_text_name="sushi")
