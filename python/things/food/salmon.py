...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A slice of chef prepared salmon. No sign of the chef in sight. Might not be salmon. It's wriggling a bit.")
    ...
    my.tp_set_text_description(mytp, "Salmon.")
