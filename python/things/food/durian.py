...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Dungeon durian. The best kind. It smells a bit like a dead zorblin and tastes like heaven.")
    ...
    my.tp_set_text_description(self, "Durian.")
