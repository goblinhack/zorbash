...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Custard pie. At least it might be custard. Whatever it is it oozes a bit and is yellow.")
    ...
    my.tp_set_text_description(self, "Custard pie.")
