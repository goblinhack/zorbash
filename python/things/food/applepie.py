...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Steaming apple pie. Made with fresh dungeon apples. Not sure why it is steaming though.")
    ...
    my.tp_set_text_description(self, "Apple pie.")
