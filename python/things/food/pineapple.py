...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A pineapple. How it got here... I mean I just can't explain this one. Just eat it and enjoy the weird dreams tonight.")
    ...
    my.tp_set_text_description(mytp, "Pineapple.")
...
def init():
    tp_init(name="food_pineapple", text_name="pineapple", short_text_name="pineapple")
