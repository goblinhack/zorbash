...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "Organic onion. You're going to eat it raw, right? What's wrong with you!")
    ...
    my.tp_set_text_description(mytp, "Organic onion.")
...
def init():
    tp_init(name="food_onion", text_name="onion", short_text_name="onion")
