...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Organic onion. You're going to eat it raw, right? What's wrong with you!")
    ...
    my.tp_set_text_description(self, "Organic onion.")
