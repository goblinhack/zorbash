...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "An entire roast chicken. Possibly. It has legs and was roasted.")
    my.text_short_description(self, "Roast chicken.")
