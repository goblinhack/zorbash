...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "An aubergine. Some call it eggplant. This one, well, it's round and a bit puckered and has seen better days. It might be a rock.")
    ...
    my.tp_set_text_description(self, "Aubergine.")
