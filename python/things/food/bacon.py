...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Some crunchy meat stuff that might be bacon")
    ...
    my.tp_set_text_description(self, "Bacon maybe.")
...
def init():
    tp_init(name="food_bacon", text_name="bacon", short_text_name="bacon")
