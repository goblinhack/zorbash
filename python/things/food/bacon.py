...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "Some crunchy meat stuff that might be bacon")
    my.text_short_description(self, "Bacon maybe.")
...
def init():
    tp_init(name="food_bacon", text_long_name="bacon", text_short_name="bacon")
