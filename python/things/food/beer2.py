...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "beer")
    my.text_apostrophize(self, "beer's")
    my.text_description_long(self, "Frothy beer. Brewed locally. By something.")
    my.text_description_short(self, "Frothy beer.")
