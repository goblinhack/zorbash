...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A bottle of wine from the zorblin vineyards. Not the best vintage.")
    ...
    my.tp_set_text_description(self, "Wine.")
...
def init():
    tp_init(name="food_wine", text_name="wine", short_text_name="wine")
