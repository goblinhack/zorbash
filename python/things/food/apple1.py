...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A juicy dungeon apple. From local dungeon apple trees, if you can believe that.")
    ...
    my.tp_set_text_description(self, "Juicy apple.")
