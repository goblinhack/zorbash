...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A chunk of some kind of meat.")
    ...
    my.tp_set_text_description(mytp, "A meaty thing.")
...
def init():
    tp_init(name="food_somekindofmeat", text_name="meat", short_text_name="meat")
