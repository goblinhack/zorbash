...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "Organic turnip. Grown locally and sutainably. In soil drenched with the blood of adventurers.")
    ...
    my.tp_set_text_description(mytp, "Organic turnip.")
...
def init():
    tp_init(name="food_turnip", text_name="turnip", short_text_name="turnip")
