...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "Organic turnip. Grown locally and sutainably. In soil drenched with the blood of adventurers.")
    my.text_short_description(self, "Organic turnip.")
