...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Dungeon steak. Of what poor creature, you have no idea. You dare eat it?")
    my.tp_set_noise_on_moving_or_being_carried(self, 1)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_nutrition_dice(self, "10+1d50")
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Dungeon steak.")
...
def init():
    tp_init(name="food_steak", text_name="steak", short_text_name="steak")
