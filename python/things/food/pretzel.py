...
def tp_init(name, text_name, short_text_name):
    ...
    mytp.set_long_text_description("Crispy dungeon atrezan made pretzel. A bit stale, but you can't be too choosy down here..")
    mytp.set_noise_decibels_on_moving_or_being_carried(40)
    mytp.set_normal_placement_rules(True)
    mytp.set_nutrition_dice("10+1d15")
    mytp.set_rarity(my.RARITY_COMMON)
    mytp.set_text_a_or_an("a")
    mytp.set_text_description("Pretzel.")
