...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "Crispy dungeon atrezan made pretzel. A bit stale, but you can't be too choosy down here..")
    my.tp_set_noise_on_moving_or_being_carried(mytp, 40)
    ...
    my.tp_set_text_description(mytp, "Pretzel.")
