...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A very juicy dungeon apple. A bit too juicy if you ask me. From local dungeon apple trees, if you can believe that.")
    my.tp_set_noise_on_moving_or_being_carried(self, 1)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_nutrition_dice(self, "10+1d12")
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Very juicy apple.")
...
def init():
    tp_init(name="food_apple2", text_name="very juicy apple", short_text_name="juicy apple")
