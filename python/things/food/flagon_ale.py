...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A flagon of weak ale with small chunks of something floating inside.")
    ...
    my.tp_set_text_description(mytp, "A flagon of weak ale.")
