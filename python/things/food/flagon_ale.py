...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A flagon of weak ale with small chunks of something floating inside.")
    ...
    my.tp_set_text_description(self, "A flagon of weak ale.")
...
def init():
    tp_init(name="food_flagon_ale", text_name="flagon of weak ale", short_text_name="ale")
