...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A pot of golden spider honey. A rare variety. Tasty with a unique aftertaste of fly.")
    ...
    my.tp_set_text_description(mytp, "Honey.")
