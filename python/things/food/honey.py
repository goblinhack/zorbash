...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A pot of golden spider honey. A rare variety. Tasty with a unique aftertaste of fly.")
    ...
    my.tp_set_text_description(self, "Honey.")
...
def init():
    tp_init(name="food_honey", text_name="honey", short_text_name="honey")
