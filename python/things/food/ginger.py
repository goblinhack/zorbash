...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "Ginger root. About the only thing that really does grow natively here.")
    ...
    my.tp_set_text_description(mytp, "Ginger root.")
...
def init():
    tp_init(name="food_ginger", text_name="ginger", short_text_name="ginger")
