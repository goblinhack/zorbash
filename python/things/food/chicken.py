...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A roast chicken leg possibly. No farms nearby. It could, frankly, be a roast anything.")
    ...
    my.tp_set_text_description(self, "Roast chicken leg.")
