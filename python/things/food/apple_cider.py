...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "A jug of apple cider.")
    ...
    my.tp_set_text_description(self, "A jug of apple cider. Made from juicy dungeon apples with a particular taste all of their own.")
