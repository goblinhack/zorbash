...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Potted meat. What kind, who knows. Just meat. An unforgettable experience.")
    ...
    my.tp_set_text_description(self, "Potted meat.")
...
def init():
    tp_init(name="food_pottedmeat", text_name="potted meat", short_text_name="potted meat")
