...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Pickled eyeballs. A great source of probiotics and vitamin A.")
    my.tp_set_noise_on_moving_or_being_carried(self, 15)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_nutrition_dice(self, "10+1d85")
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Pickled eyeballs.")
