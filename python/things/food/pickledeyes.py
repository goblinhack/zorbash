...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "pickled eyes")
    my.text_apostrophize(self, "pickled eye's")
    my.text_description_long(self, "A great source of pro-biotics and vitamin A.")
    my.text_description_short(self, "Pickled eyeballs.")
