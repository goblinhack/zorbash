...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(mytp, "A massive strawberry as big as a schoolboy's head.")
    ...
    my.tp_set_text_description(mytp, "Strawberry.")
...
def init():
    tp_init(name="food_strawberry", text_name="strawberry", short_text_name="strawberry")
