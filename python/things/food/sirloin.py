...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Sirloin steak. Jusy lying their in the dirt for who knows how long. But you'll still eat it right?")
    my.tp_set_noise_on_moving_or_being_carried(self, 1)
    my.tp_set_normal_placement_rules(self, True)
    my.tp_set_nutrition_dice(self, "10+1d45")
    my.tp_set_rarity(self, my.RARITY_COMMON)
    my.tp_set_text_a_or_an(self, "a")
    my.tp_set_text_description(self, "Sirloin steak.")
...
def init():
    tp_init(name="food_sirloin", text_name="sirloin", short_text_name="sirloin")
