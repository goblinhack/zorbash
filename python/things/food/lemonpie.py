...
def tp_init(name, text_name, short_text_name):
    ...
    my.tp_set_long_text_description(self, "Refreshing lemon pie. Might seem out of place but is commonly left in dungeons by caring grandmothers looking out for their adventurer grandchildren..")
    ...
    my.tp_set_text_description(self, "Lemon pie.")
