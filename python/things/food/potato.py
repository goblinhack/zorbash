...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_pluralize(self, "potatos")
    my.text_apostrophize(self, "potato's")
    my.text_description_long(self, "A potato. What more does one need in life.")
    my.text_description_short(self, "Potato.")
...
def init():
    tp_init(name="potato",
            text_long_name="potato",
            text_short_name="potato")
