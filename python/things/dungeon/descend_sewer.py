...
def tp_init(name, tiles=[], left1_tiles=[]):
    ...
    my.text_long_description(self, "A filthy sewer pipe. Watch out, they can spawn surprises. Don't fall in!")
    my.text_short_description(self, "A slime coated sewer pipe.")
