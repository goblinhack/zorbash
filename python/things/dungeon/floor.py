...
def tp_init(name, tiles=[], bot3_tiles=[]):
    ...
    mytp.set_damage_environment_doubled_from_acid(False)
    mytp.set_damage_environment_doubled_from_fire(False)
    mytp.set_damage_environment_doubled_from_poison(False)
    mytp.set_damage_environment_doubled_from_water(False)
