...
def tp_init(name, text_long_name, tiles=[]):
    ...
    my.gfx_ascii_mode_color_spread_green(self, 10)
    my.gfx_ascii_mode_color_spread_red(self, 10)
    ...
    for t in tiles:
        my.tile(self,
                ascii_fg_char="~", ascii_bg_col_name="lightblue1", ascii_fg_col_name="lightblue2",
