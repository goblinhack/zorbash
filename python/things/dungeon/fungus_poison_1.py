...
def tp_init(name, tiles=[]):
    ...
    my.text_description_long2(self, "Is is poisonous? Who can tell... Well you probably, if you dare to eat it.")
    my.text_description_long(self, "An enormous mushroom with a white stem and lime green spots on its cap.")
