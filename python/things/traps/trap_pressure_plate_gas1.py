...
def on_activated(me, victim, x, y):
    if my.thing_is_player(victim):
        ...
        my.thing_msg(victim, "%%fg=red$Poison gas surrounds you!%%fg=reset$")
    else:
...
def tp_init(name, text_long_name):
    ...
    my.text_pluralize(self, "odourous floor tiles")
    my.text_apostrophize(self, "odourous floor tile's")
...
def init():
    tp_init(name="trap_pressure_plate_gas1",
