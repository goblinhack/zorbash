...
def on_death(me, x, y):
    ...
    for it in my.level_get_all(me, x, y):
        if my.thing_blinded_count_incr(it, 10):
            if my.thing_is_player(it):
                my.thing_msg(it, "Why me?")
                my.thing_popup(it, "!!!")
...
def tp_init(name, text_long_name):
    ...
    my.tile(self,
            ascii_fg_char="middle_dot", ascii_fg_col_name="gray20", tile="trap.1")
    my.tile(self,
            ascii_fg_char="middle_dot", ascii_fg_col_name="gray20", tile="trap.2")
    my.tile(self,
            ascii_fg_char="middle_dot", ascii_fg_col_name="gray20", tile="trap.3")

    my.tp_update(self)


def init():
    tp_init(name="trap_blinded", text_long_name="inconspicuous floor tile")
