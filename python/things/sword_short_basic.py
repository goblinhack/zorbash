...
def init_weapon(name, text_name, short_text_name):
    ...
    mytp.set_gfx_animated_can_hflip(True)
    mytp.set_gfx_animated(True)
    mytp.set_gfx_anim_attack("sword_short_basic_swing")
    mytp.set_gfx_short_shadow_caster(True)
    ...
    mytp.set_weapon_carry_anim("sword_short_basic_carry")
...
def init():
    init_swing(name="sword_short_basic_swing")
    init_carry(name="sword_short_basic_carry")
    init_weapon(name="sword_short_basic", text_name="short sword", short_text_name="short sword")
