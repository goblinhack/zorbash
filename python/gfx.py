...
def init_16x16():
    tiles = [
            ...
            ########################################################
            "small_fire.1", "small_fire.2", "small_fire.3",
            "small_fire.4", "small_fire.5", "small_fire.6",
            "small_fire.7", "small_fire.8", "small_fire.9",
            "small_fire.10", "small_fire.11", "small_fire.12",
            "small_fire.13", "small_fire.14", "small_fire.15",
            "small_fire.16", "small_fire.17", "small_fire.18",
            "small_fire.dead",
            ########################################################
