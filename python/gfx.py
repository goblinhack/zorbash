...
def init_ui_popup_short():
    tiles = [
        "ui_popup_short", 
    ]
    zx.tile_load_arr(
        file="data/gfx/ui_popup_short.tga",
        name="ui_popup_short", width=80, height=34, arr=tiles)
...
def init_ui_popup_widest():
    tiles = [
        "ui_popup_widest", 
    ]
    zx.tile_load_arr(
        file="data/gfx/ui_popup_widest.tga",
        name="ui_popup_widest", width=160, height=152, arr=tiles)
...
def init_16x16():
    tiles = [
            "player1.1", "player1.2", "player1.3", "player1.4", "player1.5", "player1.6", "", "player1.pose", "player1.dead", "sword1.1", "save", "load", "bug", "pause", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            ...
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            "health5-icon", "health4-icon", "health3-icon", "health2-icon", "health1-icon", "dollar-icon", "armour-icon", "magic-icon", "karma-icon", "anxiety5-icon", "anxiety4-icon", "anxiety3-icon", "anxiety2-icon", "anxiety1-icon", "strength-icon", "cursor.1", "cursor.2", "cursor.3", "cursor.4", "cursor.5", "cursor.6", "cursor.7", "cursor.8", "cursor.9", "cursor.10", "cursor.11", "cursor.12", "", "", "", "", "",
            ########################################################
