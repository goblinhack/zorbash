...
def init_16x16():
    tiles = [
            ...
            "food_frog1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            "health5-icon", "health4-icon", "health3-icon", "health2-icon", "health1-icon", "dollar-icon", "defence-icon", "magic-icon", "karma-icon", "anxiety5-icon", "anxiety4-icon", "anxiety3-icon", "anxiety2-icon", "anxiety1-icon", "attack-icon", "cursor.1", "cursor.2", "cursor.3", "cursor.4", "cursor.5", "cursor.6", "cursor.7", "cursor.8", "cursor.9", "cursor.10", "cursor.11", "cursor.12", "cursor_path.1", "cursor_path.2", "cursor_path.3", "cursor_path.4", "cursor_path.5",
            ########################################################
