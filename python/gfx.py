...
def init_16x16():
    ...
    tiles = [
            ...
            ########################################################
            "blood1a", "blood1.100", "blood2.100", "blood3.100", "blood4.100", "", "", "food_frog1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            ...
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            "health5-icon", "health4-icon", "health3-icon", "health2-icon", "health1-icon", "dollar-icon", "armour-icon", "magic-icon", "karma-icon", "anxiety5-icon", "anxiety4-icon", "anxiety3-icon", "anxiety2-icon", "anxiety1-icon", "strength-icon", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            ########################################################
            ...
            ########################################################
            "grass1.tl.1", "grass1.top.1", "grass1.tr.1", "grass2.tl.1", "grass2.top.1", "grass2.tr.1", "grass3.tl.1", "grass3.top.1", "grass3.tr.1", "grass4.tl.1", "grass4.top.1", "grass4.tr.1", "grass1.1", "grass1.2", "grass1.3", "grass1.4", "grass1.5", "grass1.6", "grass1.7", "grass1.8", "grass1.9", "grass1.10", "grass1.11", "grass1.12", "grass1.13", "grass1.14", "grass1.15", "grass1.16", "grass1.17", "grass1.18", "grass1.19", "grass1.20",
            "grass1.left.1", "grass1.21", "grass1.right.1", "grass2.left.1", "grass2.21", "grass2.right.1", "grass3.left.1", "grass3.21", "grass3.right.1", "grass4.left.1", "grass3.22", "grass4.right.1", "grass2.1", "grass2.2", "grass2.3", "grass2.4", "grass2.5", "grass2.6", "grass2.7", "grass2.8", "grass2.9", "grass2.10", "grass2.11", "grass2.12", "grass2.13", "grass2.14", "grass2.15", "grass2.16", "grass2.17", "grass2.18", "grass2.19", "grass2.20",
            "grass1.bl.1", "grass1.bot.1", "grass1.br.1", "grass2.bl.1", "grass2.bot.1", "grass2.br.1", "grass3.bl.1", "grass3.bot.1", "grass3.br.1", "grass4.bl.1", "grass4.bot.1", "grass4.br.1", "grass3.1", "grass3.2", "grass3.3", "grass3.4", "grass3.5", "grass3.6", "grass3.7", "grass3.8", "grass3.9", "grass3.10", "grass3.11", "grass3.12", "grass3.13", "grass3.14", "grass3.15", "grass3.16", "grass3.17", "grass3.18", "grass3.19", "grass3.20",
            "soil1.tl.1", "soil1.top.1", "soil1.tr.1", "soil2.tl.1", "soil2.top.1", "soil2.tr.1", "soil3.tl.1", "soil3.top.1", "soil3.tr.1", "soil4.tl.1", "soil4.top.1", "soil4.tr.1", "soil1.1", "soil1.2", "soil1.3", "soil1.4", "soil1.5", "soil1.6", "soil1.7", "soil1.8", "soil1.9", "soil1.10", "soil1.11", "soil1.12", "soil1.13", "soil1.14", "soil1.15", "soil1.16", "soil1.17", "soil1.18", "soil1.19", "soil1.20",
            "soil1.left.1", "soil1.21", "soil1.right.1", "soil2.left.1", "soil2.21", "soil2.right.1", "soil3.left.1", "soil3.21", "soil3.right.1", "soil4.left.1", "soil3.22", "soil4.right.1", "soil2.1", "soil2.2", "soil2.3", "soil2.4", "soil2.5", "soil2.6", "soil2.7", "soil2.8", "soil2.9", "soil2.10", "soil2.11", "soil2.12", "soil2.13", "soil2.14", "soil2.15", "soil2.16", "soil2.17", "soil2.18", "soil2.19", "soil2.20",
            "soil1.bl.1", "soil1.bot.1", "soil1.br.1", "soil2.bl.1", "soil2.bot.1", "soil2.br.1", "soil3.bl.1", "soil3.bot.1", "soil3.br.1", "soil4.bl.1", "soil4.bot.1", "soil4.br.1", "soil3.1", "soil3.2", "soil3.3", "soil3.4", "soil3.5", "soil3.6", "soil3.7", "soil3.8", "soil3.9", "soil3.10", "soil3.11", "soil3.12", "soil3.13", "soil3.14", "soil3.15", "soil3.16", "soil3.17", "soil3.18", "soil3.19", "soil3.20",
            "gravel1.tl.1", "gravel1.top.1", "gravel1.tr.1", "gravel2.tl.1", "gravel2.top.1", "gravel2.tr.1", "gravel3.tl.1", "gravel3.top.1", "gravel3.tr.1", "gravel4.tl.1", "gravel4.top.1", "gravel4.tr.1", "gravel1.1", "gravel1.2", "gravel1.3", "gravel1.4", "gravel1.5", "gravel1.6", "gravel1.7", "gravel1.8", "gravel1.9", "gravel1.10", "gravel1.11", "gravel1.12", "gravel1.13", "gravel1.14", "gravel1.15", "gravel1.16", "gravel1.17", "gravel1.18", "gravel1.19", "gravel1.20",
            "gravel1.left.1", "gravel1.21", "gravel1.right.1", "gravel2.left.1", "gravel2.21", "gravel2.right.1", "gravel3.left.1", "gravel3.21", "gravel3.right.1", "gravel4.left.1", "gravel3.22", "gravel4.right.1", "gravel2.1", "gravel2.2", "gravel2.3", "gravel2.4", "gravel2.5", "gravel2.6", "gravel2.7", "gravel2.8", "gravel2.9", "gravel2.10", "gravel2.11", "gravel2.12", "gravel2.13", "gravel2.14", "gravel2.15", "gravel2.16", "gravel2.17", "gravel2.18", "gravel2.19", "gravel2.20",
            "gravel1.bl.1", "gravel1.bot.1", "gravel1.br.1", "gravel2.bl.1", "gravel2.bot.1", "gravel2.br.1", "gravel3.bl.1", "gravel3.bot.1", "gravel3.br.1", "gravel4.bl.1", "gravel4.bot.1", "gravel4.br.1", "gravel3.1", "gravel3.2", "gravel3.3", "gravel3.4", "gravel3.5", "gravel3.6", "gravel3.7", "gravel3.8", "gravel3.9", "gravel3.10", "gravel3.11", "gravel3.12", "gravel3.13", "gravel3.14", "gravel3.15", "gravel3.16", "gravel3.17", "gravel3.18", "gravel3.19", "gravel3.20",
            "snow1.tl.1", "snow1.top.1", "snow1.tr.1", "snow2.tl.1", "snow2.top.1", "snow2.tr.1", "snow3.tl.1", "snow3.top.1", "snow3.tr.1", "snow4.tl.1", "snow4.top.1", "snow4.tr.1", "snow1.1", "snow1.2", "snow1.3", "snow1.4", "snow1.5", "snow1.6", "snow1.7", "snow1.8", "snow1.9", "snow1.10", "snow1.11", "snow1.12", "snow1.13", "snow1.14", "snow1.15", "snow1.16", "snow1.17", "snow1.18", "snow1.19", "snow1.20",
            "snow1.left.1", "snow1.21", "snow1.right.1", "snow2.left.1", "snow2.21", "snow2.right.1", "snow3.left.1", "snow3.21", "snow3.right.1", "snow4.left.1", "snow3.22", "snow4.right.1", "snow2.1", "snow2.2", "snow2.3", "snow2.4", "snow2.5", "snow2.6", "snow2.7", "snow2.8", "snow2.9", "snow2.10", "snow2.11", "snow2.12", "snow2.13", "snow2.14", "snow2.15", "snow2.16", "snow2.17", "snow2.18", "snow2.19", "snow2.20",
            "snow1.bl.1", "snow1.bot.1", "snow1.br.1", "snow2.bl.1", "snow2.bot.1", "snow2.br.1", "snow3.bl.1", "snow3.bot.1", "snow3.br.1", "snow4.bl.1", "snow4.bot.1", "snow4.br.1", "snow3.1", "snow3.2", "snow3.3", "snow3.4", "snow3.5", "snow3.6", "snow3.7", "snow3.8", "snow3.9", "snow3.10", "snow3.11", "snow3.12", "snow3.13", "snow3.14", "snow3.15", "snow3.16", "snow3.17", "snow3.18", "snow3.19", "snow3.20",
            ########################################################
    ]
