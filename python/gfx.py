...
def init_16x16():
    tiles = [
            ...
            "blood1a", "blood1.100", "blood2.100", "blood3.100", "blood4.100",
            ########################################################
            ...
            "torch1.dead",
            ########################################################
            "small_fire1.1", "small_fire1.2", "small_fire1.3",
            "small_fire1.4", "small_fire1.5", "small_fire1.6",
            "small_fire1.7", "small_fire1.8", "small_fire1.9",
            "small_fire1.10", "small_fire1.11", "small_fire1.12",
            "small_fire1.13", "small_fire1.14", "small_fire1.15",
            "small_fire1.16", "small_fire1.17", "small_fire1.18",
            "small_fire1.dead",
            ########################################################
